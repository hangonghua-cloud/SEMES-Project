(function () {
    'use strict';
    angular.module('Siemens.SimaticIT.ProductionApp.TransferList')
        .constant('Siemens.SimaticIT.ProductionApp.TransferList.TransferCard.constants', ScreenServiceConstants())
        .service('Siemens.SimaticIT.ProductionApp.TransferList.TransferCard.service', ScreenService)
    ...
    ScreenService.$inject = ['$q', '$state', 'common.base', 'Siemens.SimaticIT.ProductionApp.TransferList.TransferCard.constants', 'common.services.logger.service'];
    function ScreenService($q, $state, base, context, loggerService) {
        ...
        activate();
        function activate() {
            logger = loggerService.getModuleLogger('Siemens.SimaticIT.ProductionApp.TransferList.TransferCard.service');
    ...
    ScreenServiceRun.$inject = ['Siemens.SimaticIT.ProductionApp.TransferList.TransferCard.constants', 'common.base'];
