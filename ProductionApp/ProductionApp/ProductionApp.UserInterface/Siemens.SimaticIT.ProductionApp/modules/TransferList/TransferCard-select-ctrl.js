(function () {
    'use strict';
    angular.module('Siemens.SimaticIT.ProductionApp.TransferList').config(ViewScreenStateConfig);

    ViewScreenController.$inject = ['Siemens.SimaticIT.ProductionApp.TransferList.TransferCard.service', '$state', '$stateParams', 'common.base', '$filter', '$scope'];
        ...
        var state = {
            ...
            views: {
                'property-area-container@': {
                    templateUrl: moduleFolder + '/TransferCard-select.html',
