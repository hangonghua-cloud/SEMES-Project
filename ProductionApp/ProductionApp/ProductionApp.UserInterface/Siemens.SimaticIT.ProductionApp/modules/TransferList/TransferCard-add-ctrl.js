(function () {
    ...
    AddScreenController.$inject = ['Siemens.SimaticIT.ProductionApp.TransferList.TransferCard.service', '$state', '$stateParams', 'common.base', '$filter', '$scope'];
        ...
        var state = {
            ...
            views: {
                'property-area-container@': {
                    templateUrl: moduleFolder + '/TransferCard-add.html',
