(function () {
    'use strict';
    angular.module('Siemens.SimaticIT.ProductionApp.TransferCardResume')
        .constant('Siemens.SimaticIT.ProductionApp.TransferCardResume.BeforeSlottingInventory.constants', ScreenServiceConstants())
        .service('Siemens.SimaticIT.ProductionApp.TransferCardResume.BeforeSlottingInventory.service', ScreenService)
    ...
    ScreenService.$inject = ['$q', '$state', 'common.base', 'Siemens.SimaticIT.ProductionApp.TransferCardResume.BeforeSlottingInventory.constants', 'common.services.logger.service'];
    function ScreenService($q, $state, base, context, loggerService) {
        ...
        activate();
        function activate() {
            logger = loggerService.getModuleLogger('Siemens.SimaticIT.ProductionApp.TransferCardResume.BeforeSlottingInventory.service');
    ...
    ScreenServiceRun.$inject = ['Siemens.SimaticIT.ProductionApp.TransferCardResume.BeforeSlottingInventory.constants', 'common.base'];
