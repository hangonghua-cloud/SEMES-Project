(function () {
    ...
    AddScreenController.$inject = ['Siemens.SimaticIT.ProductionApp.TransferCardResume.TransferCardResume.service', '$state', '$stateParams', 'common.base', '$filter', '$scope'];
        ...
        var state = {
            ...
            views: {
                'property-area-container@': {
                    templateUrl: moduleFolder + '/TransferCardResume-add.html',
