(function () {
    ...
    AddScreenController.$inject = ['Siemens.SimaticIT.ProductionApp.TransferCardResume.RawMaterialReceive.service', '$state', '$stateParams', 'common.base', '$filter', '$scope'];
        ...
        var state = {
            ...
            views: {
                'property-area-container@': {
                    templateUrl: moduleFolder + '/RawMaterialReceive-add.html',
