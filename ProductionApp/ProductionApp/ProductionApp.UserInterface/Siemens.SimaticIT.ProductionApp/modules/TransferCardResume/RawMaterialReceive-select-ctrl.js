(function () {
    ...
    ViewScreenController.$inject = ['Siemens.SimaticIT.ProductionApp.TransferCardResume.RawMaterialReceive.service', '$state', '$stateParams', 'common.base', '$filter', '$scope'];
    ...
    function ViewScreenStateConfig($stateProvider) {
        var screenStateName = 'home.Siemens_SimaticIT_ProductionApp_TransferCardResume_RawMaterialReceive';
        ...
        var state = {
            ...
            views: {
                'property-area-container@': {
                    templateUrl: moduleFolder + '/RawMaterialReceive-select.html',
