(function () {
    ...
    EditScreenController.$inject = ['Siemens.SimaticIT.ProductionApp.TransferCardResume.SharedInventory.service', '$state', '$stateParams', 'common.base', '$filter', '$scope'];
        ...
        var state = {
            ...
            views: {
                'property-area-container@': {
                    templateUrl: moduleFolder + '/SharedInventory-edit.html',
