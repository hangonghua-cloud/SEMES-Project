(function () {
    ...
    angular.module('Siemens.SimaticIT.ProductionApp.TransferCardResume')
        .constant('Siemens.SimaticIT.ProductionApp.TransferCardResume.RawMaterialReceive.constants', ScreenServiceConstants())
        .service('Siemens.SimaticIT.ProductionApp.TransferCardResume.RawMaterialReceive.service', ScreenService)
    ...
    ScreenService.$inject = ['$q', '$state', 'common.base', 'Siemens.SimaticIT.ProductionApp.TransferCardResume.RawMaterialReceive.constants', 'common.services.logger.service'];
    function ScreenService($q, $state, base, context, loggerService) {
        ...
        activate();
        function activate() {
            logger = loggerService.getModuleLogger('Siemens.SimaticIT.ProductionApp.TransferCardResume.RawMaterialReceive.service');
    ...
    ScreenServiceRun.$inject = ['Siemens.SimaticIT.ProductionApp.TransferCardResume.RawMaterialReceive.constants', 'common.base'];
