(function () {
    'use strict';
    angular.module('Siemens.SimaticIT.ProductionApp.ProcessBad')
        .constant('Siemens.SimaticIT.ProductionApp.ProcessBad.ProcessBad.constants', ScreenServiceConstants())
        .service('Siemens.SimaticIT.ProductionApp.ProcessBad.ProcessBad.service', ScreenService)
    ...
    ScreenService.$inject = ['$q', '$state', 'common.base', 'Siemens.SimaticIT.ProductionApp.ProcessBad.ProcessBad.constants', 'common.services.logger.service'];
    function ScreenService($q, $state, base, context, loggerService) {
        ...
        activate();
        function activate() {
            logger = loggerService.getModuleLogger('Siemens.SimaticIT.ProductionApp.ProcessBad.ProcessBad.service');
    ...
    ScreenServiceRun.$inject = ['Siemens.SimaticIT.ProductionApp.ProcessBad.ProcessBad.constants', 'common.base'];
