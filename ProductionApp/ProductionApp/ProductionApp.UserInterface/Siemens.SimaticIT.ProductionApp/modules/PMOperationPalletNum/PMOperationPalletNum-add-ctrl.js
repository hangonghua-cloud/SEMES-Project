(function () {
    'use strict';
    angular.module('Siemens.SimaticIT.ProductionApp.PMOperationPalletNum').config(AddScreenStateConfig);

    AddScreenController.$inject = ['Siemens.SimaticIT.ProductionApp.PMOperationPalletNum.PMOperationPalletNum.service', '$state', '$stateParams',
    ...
    function AddScreenController(dataService, $state, $stateParams,
        ...
        function activate() {
            ...
            sidePanelManager.setTitle(commonService.$t('Siemens.SimaticIT.ProductionApp.PMOperationPalletNum.addJS.Tips_1'));
        ...
        function init() {
            ...
            self.selectMaterialModal = selectMaterialModal;//选择物料
        ...
        function initDictionary() {
            ...
            //工厂
            self.typeFactory = {
                value: { ResourceName: commonService.$t('Siemens.SimaticIT.ProductionApp.PMOperationPalletNum.addJS.Tips_2'), ResourceCode: "" },
                options: [{ ResourceName: commonService.$t('Siemens.SimaticIT.ProductionApp.PMOperationPalletNum.addJS.Tips_2'), ResourceCode: "" }]
            };
            commonService.getResourceExtendInfo({ LevelCode: "Factory" }).then(function (res) {
                if (res && res.data.success) {
                    ...
                    self.typeFactory.options.splice(0, 0, {
                        ResourceCode: "",
                        ResourceName: commonService.$t('Siemens.SimaticIT.ProductionApp.PMOperationPalletNum.addJS.Tips_2')
                    });
                }
            });
            ...
            //单位
            self.typeUnit = {
                value: { ItemName: commonService.$t('Siemens.SimaticIT.ProductionApp.PMOperationPalletNum.addJS.Tips_2'), ItemValue: "" },
                options: [{ ItemName: commonService.$t('Siemens.SimaticIT.ProductionApp.PMOperationPalletNum.addJS.Tips_2'), ItemValue: "" }]
            };
        ...
        function selectMaterialModal() {
            if (!self.typeFactory.value.ResourceCode) {
                commonService.showWarning(commonService.$t('Siemens.SimaticIT.ProductionApp.PMOperationPalletNum.addJS.Tips_3'));
                return;
            }
                ...
                resolve: {
                    data: function () {
                        return {
                            ...
                            columnDefs: [
                                {
                                    name: 'rowNum', displayName: commonService.$t('Siemens.SimaticIT.ProductionApp.PMOperationPalletNum.addJS.Tips_4'), minWidth: 80, width: 90, enableSorting: false, cellTemplate:
                                        '<div class="ui-grid-cell-contents">{{grid.renderContainers.body.visibleRowCache.indexOf(row) + 1}}</div>'
                                },
                                {
                                    field: 'MaterialCode',
                                    displayName: commonService.$t('Siemens.SimaticIT.ProductionApp.PMOperationPalletNum.addJS.Tips_5'),
                                    width: 150
                                },
                                {
                                    field: 'MaterialName',
                                    displayName: commonService.$t('Siemens.SimaticIT.ProductionApp.PMOperationPalletNum.addJS.Tips_6'),
                                    width: 150
                                },
                                {
                                    field: 'Spec',
                                    displayName: commonService.$t('Siemens.SimaticIT.ProductionApp.PMOperationPalletNum.addJS.Tips_7'),
                                    width: 300
                                }
                            ],
                        };
        ...
        function save() {
            ...
            busyIndicatorService.show({ message: commonService.$t('Siemens.SimaticIT.ProductionApp.PMOperationPalletNum.addJS.Tips_9') });
        ...
        function onSaveSuccess(data) {
            if (data.data.success) {
                ...
                sidePanelManager.close();//关闭侧边栏
                commonService.showInfo(commonService.$t('Siemens.SimaticIT.ProductionApp.PMOperationPalletNum.addJS.Tips_10'));
                $rootScope.$emit('to-parent', 'parent');//刷新局部
                $state.go('^', {}, { reload: false });
            } else {
                busyIndicatorService.hide();
                backendService.genericError(data.data.returnMsg, commonService.$t('Siemens.SimaticIT.ProductionApp.PMOperationPalletNum.addJS.Tips_11'));
            }
        }
        ...
        function onSaveError(error) {
            busyIndicatorService.hide();
            backendService.genericError('[' + error.status + '] - ' + error.statusText, commonService.$t('Siemens.SimaticIT.ProductionApp.PMOperationPalletNum.addJS.Tips_11'));
        }
        ...
        var state = {
            ...
            views: {
                'property-area-container@': {
                    templateUrl: moduleFolder + '/PMOperationPalletNum-add.html',
                    controller: AddScreenController,
                    controllerAs: 'vm'
                }
            },
            data: {
                title: 'Siemens.SimaticIT.ProductionApp.PMOperationPalletNum.addJS.Tips_1'
            }
        };
