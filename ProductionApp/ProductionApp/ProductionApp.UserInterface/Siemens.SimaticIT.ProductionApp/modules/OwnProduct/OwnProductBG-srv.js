(function () {
    ...
    angular.module('Siemens.SimaticIT.ProductionApp.OwnProduct')
        .constant('Siemens.SimaticIT.ProductionApp.OwnProduct.OwnProductBG.constants', ScreenServiceConstants())
        .service('Siemens.SimaticIT.ProductionApp.OwnProduct.OwnProductBG.service', ScreenService)
    ...
    ScreenService.$inject = ['$q', '$state', 'common.base', 'Siemens.SimaticIT.ProductionApp.OwnProduct.OwnProductBG.constants', 'common.services.logger.service'];
    function ScreenService($q, $state, base, context, loggerService) {
        ...
        activate();
        function activate() {
            logger = loggerService.getModuleLogger('Siemens.SimaticIT.ProductionApp.OwnProduct.OwnProductBG.service');
    ...
    ScreenServiceRun.$inject = ['Siemens.SimaticIT.ProductionApp.OwnProduct.OwnProductBG.constants', 'common.base'];
