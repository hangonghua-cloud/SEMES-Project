(function () {
    'use strict';
    angular.module('Siemens.SimaticIT.ProductionApp.PackingBG')
        .constant('Siemens.SimaticIT.ProductionApp.PackingBG.PackingRecord.constants', ScreenServiceConstants())
        .service('Siemens.SimaticIT.ProductionApp.PackingBG.PackingRecord.service', ScreenService)
    ...
    ScreenService.$inject = ['$q', '$state', 'common.base', 'Siemens.SimaticIT.ProductionApp.PackingBG.PackingRecord.constants', 'common.services.logger.service'];
    function ScreenService($q, $state, base, context, loggerService) {
        ...
        activate();
        function activate() {
            logger = loggerService.getModuleLogger('Siemens.SimaticIT.ProductionApp.PackingBG.PackingRecord.service');
    ...
    ScreenServiceRun.$inject = ['Siemens.SimaticIT.ProductionApp.PackingBG.PackingRecord.constants', 'common.base'];
