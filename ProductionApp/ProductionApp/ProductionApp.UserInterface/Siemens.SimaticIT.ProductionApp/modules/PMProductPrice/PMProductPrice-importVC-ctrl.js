(function () {
    'use strict';
    angular.module('Siemens.SimaticIT.ProductionApp.PMProductPrice').config(ImportVCScreenStateConfig);

    ImportVCScreenController.$inject = ['Siemens.SimaticIT.ProductionApp.PMProductPrice.PMProductPrice.service', '$state',
    ...
    function ImportVCScreenController(dataService, $state, $stateParams, common, $filter, $scope, i18nService, FileUploader,
        ...
        function activate() {
            init();
            registerEvents();
            sidePanelManager.setTitle(commonService.$t('Siemens.SimaticIT.ProductionApp.PMProductPrice.importWLJS.Tips_5'));
        ...
        function importExcel(contents) {
            ...
            self.grid1Json = XLSX.utils.sheet_to_json(wb.Sheets["VC"]);
    ...
    ImportVCScreenStateConfig.$inject = ['$stateProvider'];
    function ImportVCScreenStateConfig($stateProvider) {
        ...
        var state = {
            name: moduleStateName + '.importVC',
            url: '/importVC',
            views: {
                'property-area-container@': {
                    templateUrl: moduleFolder + '/PMProductPrice-importVC.html',
                    controller: ImportVCScreenController,
                    controllerAs: 'vm'
                }
            },
            data: {
                title: 'Siemens.SimaticIT.ProductionApp.PMProductPrice.importWLJS.Tips_5'
            },
            params: {
                selectedItem: null
            }
