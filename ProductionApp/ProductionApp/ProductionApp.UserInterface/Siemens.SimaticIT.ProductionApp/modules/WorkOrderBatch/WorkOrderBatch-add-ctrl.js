(function () {
    'use strict';
    angular.module('Siemens.SimaticIT.ProductionApp.WorkOrderBatch').config(AddScreenStateConfig);

    AddScreenController.$inject = ['Siemens.SimaticIT.ProductionApp.WorkOrderBatch.WorkOrderBatch.service', '$state', '$stateParams', 'common.base', '$filter', '$scope'];
        ...
        var state = {
            ...
            views: {
                'property-area-container@': {
                    templateUrl: moduleFolder + '/WorkOrderBatch-add.html',
