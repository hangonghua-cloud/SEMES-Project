(function () {
    'use strict';
    angular.module('Siemens.SimaticIT.ProductionApp.AbrasiveOrder').config(ViewScreenStateConfig);

    ViewScreenController.$inject = ['Siemens.SimaticIT.ProductionApp.AbrasiveOrder.AbrasiveOrder.service', '$state',
        '$stateParams', 'common.base', '$filter', '$scope', 'commonService', 'common.services.authentication', 'common.widgets.notificationTile.globalService',
        'common.widgets.busyIndicator.service', '$uibModal'];
    function ViewScreenController(dataService, $state, $stateParams, common, $filter, $scope, commonService, auth,
        notificationService, busyIndicatorService, $modal) {
        var self = this;
        ...
        function addForm() {
            var modalInstance = commonService.openModel({
                templateUrl: 'Siemens.SimaticIT.ProductionApp/modules/AbrasiveOrder/AddBomItem.html',
                controller: 'Siemens.SimaticIT.ProductionApp.AbrasiveOrder.AddBomItem',
                controllerAs: 'vm',
                size: 'lg',
                resolve: {
                    data: function () {
        ...
        function editForm() {
            ...
            var modalInstance = commonService.openModel({
                templateUrl: 'Siemens.SimaticIT.ProductionApp/modules/AbrasiveOrder/EditBomItem.html',
                controller: 'Siemens.SimaticIT.ProductionApp.AbrasiveOrder.EditBomItem',
                controllerAs: 'vm',
                size: 'lg',
                resolve: {
                    data: function () {
        ...
        function save() {
            ...
            var url = commonService.getMesApiAddress("ProduceManage") + 'PL_BOM/AbrasiveOrderBOMEdit';
        ...
        var state = {
            ...
            views: {
                'property-area-container@': {
                    templateUrl: moduleFolder + '/AbrasiveOrder-select.html',
