(function () {
    'use strict';
    angular.module('Siemens.SimaticIT.ProductionApp.TeamPerson')
        .constant('Siemens.SimaticIT.ProductionApp.TeamPerson.TeamPerson.constants', ScreenServiceConstants())
        .service('Siemens.SimaticIT.ProductionApp.TeamPerson.TeamPerson.service', ScreenService)
    ...
    ScreenService.$inject = ['$q', '$state', 'common.base', 'Siemens.SimaticIT.ProductionApp.TeamPerson.TeamPerson.constants', 'common.services.logger.service'];
    function ScreenService($q, $state, base, context, loggerService) {
        ...
        activate();
        function activate() {
            logger = loggerService.getModuleLogger('Siemens.SimaticIT.ProductionApp.TeamPerson.TeamPerson.service');
    ...
    ScreenServiceRun.$inject = ['Siemens.SimaticIT.ProductionApp.TeamPerson.TeamPerson.constants', 'common.base'];
