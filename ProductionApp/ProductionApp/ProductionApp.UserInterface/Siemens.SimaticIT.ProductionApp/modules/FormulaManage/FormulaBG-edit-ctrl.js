(function () {
    ...
    EditScreenController.$inject = ['Siemens.SimaticIT.ProductionApp.FormulaManage.FormulaBG.service', '$state', '$stateParams', 'common.base', '$filter', '$scope'];
        ...
        var state = {
            ...
            views: {
                'property-area-container@': {
                    templateUrl: moduleFolder + '/FormulaBG-edit.html',
