(function () {
    'use strict';
    angular.module('Siemens.SimaticIT.ProductionApp.PMOwnSemiProductOrder').config(ImportScreenStateConfig);

    ImportScreenController.$inject = ['Siemens.SimaticIT.ProductionApp.PMOwnSemiProductOrder.PMOwnSemiProductOrder.service',
        ...
        'i18nService', 'FileUploader',
    ];
    function ImportScreenController(dataService, $state, $stateParams, common, $filter, $scope, commonService, auth,
        notificationService, busyIndicatorService, $modal, $rootScope, i18nService, FileUploader,
    ) {
        var self = this;
        ...
        function getData1() {
            ...
            for (var i = 0; i < self.grid1.data.length; i++) {
                ...
                dataList.push({
                    ...
                    Spec: item["规格"],
                    CustomerCode: item["客户编码"],
                    CustomerName: item["客户名称"],
                    ContainerNO: item["柜号"],
                    ProductQty: item["订单数量"],
                    UnitName: item["单位"],
                    PalletNum: item["托数"],
                    VolumeNum: item["卷数"],
                    Meters: item["米数"],
        ...
        function save() {
            ...
            var url = commonService.getMesApiAddress('ProduceManage') + "/PMOwnSemiProductOrder/PMOwnSemiProductOrder_Import";
        ...
        var state = {
            ...
            views: {
                'property-area-container@': {
                    templateUrl: moduleFolder + '/PMOwnSemiProductOrder-import.html',
