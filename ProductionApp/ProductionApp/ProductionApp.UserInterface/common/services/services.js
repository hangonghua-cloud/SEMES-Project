    ...
    (function (framework) {
        ...
        angular.module('siemens.simaticit.common.services.configUtil')
            .config(['common.services.data.config.endpointsConfigProvider', function (endpointsConfigProvider) {
                endpointsConfigProvider.config.serviceEndpointsUrl = window.location.protocol + "//" + window.location.hostname + "/sit-svc/config";
        ...
        var ConfigDataService = /** @class */ (function () {
            function ConfigDataService($http, $q, endpointsConfig) {
                ...
                this.queryServiceEndpoints = function () {
                    ...
                    _this._$http.get(_this.servicesPath + '?timestamp=' + new Date().getTime()).then(function (response) {
...
(function () {
    ...
    var initInjector, $http, $q, $interpolate, configUtilService, contextInstance;
    var configTextFn;
    ...
    var buildNumber = content + '' + version;

    function initInjectors() {
        initInjector = angular.injector(['ng', 'siemens.simaticit.common.services.configUtil', 'siemens.simaticit.common.base']);
   ...
   */
     ...
     */
    function generateAbsoluteConfig(data) {
        function generate(data) {
            var items = Object.keys(data);
            Object.keys(data).forEach(function (item) {
                if (typeof data[item] === 'object') {
                    generate(data[item]);
                } else if (data[item].indexOf('/') === 0) {
                    // check for partial path
                    data[item] = window.location.protocol + '//' + window.location.hostname + data[item];
                }
            });
        }
        generate(data);
    ...
    function displayPopUp(response) {
        ...
        document.querySelector("#ieUnsupportedPopup .ie-popup-header").innerHTML = title;
        document.querySelector("#ieUnsupportedPopup .ie-popup-header-text").innerHTML = text;
        ...
        angular.element(window.document).ready(function () {
            ...
            loadConfigModule().then(function () {
                fetchData().then(function () {
                    detectIEBrowser();
                    if (isIE && appConfig.type !== 'mdui' && appConfig.type !== 'debug') {
...
(function (sit) {
    ...
    (function (framework) {
        var ContextModal = /** @class */ (function () {
            function ContextModal(APPCONFIG) {
                this.ctx = {
                    configEndpoint: window.location.protocol + "//" + window.location.hostname + "/sit-svc/config",
                    isSwacEnabled: true,
                    appType: 'runtime'
                };
                this.ctx.isSwacEnabled = APPCONFIG.appConfig ? APPCONFIG.appConfig.mode === 'swac' : true;
                this.ctx.appType = APPCONFIG.appConfig ? APPCONFIG.appConfig.type : 'runtime';
            }
            // Generic coontext methods
            ...
            ContextModal.prototype.setSwacMode = function (value) {
                this.ctx.isSwacEnabled = value;
            };
            ContextModal.prototype.getSwacMode = function () {
                return this.ctx.isSwacEnabled;
            };
            return ContextModal;
        }());
        var CommonContext = /** @class */ (function () {
            ...
            CommonContext.prototype.$get = function () {
                return new ContextModal(this.APPCONFIG);
            };
...
(function (sit) {
    ...
    (function (framework) {
        var Common = /** @class */ (function () {
            function Common(globalization, logger, shell, authentication, sidePanelManager, commandBarManager, contextAreaManager, dragDropManager, swacManager, headerService, CONFIG, $state, $window, $rootScope, commandResponse, executionError, messageOverlay, globalDialog, timerService) {
        ...
        */
        ...
        var HomeCardConfiguration = /** @class */ (function () {
            ...
            HomeCardConfiguration.prototype.getAuthorizedScreens = function (UIAuthorization) {
                this.authorizedScreens = __spreadArrays(UIAuthorization.getAuthorizedScreens());
            };
