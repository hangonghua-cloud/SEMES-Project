...
(function () {
    ...
    StateListeners.$inject = ['$rootScope', '$state', '$http', '$resolve', '$stateParams', '$location', '$translate', 'common', 'LOG_TYPES', 'debug', 'CONFIG', 'APPCONFIG',
        'common.services.component.swacComponentManager', 'common.services.swac.SwacUiModuleManager', 'common.services.security.ui.authorization', 'common.services.modelDriven.warningService', '$timeout'];
    function StateListeners($rootScope, $state, $http, $resolve, $stateParams, $location, $translate, common, LOG_TYPES, debug,
        CONFIG, APPCONFIG, swacComponentManager, swacUiModuleManager, UIAuthorization, warningService) {
        ...
        function onViewContentLoaded() {
            ...
            if (swacUiModuleManager.enabled && !swacUiModuleManager.swacComponent && ($state.current.name !== undefined && $state.current.name !== '')) {
