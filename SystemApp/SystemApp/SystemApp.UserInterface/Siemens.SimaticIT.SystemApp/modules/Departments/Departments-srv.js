(function () {
    'use strict';
    angular.module('Siemens.SimaticIT.SystemApp.Departments')
        .constant('Siemens.SimaticIT.SystemApp.Departments.Departments.constants', ScreenServiceConstants())
        .service('Siemens.SimaticIT.SystemApp.Departments.Departments.service', ScreenService)
    ...
    ScreenService.$inject = ['$q', '$state', 'common.base', 'Siemens.SimaticIT.SystemApp.Departments.Departments.constants', 'common.services.logger.service'];
    function ScreenService($q, $state, base, context, loggerService) {
        ...
        activate();
        function activate() {
            logger = loggerService.getModuleLogger('Siemens.SimaticIT.SystemApp.Departments.Departments.service');
    ...
    ScreenServiceRun.$inject = ['Siemens.SimaticIT.SystemApp.Departments.Departments.constants', 'common.base'];
