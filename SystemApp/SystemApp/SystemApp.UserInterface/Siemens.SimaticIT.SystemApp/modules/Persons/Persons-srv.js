(function () {
    'use strict';
    angular.module('Siemens.SimaticIT.SystemApp.Persons')
        .constant('Siemens.SimaticIT.SystemApp.Persons.Persons.constants', ScreenServiceConstants())
        .service('Siemens.SimaticIT.SystemApp.Persons.Persons.service', ScreenService)
    ...
    ScreenService.$inject = ['$q', '$state', 'common.base', 'Siemens.SimaticIT.SystemApp.Persons.Persons.constants', 'common.services.logger.service'];
    function ScreenService($q, $state, base, context, loggerService) {
        ...
        activate();
        function activate() {
            logger = loggerService.getModuleLogger('Siemens.SimaticIT.SystemApp.Persons.Persons.service');
    ...
    ScreenServiceRun.$inject = ['Siemens.SimaticIT.SystemApp.Persons.Persons.constants', 'common.base'];
