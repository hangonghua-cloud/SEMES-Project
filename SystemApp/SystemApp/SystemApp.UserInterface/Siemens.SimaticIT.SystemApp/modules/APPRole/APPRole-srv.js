(function () {
    'use strict';
    angular.module('Siemens.SimaticIT.SystemApp.APPRole')
        .constant('Siemens.SimaticIT.SystemApp.APPRole.APPRole.constants', ScreenServiceConstants())
        .service('Siemens.SimaticIT.SystemApp.APPRole.APPRole.service', ScreenService)
    ...
    ScreenService.$inject = ['$q', '$state', 'common.base', 'Siemens.SimaticIT.SystemApp.APPRole.APPRole.constants', 'common.services.logger.service'];
    function ScreenService($q, $state, base, context, loggerService) {
        ...
        activate();
        function activate() {
            logger = loggerService.getModuleLogger('Siemens.SimaticIT.SystemApp.APPRole.APPRole.service');
    ...
    ScreenServiceRun.$inject = ['Siemens.SimaticIT.SystemApp.APPRole.APPRole.constants', 'common.base'];
