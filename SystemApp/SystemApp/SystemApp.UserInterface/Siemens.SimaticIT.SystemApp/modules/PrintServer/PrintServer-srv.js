(function () {
    'use strict';
    angular.module('Siemens.SimaticIT.SystemApp.PrintServer')
        .constant('Siemens.SimaticIT.SystemApp.PrintServer.PrintServer.constants', ScreenServiceConstants())
        .service('Siemens.SimaticIT.SystemApp.PrintServer.PrintServer.service', ScreenService)
    ...
    ScreenService.$inject = ['$q', '$state', 'common.base', 'Siemens.SimaticIT.SystemApp.PrintServer.PrintServer.constants', 'common.services.logger.service'];
    function ScreenService($q, $state, base, context, loggerService) {
        ...
        activate();
        function activate() {
            logger = loggerService.getModuleLogger('Siemens.SimaticIT.SystemApp.PrintServer.PrintServer.service');
    ...
    ScreenServiceRun.$inject = ['Siemens.SimaticIT.SystemApp.PrintServer.PrintServer.constants', 'common.base'];
