(function () {
    'use strict';
    angular.module('Siemens.SimaticIT.BasicDataManageFBApp.AppRoleManage').config(ViewScreenStateConfig);

    ViewScreenController.$inject = ['Siemens.SimaticIT.BasicDataManageFBApp.AppRoleManage.AppRoleScreen.service', '$state', '$stateParams', 'common.base', '$filter', '$scope'];
        ...
        var state = {
            ...
            views: {
                'property-area-container@': {
                    templateUrl: moduleFolder + '/AppRoleScreen-select.html',
