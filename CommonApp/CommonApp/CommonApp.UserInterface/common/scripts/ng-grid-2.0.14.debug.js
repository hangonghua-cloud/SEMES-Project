...
(function (window, $) {
    ...
    var ngColumn = function (config, $scope, grid, domUtilityService, $templateCache, $utils) {
        ...
        self.gripOnMouseUp = function (event) {
            ...
            $scope.$emit('ngGridEventColumnResize');
            return false;
        };
        self.copy = function () {
        ...
        self.assignGridEventHandlers = function () {
            ...
            var windowResize = function () {
                ...
                windowThrottle = setTimeout(function () {
                    ...
                    if (viewPort) {
                        // 70 px is the salt to render one row extra when scrolled
                        $scope._limit = Math.ceil(($scope.viewportDimHeight() + 70) / grid.config.rowHeight);
                    }
                }, 100);
            };
    ...
    ngGridDirectives.directive('ngViewport', ['$animate', function ($animate) {
        ...
        return function ($scope, elm) {
            ...
            function scroll(evt) {
                ...
                var begin = Math.ceil(scrollValue / 31) - 1;
                if (begin < 0) begin = 0;
                $scope._begin = begin;
