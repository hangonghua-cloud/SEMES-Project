(function () {
    ...
    function AlpDatePickerController($filter) {
        var vm = this;
        vm.opened = false;
    ...
    app.controller('AlpDatePickerController', ['$filter', AlpDatePickerController]);
    ...
    * ```
    */
    app.directive('sitAlpDatepicker', function () {
        return {
            scope: {},
            ...
            bindToController: {
                ...
                'dateOptions': '=?sitOptions',
                'ngDisabled': '=?',
                'ngFocus': '&?',
                'ngReadonly': '=?'
            },

            controller: 'AlpDatePickerController',
