(function () {
    'use strict';
    angular.module('CCS.CommonApp.CommonUI').config(ViewScreenStateConfig);

    ViewScreenController.$inject = ['CCS.CommonApp.CommonUI.Blank.service', '$state', '$stateParams', 'common.base', '$filter', '$scope'];
    ...
    function ViewScreenStateConfig($stateProvider) {
        var screenStateName = 'home.CCS_CommonApp_CommonUI_Blank';
        ...
        var state = {
            ...
            views: {
                'property-area-container@': {
                    templateUrl: moduleFolder + '/Blank-select.html',
