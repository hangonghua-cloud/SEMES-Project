(function () {
    ...
    angular.module('CCS.CommonApp.CommonUI')
        .constant('CCS.CommonApp.CommonUI.Demo.constants', ScreenServiceConstants())
        .service('CCS.CommonApp.CommonUI.Demo.service', ScreenService)
    ...
    ScreenService.$inject = ['$q', '$state', 'common.base', 'CCS.CommonApp.CommonUI.Demo.constants', 'common.services.logger.service'];
    function ScreenService($q, $state, base, context, loggerService) {
        ...
        activate();
        function activate() {
            logger = loggerService.getModuleLogger('CCS.CommonApp.CommonUI.Demo.service');
    ...
    ScreenServiceRun.$inject = ['CCS.CommonApp.CommonUI.Demo.constants', 'common.base'];
