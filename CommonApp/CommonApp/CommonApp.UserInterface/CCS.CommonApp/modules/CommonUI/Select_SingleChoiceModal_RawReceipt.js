(function () {
    'use strict';
    angular.module('CCS.CommonApp.CommonUI').controller('CCS.CommonApp.CommonUI.Select_SingleChoiceModal_RawReceipt',
        ['common.base', '$filter', '$scope', '$uibModalInstance','data', 'commonService',
            function (common, $filter, $scope, $modalInstance, data, commonService) {
                ...
                function loadData() {
                    ...
                    console.log('Select_SingleChoiceModal:queryParmeters');   console.log(queryParmeters);
                    //调用API 传递翻页\参数 获取数据
