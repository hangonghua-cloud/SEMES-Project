...
(function () {
    'use strict';
    angular.module('Siemens.SimaticIT.MaterialApp.Base_DataFileCon')
        .constant('Siemens.SimaticIT.MaterialApp.Base_DataFileCon.Base_DataFileCon.constants', ScreenServiceConstants())
        .service('Siemens.SimaticIT.MaterialApp.Base_DataFileCon.Base_DataFileCon.service', ScreenService)
    ...
    ScreenService.$inject = ['$q', '$state', 'common.base', 'Siemens.SimaticIT.MaterialApp.Base_DataFileCon.Base_DataFileCon.constants', 'common.services.logger.service'];
    function ScreenService($q, $state, base, context, loggerService) {
        ...
        activate();
        function activate() {
            logger = loggerService.getModuleLogger('Siemens.SimaticIT.MaterialApp.Base_DataFileCon.Base_DataFileCon.service');
    ...
    ScreenServiceRun.$inject = ['Siemens.SimaticIT.MaterialApp.Base_DataFileCon.Base_DataFileCon.constants', 'common.base'];
