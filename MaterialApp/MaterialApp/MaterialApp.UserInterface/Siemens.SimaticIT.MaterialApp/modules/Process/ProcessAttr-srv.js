(function () {
    ...
    angular.module('Siemens.SimaticIT.MaterialApp.Process')
        .constant('Siemens.SimaticIT.MaterialApp.Process.ProcessAttr.constants', ScreenServiceConstants())
        .service('Siemens.SimaticIT.MaterialApp.Process.ProcessAttr.service', ScreenService)
    ...
    ScreenService.$inject = ['$q', '$state', 'common.base', 'Siemens.SimaticIT.MaterialApp.Process.ProcessAttr.constants', 'common.services.logger.service'];
    function ScreenService($q, $state, base, context, loggerService) {
        ...
        activate();
        function activate() {
            logger = loggerService.getModuleLogger('Siemens.SimaticIT.MaterialApp.Process.ProcessAttr.service');
    ...
    ScreenServiceRun.$inject = ['Siemens.SimaticIT.MaterialApp.Process.ProcessAttr.constants', 'common.base'];
