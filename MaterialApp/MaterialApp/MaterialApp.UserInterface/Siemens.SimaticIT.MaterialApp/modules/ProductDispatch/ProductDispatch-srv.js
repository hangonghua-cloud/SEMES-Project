(function () {
    'use strict';
    angular.module('Siemens.SimaticIT.MaterialApp.ProductDispatch')
        .constant('Siemens.SimaticIT.MaterialApp.ProductDispatch.ProductDispatch.constants', ScreenServiceConstants())
        .service('Siemens.SimaticIT.MaterialApp.ProductDispatch.ProductDispatch.service', ScreenService)
    ...
    ScreenService.$inject = ['$q', '$state', 'common.base', 'Siemens.SimaticIT.MaterialApp.ProductDispatch.ProductDispatch.constants', 'common.services.logger.service'];
    function ScreenService($q, $state, base, context, loggerService) {
        ...
        activate();
        function activate() {
            logger = loggerService.getModuleLogger('Siemens.SimaticIT.MaterialApp.ProductDispatch.ProductDispatch.service');
    ...
    ScreenServiceRun.$inject = ['Siemens.SimaticIT.MaterialApp.ProductDispatch.ProductDispatch.constants', 'common.base'];
