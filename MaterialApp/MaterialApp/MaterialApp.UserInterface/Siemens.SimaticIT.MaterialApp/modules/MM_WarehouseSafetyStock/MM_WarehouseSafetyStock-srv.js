...
(function () {
    'use strict';
    angular.module('Siemens.SimaticIT.MaterialApp.MM_WarehouseSafetyStock')
        .constant('Siemens.SimaticIT.MaterialApp.MM_WarehouseSafetyStock.MM_WarehouseSafetyStock.constants', ScreenServiceConstants())
        .service('Siemens.SimaticIT.MaterialApp.MM_WarehouseSafetyStock.MM_WarehouseSafetyStock.service', ScreenService)
    ...
    ScreenService.$inject = ['$q', '$state', 'common.base', 'Siemens.SimaticIT.MaterialApp.MM_WarehouseSafetyStock.MM_WarehouseSafetyStock.constants', 'common.services.logger.service'];
    function ScreenService($q, $state, base, context, loggerService) {
        ...
        activate();
        function activate() {
            logger = loggerService.getModuleLogger('Siemens.SimaticIT.MaterialApp.MM_WarehouseSafetyStock.MM_WarehouseSafetyStock.service');
    ...
    ScreenServiceRun.$inject = ['Siemens.SimaticIT.MaterialApp.MM_WarehouseSafetyStock.MM_WarehouseSafetyStock.constants', 'common.base'];
