(function () {
    ...
    function AddScreenController(dataService, $state, $stateParams, common, $filter, $scope, commonService, auth, notificationService, busyIndicatorService, $modal, c) {
        var self = this;
        ...
        function activate() {
            ...
            sidePanelManager.setTitle(commonService.$t('Siemens.SimaticIT.MaterialApp.SupplierManage.SupplierManageaddDetailctrl.Tips_1'));
        ...
        function init() {
            ...
            self.Supplier = angular.copy($stateParams.selectedItem);
            self.currentItem = {
                SupplierCode: self.Supplier.SupplierCode
            }
        ...
        function showSelectOrganizeDialog() {
            ...
            self.dialogButtons = [{
                ...
                displayName: commonService.$t('Siemens.SimaticIT.MaterialApp.SupplierManage.SupplierManageaddDetailctrl.Tips_2'),
                ...
                displayName: commonService.$t('Siemens.SimaticIT.MaterialApp.SupplierManage.SupplierManageaddDetailctrl.Tips_3'),
                onClickCallback: function () {
                    globalDialogService.hide();
                },
                disabled: false
            ...
            var dialogData = {
                title: 'Siemens.SimaticIT.MaterialApp.SupplierManage.SupplierManageaddDetailctrl.Tips_4',
                templatedata: {
        ...
        function getOrganizeTreeData() {
            ...
            commonService.callWebApiGet(url, null).then(function (data) {
                ...
                messageservice.set({
                    ...
                    title: 'Siemens.SimaticIT.MaterialApp.SupplierManage.SupplierManageaddDetailctrl.Tips_5',
        ...
        //保存
        function save() {
            busyIndicatorService.show({ message: commonService.$t('Siemens.SimaticIT.MaterialApp.SupplierManage.SupplierManageaddDetailctrl.Tips_6') });

            if (!self.currentItem.GroupCode || self.currentItem.GroupCode.length < 0) {
                backendService.genericError(commonService.$t('Siemens.SimaticIT.MaterialApp.SupplierManage.SupplierManageaddDetailctrl.Tips_7'), commonService.$t('Siemens.SimaticIT.MaterialApp.SupplierManage.SupplierManageaddDetailctrl.Tips_8'));
        ...
        function onSaveSuccess(data) {
            ...
            if (data.data.success) {
                ...
                //关闭侧边栏
                sidePanelManager.close();
                commonService.showInfo(commonService.$t('Siemens.SimaticIT.MaterialApp.SupplierManage.SupplierManageaddDetailctrl.Tips_9'));
                //刷新局部
                //$rootScope.$emit('to-parent', 'parent');
                $state.go('^', {}, { reload: true });
            } else {
                busyIndicatorService.hide();
                backendService.genericError(data.data.returnMsg, commonService.$t('Siemens.SimaticIT.MaterialApp.SupplierManage.SupplierManageaddDetailctrl.Tips_8'));
            }
        }
        ...
        function onSaveError(error) {
            busyIndicatorService.hide();
            backendService.genericError('[' + error.status + '] - ' + error.statusText, commonService.$t('Siemens.SimaticIT.MaterialApp.SupplierManage.SupplierManageaddDetailctrl.Tips_8'));
        }
        ...
        var state = {
            ...
            views: {
                'property-area-container@': {
                    templateUrl: moduleFolder + '/SupplierManage-addDetail.html',
                    controller: AddScreenController,
                    controllerAs: 'vm'
                }
            },
            data: {
                title: 'Siemens.SimaticIT.MaterialApp.SupplierManage.SupplierManageaddDetailctrl.Tips_1'
            },
            params: {
                selectedItem: null,
            }
