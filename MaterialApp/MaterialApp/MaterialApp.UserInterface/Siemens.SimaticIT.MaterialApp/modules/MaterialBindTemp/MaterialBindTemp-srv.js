(function () {
    'use strict';
    angular.module('Siemens.SimaticIT.MaterialApp.MaterialBindTemp')
        .constant('Siemens.SimaticIT.MaterialApp.MaterialBindTemp.MaterialBindTemp.constants', ScreenServiceConstants())
        .service('Siemens.SimaticIT.MaterialApp.MaterialBindTemp.MaterialBindTemp.service', ScreenService)
    ...
    ScreenService.$inject = ['$q', '$state', 'common.base', 'Siemens.SimaticIT.MaterialApp.MaterialBindTemp.MaterialBindTemp.constants', 'common.services.logger.service'];
    function ScreenService($q, $state, base, context, loggerService) {
        ...
        activate();
        function activate() {
            logger = loggerService.getModuleLogger('Siemens.SimaticIT.MaterialApp.MaterialBindTemp.MaterialBindTemp.service');
    ...
    ScreenServiceRun.$inject = ['Siemens.SimaticIT.MaterialApp.MaterialBindTemp.MaterialBindTemp.constants', 'common.base'];
