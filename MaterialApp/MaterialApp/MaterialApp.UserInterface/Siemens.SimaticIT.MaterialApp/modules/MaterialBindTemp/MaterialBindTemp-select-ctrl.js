(function () {
    'use strict';
    angular.module('Siemens.SimaticIT.MaterialApp.MaterialBindTemp').config(ViewScreenStateConfig);

    ViewScreenController.$inject = ['Siemens.SimaticIT.MaterialApp.MaterialBindTemp.MaterialBindTemp.service', '$state', '$stateParams', 'common.base', '$filter', '$scope'];
    function ViewScreenController(dataService, $state, $stateParams, common, $filter, $scope) {
        ...
        function activate() {
            ...
            sidePanelManager.setTitle(commonService.$t('Siemens.SimaticIT.MaterialApp.MaterialBindTemp.MaterialBindTempselectctrl.Tips_1'));
        ...
        var state = {
            ...
            views: {
                'property-area-container@': {
                    templateUrl: moduleFolder + '/MaterialBindTemp-select.html',
                    controller: ViewScreenController,
                    controllerAs: 'vm'
                }
            },
            data: {
                title: 'Siemens.SimaticIT.MaterialApp.MaterialBindTemp.MaterialBindTempselectctrl.Tips_1'
            },
            params: {
                selectedItem: null,
            }
