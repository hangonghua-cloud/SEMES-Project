(function () {
    ...
    function AddScreenController(dataService, $state, $stateParams, common, $filter, $scope, commonService, auth, notificationService, busyIndicatorService, $modal, $rootScope, $interval) {
        ...
        function activate() {
            ...
            sidePanelManager.setTitle(commonService.$t('Siemens.SimaticIT.MaterialApp.TraitProcess.TraitProcessOperationaddAttrctrl.Tips_1'));
        ...
        function initDictionary() {
            self.typeSelect = {
                value: { ItemName: commonService.$t('Siemens.SimaticIT.MaterialApp.TraitProcess.TraitProcessOperationaddAttrctrl.Tips_2'), ItemValue: "" },
                options: [{ ItemName: commonService.$t('Siemens.SimaticIT.MaterialApp.TraitProcess.TraitProcessOperationaddAttrctrl.Tips_2'), ItemValue: "" }]
            }
            self.Factory = {
                value: { ResourceName: commonService.$t('Siemens.SimaticIT.MaterialApp.TraitProcess.TraitProcessOperationaddAttrctrl.Tips_2'), ResourceCode: "" },
                options: [{ ResourceName: commonService.$t('Siemens.SimaticIT.MaterialApp.TraitProcess.TraitProcessOperationaddAttrctrl.Tips_2'), ResourceCode: "" }]
            };
            self.Process = {
                value: { ResourceName: commonService.$t('Siemens.SimaticIT.MaterialApp.TraitProcess.TraitProcessOperationaddAttrctrl.Tips_2'), ResourceCode: "" },
                options: [{ ResourceName: commonService.$t('Siemens.SimaticIT.MaterialApp.TraitProcess.TraitProcessOperationaddAttrctrl.Tips_2'), ResourceCode: "" }]
            ...
            self.Attr = {
                value: { ItemName: commonService.$t('Siemens.SimaticIT.MaterialApp.TraitProcess.TraitProcessOperationaddAttrctrl.Tips_2'), ItemCode: "" },
                options: [{ ItemName: commonService.$t('Siemens.SimaticIT.MaterialApp.TraitProcess.TraitProcessOperationaddAttrctrl.Tips_2'), ItemCode: "" }]
            }
            commonService.getResourceExtendInfo({ LevelCode: "Factory" }).then(function (res) {
                if (res && res.data.success) {
                    ...
                    self.Factory.options.splice(0, 0, {
                        ResourceCode: "",
                        ResourceName: commonService.$t('Siemens.SimaticIT.MaterialApp.TraitProcess.TraitProcessOperationaddAttrctrl.Tips_2')
                    });
            ...
            commonService.callWebApiPost(url, params).then(function (res) {
                ...
                if (res && res.data.success) {
                    ...
                    self.Attr.options.splice(0, 0, {
                        ItemCode: "",
                        ItemName: commonService.$t('Siemens.SimaticIT.MaterialApp.TraitProcess.TraitProcessOperationaddAttrctrl.Tips_2')
                    });
                }
            })
        }
        ...
        function initGridOptions() {
            self.gridOptionsItem = {
                ...
                columnDefs: [
                    // {
                    //     name: commonService.$t('Siemens.SimaticIT.MaterialApp.TraitProcess.TraitProcessOperationaddAttrctrl.Tips_3'), field: 'operation', enableFiltering: false, enableSorting: false, enableColumnMenu: false,
                    ...
                    // {
                    //     field: 'MaterialName',
                    //     displayName: commonService.$t('Siemens.SimaticIT.MaterialApp.TraitProcess.TraitProcessOperationaddAttrctrl.Tips_4'),
                    ...
                    {
                        field: 'AttrCode',
                        displayName: commonService.$t('Siemens.SimaticIT.MaterialApp.TraitProcess.TraitProcessOperationaddAttrctrl.Tips_5'),
                        width: 110,
                    },
                    {
                        field: 'AttrName',
                        displayName: commonService.$t('Siemens.SimaticIT.MaterialApp.TraitProcess.TraitProcessOperationaddAttrctrl.Tips_6'),
                        width: 110
                    },

                    {
                        field: 'AttrTypeName',
                        displayName: commonService.$t('Siemens.SimaticIT.MaterialApp.TraitProcess.TraitProcessOperationaddAttrctrl.Tips_7'),
                        width: 110
                    },

                    {
                        field: 'AttrValue',
                        displayName: commonService.$t('Siemens.SimaticIT.MaterialApp.TraitProcess.TraitProcessOperationaddAttrctrl.Tips_8'),
                    ...
                    // {
                    //     field: 'MixTime',
                    //     displayName: commonService.$t('Siemens.SimaticIT.MaterialApp.TraitProcess.TraitProcessOperationaddAttrctrl.Tips_9'),
                    //     enableCellEdit: false,
        ...
        function AttrChange(oldval, newval) {
            ...
            commonService.callWebApiPost(url, queryParmeters).then(function (res) {
                    ...
                    commonService.callWebApiPost(url1, { queryJson: { OperationsId: self.currentItem.Id } }).then(function (resAttr) {
                        if (resAttr && resAttr.data.success && resAttr.data.resultData.rows.length > 0) {
                            ...
                            data.forEach((item, index, arr) => {
                                ...
                                if (item.AttrType > 3) {
                                    self.typeSelect.options = [{ ItemName: commonService.$t('Siemens.SimaticIT.MaterialApp.TraitProcess.TraitProcessOperationaddAttrctrl.Tips_2'), ItemValue: "" }];
                ...
                backendService.genericError('获取数据出错', commonService.$t('Siemens.SimaticIT.MaterialApp.TraitProcess.TraitProcessOperationaddAttrctrl.Tips_10'));
            });
        }
        ...
        function save() {
            ...
            rows.forEach((item, index, arr) => {
                if (item.AttrType > "3") {
                    ...
                    if (item.AttrValue == commonService.$t('Siemens.SimaticIT.MaterialApp.TraitProcess.TraitProcessOperationaddAttrctrl.Tips_2')) {
                        item.AttrValue = "";
                    }
            ...
            if (rows.length == 0 || flag) {
                backendService.genericError(commonService.$t('Siemens.SimaticIT.MaterialApp.TraitProcess.TraitProcessOperationaddAttrctrl.Tips_11'), commonService.$t('Siemens.SimaticIT.MaterialApp.TraitProcess.TraitProcessOperationaddAttrctrl.Tips_12'));
                return false;
            }
            ...
            busyIndicatorService.show({ message: commonService.$t('Siemens.SimaticIT.MaterialApp.TraitProcess.TraitProcessOperationaddAttrctrl.Tips_13') });
        ...
        function onSaveSuccess(data) {
            ...
            if (data.data.success) {
                ...
                //关闭侧边栏
                sidePanelManager.close();
                commonService.showInfo(commonService.$t('Siemens.SimaticIT.MaterialApp.TraitProcess.TraitProcessOperationaddAttrctrl.Tips_14'));
                //刷新局部
                $rootScope.$emit('to-parentAttr', 'parent');
                $state.go('^', {}, { reload: false });
            } else {
                busyIndicatorService.hide();
                backendService.genericError(data.data.returnMsg, commonService.$t('Siemens.SimaticIT.MaterialApp.TraitProcess.TraitProcessOperationaddAttrctrl.Tips_12'));
            }
        }
        ...
        function onSaveError(error) {
            busyIndicatorService.hide();
            backendService.genericError('[' + error.status + '] - ' + error.statusText, commonService.$t('Siemens.SimaticIT.MaterialApp.TraitProcess.TraitProcessOperationaddAttrctrl.Tips_12'));
        }
        ...
        var state = {
            ...
            views: {
                'property-area-container@': {
                    templateUrl: moduleFolder + '/TraitProcessOperation-addAttr.html',
                    controller: AddScreenController,
                    controllerAs: 'vm'
                }
            },
            data: {
                title: 'Siemens.SimaticIT.MaterialApp.TraitProcess.TraitProcessOperationaddAttrctrl.Tips_1'
            },
            params: {
                selectedItem: null
            }
