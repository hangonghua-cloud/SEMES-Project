(function () {
    'use strict';
    angular.module('Siemens.SimaticIT.MaterialApp.SupProductStockTransfer')
        .constant('Siemens.SimaticIT.MaterialApp.SupProductStockTransfer.SupProductStockTransfer.constants', ScreenServiceConstants())
        .service('Siemens.SimaticIT.MaterialApp.SupProductStockTransfer.SupProductStockTransfer.service', ScreenService)
    ...
    function ScreenServiceConstants() {
        return {
            data: {
                //appName: 'MaterialApp',
                appName: 'MaterialApp', // The name of App: in case of extended app, it is the name of AppBase
    ...
    ScreenService.$inject = ['$q', '$state', 'common.base', 'Siemens.SimaticIT.MaterialApp.SupProductStockTransfer.SupProductStockTransfer.constants', 'common.services.logger.service'];
    function ScreenService($q, $state, base, context, loggerService) {
        ...
        activate();
        function activate() {
            logger = loggerService.getModuleLogger('Siemens.SimaticIT.MaterialApp.SupProductStockTransfer.SupProductStockTransfer.service');
    ...
    ScreenServiceRun.$inject = ['Siemens.SimaticIT.MaterialApp.SupProductStockTransfer.SupProductStockTransfer.constants', 'common.base'];
