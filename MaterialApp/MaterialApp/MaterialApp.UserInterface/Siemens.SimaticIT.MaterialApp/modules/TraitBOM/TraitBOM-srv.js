(function () {
    'use strict';
    angular.module('Siemens.SimaticIT.MaterialApp.TraitBOM')
        .constant('Siemens.SimaticIT.MaterialApp.TraitBOM.TraitBOM.constants', ScreenServiceConstants())
        .service('Siemens.SimaticIT.MaterialApp.TraitBOM.TraitBOM.service', ScreenService)
    ...
    ScreenService.$inject = ['$q', '$state', 'common.base', 'Siemens.SimaticIT.MaterialApp.TraitBOM.TraitBOM.constants', 'common.services.logger.service'];
    function ScreenService($q, $state, base, context, loggerService) {
        ...
        activate();
        function activate() {
            logger = loggerService.getModuleLogger('Siemens.SimaticIT.MaterialApp.TraitBOM.TraitBOM.service');
    ...
    ScreenServiceRun.$inject = ['Siemens.SimaticIT.MaterialApp.TraitBOM.TraitBOM.constants', 'common.base'];
