(function () {
    'use strict';
    angular.module('Siemens.SimaticIT.MaterialApp.ProductDatafile')
        .constant('Siemens.SimaticIT.MaterialApp.ProductDatafile.ProductDatafile.constants', ScreenServiceConstants())
        .service('Siemens.SimaticIT.MaterialApp.ProductDatafile.ProductDatafile.service', ScreenService)
    ...
    ScreenService.$inject = ['$q', '$state', 'common.base', 'Siemens.SimaticIT.MaterialApp.ProductDatafile.ProductDatafile.constants', 'common.services.logger.service'];
    function ScreenService($q, $state, base, context, loggerService) {
        ...
        activate();
        function activate() {
            logger = loggerService.getModuleLogger('Siemens.SimaticIT.MaterialApp.ProductDatafile.ProductDatafile.service');
    ...
    ScreenServiceRun.$inject = ['Siemens.SimaticIT.MaterialApp.ProductDatafile.ProductDatafile.constants', 'common.base'];
