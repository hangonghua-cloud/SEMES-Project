(function () {
    'use strict';
    angular.module('Siemens.SimaticIT.MaterialApp.BOM')
        .constant('Siemens.SimaticIT.MaterialApp.BOM.BOM.constants', ScreenServiceConstants())
        .service('Siemens.SimaticIT.MaterialApp.BOM.BOM.service', ScreenService)
    ...
    ScreenService.$inject = ['$q', '$state', 'common.base', 'Siemens.SimaticIT.MaterialApp.BOM.BOM.constants', 'common.services.logger.service'];
    function ScreenService($q, $state, base, context, loggerService) {
        ...
        activate();
        function activate() {
            logger = loggerService.getModuleLogger('Siemens.SimaticIT.MaterialApp.BOM.BOM.service');
    ...
    ScreenServiceRun.$inject = ['Siemens.SimaticIT.MaterialApp.BOM.BOM.constants', 'common.base'];
