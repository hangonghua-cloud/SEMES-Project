(function () {
    ...
    angular.module('Siemens.SimaticIT.MaterialApp.RawMaterialStock')
        .constant('Siemens.SimaticIT.MaterialApp.RawMaterialStock.RawMaterialStock.constants', ScreenServiceConstants())
        .service('Siemens.SimaticIT.MaterialApp.RawMaterialStock.RawMaterialStock.service', ScreenService)
    ...
    ScreenService.$inject = ['$q', '$state', 'common.base', 'Siemens.SimaticIT.MaterialApp.RawMaterialStock.RawMaterialStock.constants', 'common.services.logger.service'];
    function ScreenService($q, $state, base, context, loggerService) {
        ...
        activate();
        function activate() {
            logger = loggerService.getModuleLogger('Siemens.SimaticIT.MaterialApp.RawMaterialStock.RawMaterialStock.service');
    ...
    ScreenServiceRun.$inject = ['Siemens.SimaticIT.MaterialApp.RawMaterialStock.RawMaterialStock.constants', 'common.base'];
