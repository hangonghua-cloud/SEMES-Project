(function () {
    'use strict';
    angular.module('Siemens.SimaticIT.MaterialApp.MMSaleDomestic')
        .constant('Siemens.SimaticIT.MaterialApp.MMSaleDomestic.SaleDomesticOut.constants', ScreenServiceConstants())
        .service('Siemens.SimaticIT.MaterialApp.MMSaleDomestic.SaleDomesticOut.service', ScreenService)
    ...
    ScreenService.$inject = ['$q', '$state', 'common.base', 'Siemens.SimaticIT.MaterialApp.MMSaleDomestic.SaleDomesticOut.constants', 'common.services.logger.service'];
    function ScreenService($q, $state, base, context, loggerService) {
        ...
        activate();
        function activate() {
            logger = loggerService.getModuleLogger('Siemens.SimaticIT.MaterialApp.MMSaleDomestic.SaleDomesticOut.service');
    ...
    ScreenServiceRun.$inject = ['Siemens.SimaticIT.MaterialApp.MMSaleDomestic.SaleDomesticOut.constants', 'common.base'];
