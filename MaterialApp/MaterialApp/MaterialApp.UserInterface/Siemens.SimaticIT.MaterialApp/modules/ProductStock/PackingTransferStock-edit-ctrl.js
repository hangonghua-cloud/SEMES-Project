(function () {
    ...
    EditScreenController.$inject = ['Siemens.SimaticIT.MaterialApp.ProductStock.PackingTransferStock.service', '$state', '$stateParams', 'common.base', '$filter', '$scope'];
    function EditScreenController(dataService, $state, $stateParams, common, $filter, $scope) {
        ...
        function activate() {
            ...
            sidePanelManager.setTitle(commonService.$t('Siemens.SimaticIT.MaterialApp.ProductStock.PackingTransferStockeditctrl.Tips_1'));
        ...
        var state = {
            ...
            views: {
                'property-area-container@': {
                    templateUrl: moduleFolder + '/PackingTransferStock-edit.html',
                    controller: EditScreenController,
                    controllerAs: 'vm'
                }
            },
            data: {
                title: 'Siemens.SimaticIT.MaterialApp.ProductStock.PackingTransferStockeditctrl.Tips_1'
            },
            params: {
                selectedItem: null,
            }
