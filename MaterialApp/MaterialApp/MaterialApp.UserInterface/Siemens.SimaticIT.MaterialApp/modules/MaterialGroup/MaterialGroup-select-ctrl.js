(function () {
    'use strict';
    angular.module('Siemens.SimaticIT.MaterialApp.MaterialGroup').config(ViewScreenStateConfig);

    ViewScreenController.$inject = ['Siemens.SimaticIT.MaterialApp.MaterialGroup.MaterialGroup.service', '$state', '$stateParams', 'common.base', '$filter', '$scope'];
    function ViewScreenController(dataService, $state, $stateParams, common, $filter, $scope) {
        ...
        function activate() {
            ...
            sidePanelManager.setTitle(commonService.$t('Siemens.SimaticIT.MaterialApp.MaterialGroup.MaterialGroupselectctrl.Tips_1'));
        ...
        var state = {
            ...
            views: {
                'property-area-container@': {
                    templateUrl: moduleFolder + '/MaterialGroup-select.html',
                    controller: ViewScreenController,
                    controllerAs: 'vm'
                }
            },
            data: {
                title: 'Siemens.SimaticIT.MaterialApp.MaterialGroup.MaterialGroupselectctrl.Tips_1'
            },
            params: {
                selectedItem: null,
            }
