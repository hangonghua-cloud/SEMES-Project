(function () {
    ...
    AddScreenController.$inject = ['Siemens.SimaticIT.MaterialApp.MaterialGroup.MaterialGroup.service', '$state',
    ...
    function AddScreenController(dataService, $state, $stateParams, common, $filter, $rootScope, $scope, c, notification,
        ...
        function activate() {
            ...
            sidePanelManager.setTitle(commonService.$t('Siemens.SimaticIT.MaterialApp.MaterialGroup.MaterialGroupaddDetailctrl.Tips_1'));
        ...
        function initDictionary() {
            //初始化 物料分类
            self.MaterialClass = {
                value: { ItemName: commonService.$t('Siemens.SimaticIT.MaterialApp.MaterialGroup.MaterialGroupaddDetailctrl.Tips_2'), ItemValue: "" },
                options: [{ ItemName: commonService.$t('Siemens.SimaticIT.MaterialApp.MaterialGroup.MaterialGroupaddDetailctrl.Tips_2'), ItemValue: "" }]
            };
        ...
        function initGridOptionsDetail() {
            self.gridOptionsDetail = {
                ...
                columnDefs: [
                    {
                        field: 'MaterialCode',
                        displayName: commonService.$t('Siemens.SimaticIT.MaterialApp.MaterialGroup.MaterialGroupaddDetailctrl.Tips_3'),
                        width: 120
                    },
                    {
                        field: 'MaterialName',
                        displayName: commonService.$t('Siemens.SimaticIT.MaterialApp.MaterialGroup.MaterialGroupaddDetailctrl.Tips_4'),
                        width: 120
                    },
                    {
                        field: 'Spec',
                        displayName: commonService.$t('Siemens.SimaticIT.MaterialApp.MaterialGroup.MaterialGroupaddDetailctrl.Tips_5'),
                        width: 220
                    },
                    {
                        field: 'MaterialClassName',
                        displayName: commonService.$t('Siemens.SimaticIT.MaterialApp.MaterialGroup.MaterialGroupaddDetailctrl.Tips_6'),
                        width: 120
                    },
                    {
                        field: 'SmallClassName',
                        displayName: commonService.$t('Siemens.SimaticIT.MaterialApp.MaterialGroup.MaterialGroupaddDetailctrl.Tips_7'),
                        width: 120
                    },
                    {
                        field: 'UnitName',
                        displayName: commonService.$t('Siemens.SimaticIT.MaterialApp.MaterialGroup.MaterialGroupaddDetailctrl.Tips_8'),
                        width: 100
                    },
                ],
                //---------------api---------------------
        ...
        function initGridData() {
            ...
            self.requestparam.MaterialClass = self.MaterialClass.value.ItemValue;
            self.requestparam.SmallClass = self.SmallClass.value.ItemValue;
            ...
            commonService.callWebApiPost(url, { queryJson: self.requestparam }).then(function (res) {
                    ...
                    commonService.callWebApiPost(url, param).then(function (res1) {
                        if (res1 && res1.data.success) {
                            ...
                            res.data.resultData.rows.forEach(item => {
                                if (res1.data.resultData.rows.find(t => t.MaterialCode == item.MaterialCode) == null) {
                                    data.push(item);
                                }
                            });
                ...
                backendService.genericError('获取数据出错', commonService.$t('Siemens.SimaticIT.MaterialApp.MaterialGroup.MaterialGroupaddDetailctrl.Tips_9'));
            });
        }
        ...
        function save() {
            ...
            console.log(rows);
            if (rows.length < 1) {
                backendService.genericError(commonService.$t('Siemens.SimaticIT.MaterialApp.MaterialGroup.MaterialGroupaddDetailctrl.Tips_10'), commonService.$t('Siemens.SimaticIT.MaterialApp.MaterialGroup.MaterialGroupaddDetailctrl.Tips_11'));
            ...
            busyIndicatorService.show({ message: commonService.$t('Siemens.SimaticIT.MaterialApp.MaterialGroup.MaterialGroupaddDetailctrl.Tips_12') });
        ...
        function onSaveSuccess(data) {
            ...
            if (data.data.success) {
                ...
                backendService.genericError(data.data.returnMsg, commonService.$t('Siemens.SimaticIT.MaterialApp.MaterialGroup.MaterialGroupaddDetailctrl.Tips_11'));
            }
        }
        ...
        function onSaveError(error) {
            ...
            messageservice.set({
                buttons: [{
                    id: 'ok',
                    displayName: commonService.$t('Siemens.SimaticIT.MaterialApp.MaterialGroup.MaterialGroupaddDetailctrl.Tips_13'),
                    onClickCallback: function () {
                        messageservice.hide();
                    }
                }],
                title: 'Siemens.SimaticIT.MaterialApp.MaterialGroup.MaterialGroupaddDetailctrl.Tips_14',
        ...
        var state = {
            ...
            views: {
                'property-area-container@': {
                    templateUrl: moduleFolder + '/MaterialGroup-addDetail.html',
                    controller: AddScreenController,
                    controllerAs: 'vm'
                }
            },
            data: {
                title: 'Siemens.SimaticIT.MaterialApp.MaterialGroup.MaterialGroupaddDetailctrl.Tips_15'
            },
            params: {
                selectedItem: null,
            }
