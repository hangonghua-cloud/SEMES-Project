(function () {
    'use strict';
    angular.module('Siemens.SimaticIT.MaterialApp.MaterialGroup')
        .constant('Siemens.SimaticIT.MaterialApp.MaterialGroup.MaterialGroup.constants', ScreenServiceConstants())
        .service('Siemens.SimaticIT.MaterialApp.MaterialGroup.MaterialGroup.service', ScreenService)
    ...
    ScreenService.$inject = ['$q', '$state', 'common.base', 'Siemens.SimaticIT.MaterialApp.MaterialGroup.MaterialGroup.constants', 'common.services.logger.service'];
    function ScreenService($q, $state, base, context, loggerService) {
        ...
        activate();
        function activate() {
            logger = loggerService.getModuleLogger('Siemens.SimaticIT.MaterialApp.MaterialGroup.MaterialGroup.service');
    ...
    ScreenServiceRun.$inject = ['Siemens.SimaticIT.MaterialApp.MaterialGroup.MaterialGroup.constants', 'common.base'];
