(function () {
    ...
    function AddScreenController(dataService, $state, $stateParams, common, $filter, $scope, commonService, auth,
        ...
        function activate() {
            ...
            sidePanelManager.setTitle(commonService.$t('Siemens.SimaticIT.MaterialApp.MaterialMain.MaterialMainaddctrl.Tips_1'));
        ...
        function initDictionary() {
            //初始化 物料分类
            self.MaterialClass = {
                value: { ItemName: commonService.$t('Siemens.SimaticIT.MaterialApp.MaterialMain.MaterialMainaddctrl.Tips_2'), ItemValue: "" },
                options: [{ ItemName: commonService.$t('Siemens.SimaticIT.MaterialApp.MaterialMain.MaterialMainaddctrl.Tips_2'), ItemValue: "" }]
            };
            ...
            self.Warehouse = {
                value: { ResourceName: commonService.$t('Siemens.SimaticIT.MaterialApp.MaterialMain.MaterialMainaddctrl.Tips_2'), ResourceCode: "" },
                options: [{ ResourceName: commonService.$t('Siemens.SimaticIT.MaterialApp.MaterialMain.MaterialMainaddctrl.Tips_2'), ResourceCode: "" }]
            };
            ...
            //初始化 物料小类
            self.IsEnabled = {
                value: { ItemValue: true, ItemName: commonService.$t('Siemens.SimaticIT.MaterialApp.MaterialMain.MaterialMainaddctrl.Tips_3') },
                options: [
                    { ItemValue: true, ItemName: commonService.$t('Siemens.SimaticIT.MaterialApp.MaterialMain.MaterialMainaddctrl.Tips_3') },
                    { ItemValue: false, ItemName: commonService.$t('Siemens.SimaticIT.MaterialApp.MaterialMain.MaterialMainaddctrl.Tips_4') }
                ]
            };
            self.Attr = {
                value: null,
            ...
            commonService.getResourceExtendInfo({ LevelCode: "Warehouse" }).then(function (res) {
                if (res && res.data.success) {
                    ...
                    self.Warehouse.options.splice(0, 0, {
                        ResourceCode: "",
                        ResourceName: commonService.$t('Siemens.SimaticIT.MaterialApp.MaterialMain.MaterialMainaddctrl.Tips_2')
                    });
                }
            });
            ...
            var req = commonService.callWebApiGet(url, null).then(function (res) {
                if (res && res.data.success) {
                    ...
                    self.Attr.options.splice(0, 0, {
                        TempCode: "",
                        TempName: commonService.$t('Siemens.SimaticIT.MaterialApp.MaterialMain.MaterialMainaddctrl.Tips_2')
                    });
        ...
        function initGridOptions() {
            self.gridOptionsItem = {
                ...
                columnDefs: [
                    // {
                    //     name: commonService.$t('Siemens.SimaticIT.MaterialApp.MaterialMain.MaterialMainaddctrl.Tips_5'), field: 'operation', enableFiltering: false, enableSorting: false, enableColumnMenu: false,
                    ...
                    // {
                    //     field: 'MaterialName',
                    //     displayName: commonService.$t('Siemens.SimaticIT.MaterialApp.MaterialMain.MaterialMainaddctrl.Tips_6'),
                    ...
                    {
                        field: 'AttrCode',
                        displayName: commonService.$t('Siemens.SimaticIT.MaterialApp.MaterialMain.MaterialMainaddctrl.Tips_7'),
                        width: 200,
                    },
                    {
                        field: 'AttrName',
                        displayName: commonService.$t('Siemens.SimaticIT.MaterialApp.MaterialMain.MaterialMainaddctrl.Tips_8'),
                        width: 200
                    },

                    {
                        field: 'AttrTypeName',
                        displayName: commonService.$t('Siemens.SimaticIT.MaterialApp.MaterialMain.MaterialMainaddctrl.Tips_9'),
                        width: 200
                    },

                    {
                        field: 'AttrValue',
                        displayName: commonService.$t('Siemens.SimaticIT.MaterialApp.MaterialMain.MaterialMainaddctrl.Tips_10'),
                    ...
                    // {
                    //     field: 'MixTime',
                    //     displayName: commonService.$t('Siemens.SimaticIT.MaterialApp.MaterialMain.MaterialMainaddctrl.Tips_11'),
                    //     enableCellEdit: false,
        ...
        function save() {
            ...
            busyIndicatorService.show({ message: commonService.$t('Siemens.SimaticIT.MaterialApp.MaterialMain.MaterialMainaddctrl.Tips_12') });
        ...
        function onSaveSuccess(data) {
            if (data.data.success) {
                ...
                //关闭侧边栏
                sidePanelManager.close();
                commonService.showInfo(commonService.$t('Siemens.SimaticIT.MaterialApp.MaterialMain.MaterialMainaddctrl.Tips_13'));
                //刷新局部
                //$rootScope.$emit('to-parent', 'parent');
                $state.go('^', {}, { reload: true });
            } else {
                busyIndicatorService.hide();
                backendService.genericError(data.data.returnMsg, commonService.$t('Siemens.SimaticIT.MaterialApp.MaterialMain.MaterialMainaddctrl.Tips_14'));
            }
        }
        ...
        function onSaveError(error) {
            busyIndicatorService.hide();
            backendService.genericError('[' + error.status + '] - ' + error.statusText, commonService.$t('Siemens.SimaticIT.MaterialApp.MaterialMain.MaterialMainaddctrl.Tips_14'));
        }
        ...
        var state = {
            ...
            views: {
                'property-area-container@': {
                    templateUrl: moduleFolder + '/MaterialMain-add.html',
                    controller: AddScreenController,
                    controllerAs: 'vm'
                }
            },
            data: {
                title: 'Siemens.SimaticIT.MaterialApp.MaterialMain.MaterialMainaddctrl.Tips_15'
            }
        };
