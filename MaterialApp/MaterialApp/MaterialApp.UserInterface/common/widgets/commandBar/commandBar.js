            ...
            function truncateLabel() {
                function ellipsisText(e) {
                    ...
                    if (e.innerHTML.indexOf('...') === -1) {
                        e.innerHTML = getTrunactedLabel(e.innerHTML, font, width);
                    }
                }
    ...
    function commandGroup($window) {
        ...
        return {
            ...
            template: ['<div>',
                ...
                'data-toggle="{{(cmdBarGrpBtnCtrl.layout === \'vertical\' || cmdBarGrpBtnCtrl.layout === \'contextual\')  ? \'dropdown\' : \'\' }}" data-display="static">',
                ...
                'class="dropdown-toggle MainCmdGrpdropdown" data-toggle="dropdown" data-display="static" title="{{ cmdBarGrpBtnCtrl.group.tooltip || cmdBarGrpBtnCtrl.group.label }}">',
                '<span class="caret">',
                '</span>',
                '</button>',
                '</button>',
                ...
                'data-toggle="dropdown" title="{{ cmdBarGrpBtnCtrl.group.tooltip || cmdBarGrpBtnCtrl.group.label }}" data-display="static">',
