(function () {
    'use strict';
    angular.module('Siemens.SimaticIT.BaseDataApp.KnowledgeBase')
        .constant('Siemens.SimaticIT.BaseDataApp.KnowledgeBase.KnowledgeBase.constants', ScreenServiceConstants())
        .service('Siemens.SimaticIT.BaseDataApp.KnowledgeBase.KnowledgeBase.service', ScreenService)
    ...
    ScreenService.$inject = ['$q', '$state', 'common.base', 'Siemens.SimaticIT.BaseDataApp.KnowledgeBase.KnowledgeBase.constants', 'common.services.logger.service'];
    function ScreenService($q, $state, base, context, loggerService) {
        ...
        activate();
        function activate() {
            logger = loggerService.getModuleLogger('Siemens.SimaticIT.BaseDataApp.KnowledgeBase.KnowledgeBase.service');
    ...
    ScreenServiceRun.$inject = ['Siemens.SimaticIT.BaseDataApp.KnowledgeBase.KnowledgeBase.constants', 'common.base'];
