(function () {
    ...
    angular.module('Siemens.SimaticIT.BaseDataApp.ReportManage')
        .constant('Siemens.SimaticIT.BaseDataApp.ReportManage.ReportLayout.constants', ScreenServiceConstants())
        .service('Siemens.SimaticIT.BaseDataApp.ReportManage.ReportLayout.service', ScreenService)
    ...
    ScreenService.$inject = ['$q', '$state', 'common.base', 'Siemens.SimaticIT.BaseDataApp.ReportManage.ReportLayout.constants', 'common.services.logger.service'];
    function ScreenService($q, $state, base, context, loggerService) {
        ...
        activate();
        function activate() {
            logger = loggerService.getModuleLogger('Siemens.SimaticIT.BaseDataApp.ReportManage.ReportLayout.service');
    ...
    ScreenServiceRun.$inject = ['Siemens.SimaticIT.BaseDataApp.ReportManage.ReportLayout.constants', 'common.base'];
