(function () {
    'use strict';
    angular.module('Siemens.SimaticIT.ProductionApp.PMPerformanceManage')
        .constant('Siemens.SimaticIT.ProductionApp.PMPerformanceManage.PMPerformanceManage.constants', ScreenServiceConstants())
        .service('Siemens.SimaticIT.ProductionApp.PMPerformanceManage.PMPerformanceManage.service', ScreenService)
    ...
    ScreenService.$inject = ['$q', '$state', 'common.base', 'Siemens.SimaticIT.ProductionApp.PMPerformanceManage.PMPerformanceManage.constants', 'common.services.logger.service'];
    function ScreenService($q, $state, base, context, loggerService) {
        ...
        activate();
        function activate() {
            logger = loggerService.getModuleLogger('Siemens.SimaticIT.ProductionApp.PMPerformanceManage.PMPerformanceManage.service');
    ...
    ScreenServiceRun.$inject = ['Siemens.SimaticIT.ProductionApp.PMPerformanceManage.PMPerformanceManage.constants', 'common.base'];
