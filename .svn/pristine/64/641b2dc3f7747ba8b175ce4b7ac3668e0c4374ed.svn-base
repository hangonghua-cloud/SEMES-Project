(function () {
    'use strict';
    angular.module('Siemens.SimaticIT.BaseDataApp.KeyParameter').config(ViewScreenStateConfig);

    ViewScreenController.$inject = ['Siemens.SimaticIT.BaseDataApp.KeyParameter.KeyParameter.service', '$state', '$stateParams', 'common.base', '$filter', '$scope'];
    function ViewScreenController(dataService, $state, $stateParams, common, $filter, $scope) {
        ...
        function activate() {
            ...
            sidePanelManager.setTitle(commonService.$t('Siemens.SimaticIT.BaseDataApp.KeyParameter.KeyParameterselectctrl.Tips_1'));
        ...
        var state = {
            ...
            views: {
                'property-area-container@': {
                    templateUrl: moduleFolder + '/KeyParameter-select.html',
                    controller: ViewScreenController,
                    controllerAs: 'vm'
                }
            },
            data: {
                title: 'Siemens.SimaticIT.BaseDataApp.KeyParameter.KeyParameterselectctrl.Tips_1'
            },
            params: {
                selectedItem: null,
            }
