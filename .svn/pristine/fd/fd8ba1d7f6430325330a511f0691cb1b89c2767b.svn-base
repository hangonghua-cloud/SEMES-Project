...
{
    public class QC_IQCQualityCheckItem_BLL
    {
        private QC_IQCQualityCheckItem_IService service = new QC_IQCQualityCheckItem_Service();
        /// <summary>
        /// 功能描述: 查询分页列表
        /// 创　　建: 丁零
        ...
        /// <param name="List<QC_TestDetailEntity>">实体对象数组</param>
        /// <param name="msg">输出错误内容</param>
        /// <returns>返回int 成功1, 失败0 </returns>
        ...
        /// </summary>
        /// <param name="keyValue">主键值</param>
        /// <returns>返回QC_TestDetailEntity</returns>
        ...
        /// <returns>返回QC_TestDetailEntity 对象</returns>
        ...
        /// </summary>
        /// /// <param name="condition">Expression 条件</param>
        /// <returns>返回QC_TestDetailEntity 列表</returns>
        ...
        //    //子表服务类
        //    RepositoryFactory<QC_TestDetailEntity> bomService = new RepositoryFactory<QC_TestDetailEntity>();

        //    QC_TestDetailEntity entity = this.BaseRepository().FindEntity(keyValue);
        //    //根据主表在子表的ID与主表主键查找实体, 如果是多条,使用循环遍历删除
        //    QC_TestDetailDetailEntity bomEntity = bomService.BaseRepository().IQueryable(t => t.QC_TestDetail_Id == entity.Id).FirstOrDefault();
        //    if (entity != null)
        //    {
        //        //主表删除标记
