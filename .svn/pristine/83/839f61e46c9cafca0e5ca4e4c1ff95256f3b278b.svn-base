...
namespace ALP.Application.Service.BaseManage
{
    ...
    public class ModuleService : RepositoryFactory<ModuleEntity>, IModuleService
    {
        ...
        public IEnumerable<ModuleEntity> GetList()
        {
            ...
            strSql.Append("SELECT * FROM bASE_Module where  EnabledMark=1 Order By SortCode");
        ...
        /// </summary>
        /// <returns></returns>
        public IEnumerable<ModuleEntity> GetIsMenuList()
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("SELECT * FROM bASE_Module where  EnabledMark=1  AND IsMenu=1 Order By SortCode");
            return this.BaseRepository().FindList(strSql.ToString());
        }
        /// <summary>
        /// 功能实体
