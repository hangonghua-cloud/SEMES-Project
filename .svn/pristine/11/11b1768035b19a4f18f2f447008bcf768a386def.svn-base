(function () {
    'use strict';
    angular.module('Siemens.SimaticIT.ProductionApp.WorkOrderBatch')
        .constant('Siemens.SimaticIT.ProductionApp.WorkOrderBatch.WorkOrderBatch.constants', ScreenServiceConstants())
        .service('Siemens.SimaticIT.ProductionApp.WorkOrderBatch.WorkOrderBatch.service', ScreenService)
    ...
    ScreenService.$inject = ['$q', '$state', 'common.base', 'Siemens.SimaticIT.ProductionApp.WorkOrderBatch.WorkOrderBatch.constants', 'common.services.logger.service'];
    function ScreenService($q, $state, base, context, loggerService) {
        ...
        activate();
        function activate() {
            logger = loggerService.getModuleLogger('Siemens.SimaticIT.ProductionApp.WorkOrderBatch.WorkOrderBatch.service');
    ...
    ScreenServiceRun.$inject = ['Siemens.SimaticIT.ProductionApp.WorkOrderBatch.WorkOrderBatch.constants', 'common.base'];
