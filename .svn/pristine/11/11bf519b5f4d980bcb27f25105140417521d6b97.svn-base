...
{ 
    ...
    /// 1.创建日期: 2021-08-05
    /// 2.创建作者: 王坤
    /// 3.功能描述: EP_EquipmentMaintainDetailService 业务服务类
    /// 4.任务编号: 设备保养项目详情
    /// 5.最后修改日期: 
    /// 6.最后修改作者: 
    /// </summary>
    public class EP_EquipmentMaintainDetail_Service : RepositoryFactory<EP_EquipmentMaintainDetailEntity>
    { 
        /// <summary>
        /// 功能描述: 查询分页列表
        /// 创　　建: 王坤
        ...
        public IEnumerable<EP_EquipmentMaintainDetailEntity> GetPageList(Pagination pagination, string queryJson)
        {
            ...
            sql.Append(@"SELECT 
                      ...
                      ,[ModifyBy]
                      ,[ModifyTime]
                  FROM [dbo].[EP_EquipmentMaintainDetail] where IsDeleted = 0 ");
            ...
            if (!string.IsNullOrEmpty(queryJson))
            {
                ...
                //保养项目标准 是否为空进行查询
                if (!queryParam["EquipmentMaintainStandard"].IsEmpty())
                {
                    //sql.Append($" AND EquipmentMaintainStandard = N'{queryParam["EquipmentMaintainStandard"]}'");
                    sql.Append($" AND EquipmentMaintainStandard like N'%{queryParam["EquipmentMaintainStandard"]}%'");
                }
                //数据类型 是否为空进行查询
        ...
        public DataTable GetPageDataTableList(Pagination pagination, string queryJson)
        {
            ...
            sql.Append(@"SELECT Id,
                               ...
                               Creator,
                               CreateTime,
                               dbo.get_dicName('DataType', DataType) AS DataTypeName
                        FROM EP_EquipmentMaintainDetail
                        WHERE EnabledMark = 1 ");
            var parameter = new List<DbParameter>();
            if (!string.IsNullOrEmpty(queryJson))
            {
        ...
        /// <returns>返回分页列表</returns>
        public IEnumerable<EP_EquipmentMaintainDetailEntity> GetList(string checkType, out string msg)
        {
            StringBuilder sql = new StringBuilder();
            sql.Append(@"SELECT 
                      [Id]
        ...
        public int SaveEntity(string keyValue, EP_EquipmentMaintainDetailEntity entity, out string msg)
        {
            int n = 0;
            msg = "";
            try
            {
                ...
                {
                    EP_EquipmentMaintainDetailEntity _entity = this.BaseRepository().FindEntity(t => t.EnabledMark == true && t.EquipmentMaintainId == entity.EquipmentMaintainId && t.EquipmentTaskId == entity.EquipmentTaskId);
                    if (_entity == null)
                    {
                        entity.Create();
        ...
        /// <param name="List<EP_EquipmentMaintainDetailEntity>">实体对象数组</param>
        /// <param name="msg">输出错误内容</param>
        /// <returns>返回int 成功1, 失败0 </returns>
        public int SaveEntity_List(bool IsUpdate, string CreatedByName, List<EP_EquipmentMaintainDetailEntity> entity_list, out string msg)
        {
            int n = 0;
            msg = "";
            try
            {
                if (IsUpdate)
                {
                    ...
                    if (entity_list.Count > 0)
                    {
                        foreach (var Save_obj in entity_list)
                        {
                            ...
                            sql_temp.Append("UPDATE [dbo].[EP_EquipmentMaintainDetail] set ");
                            string keyValue = "";
                            //循环实体
                ...
                else
                {
                    ...
                    StringBuilder sql = new StringBuilder();
                    sql.Append($@"INSERT INTO [dbo].[EP_EquipmentMaintainDetail] (
                                            [Id]
                                            ,[EquipmentTaskId]
                                            ,[EquipmentMaintainId]
                                            ,[EquipmentMaintainName]
                    ...
                    if (entity_list.Count > 0)
                    {
                        foreach (var Save_obj in entity_list)
                        {
                            sql.Append($@"(
                                ...
                                ,N'{Save_obj.EquipmentMaintainStandard}'
                                ,N'{Save_obj.DataType}'
                                ,N'{Save_obj.Creator}'
        ...
        {
            int result = 0;
            EP_EquipmentMaintainDetailEntity entity = this.BaseRepository().FindEntity(keyValue);
            if (entity != null)
            {
                //删除禁用标记
        ...
        public int Delete_SQL(string keyValue, out string msg)
        {
            ...
            {
                StringBuilder sql = new StringBuilder();
                sql.Append($@"DELETE FROM [dbo].[EP_EquipmentMaintainDetail] WHERE Id=N'{keyValue}'");
                n = this.BaseRepository().ExecuteBySql(sql.ToString());
            }
            catch (Exception ex)
            {
        ...
        /// </summary>
        /// <param name="keyValue">主键值</param>
        /// <returns>返回EP_EquipmentMaintainDetailEntity</returns>
        public EP_EquipmentMaintainDetailEntity GetEntity(string keyValue)
        {
        ...
        /// <returns>返回EP_EquipmentMaintainDetailEntity</returns>
        public EP_EquipmentMaintainDetailEntity GetEntityByQuery(string QueryField)
        {
        ...
        /// <returns>返回EP_EquipmentMaintainDetailEntity 对象</returns>
        public EP_EquipmentMaintainDetailEntity Get_ExpressionEntity(Expression<Func<EP_EquipmentMaintainDetailEntity, bool>> condition)
        {
            // 根据实际情况更换某字段, 这个字段内容在列表是唯一值
        ...
        /// </summary>
        /// /// <param name="condition">Expression 条件</param>
        /// <returns>返回EP_EquipmentMaintainDetailEntity 列表</returns>
        public IEnumerable<EP_EquipmentMaintainDetailEntity> Get_ExpressionList(Expression<Func<EP_EquipmentMaintainDetailEntity, bool>> condition)
        {
            // 根据实际情况更换某字段, 这个字段内容在列表是唯一值
        ...
        //    StringBuilder sql = new StringBuilder();
        //    //子表服务类
        //    RepositoryFactory<EP_EquipmentMaintainDetailEntity> bomService = new RepositoryFactory<EP_EquipmentMaintainDetailEntity>();
        
        //    EP_EquipmentMaintainDetailEntity entity = this.BaseRepository().FindEntity(keyValue);
        //    //根据主表在子表的ID与主表主键查找实体, 如果是多条,使用循环遍历删除
        //    EP_EquipmentMaintainDetailDetailEntity bomEntity = bomService.BaseRepository().IQueryable(t => t.EP_EquipmentMaintainDetail_Id == entity.Id).FirstOrDefault();
        //    if (entity != null)
        //    {
        //        //主表删除标记
        ...
        /// <returns>返回分页列表</returns>
        public IEnumerable<EP_EquipmentMaintainDetailEntity> GetList_TestOtherEntity(string checkType, out string msg)
        {
            StringBuilder sql = new StringBuilder();
            ...
            try
            {
                ...
                //实体映射查询
                IEnumerable<EP_EquipmentMaintainDetailEntity> EP_EquipmentMaintainDetailEntity_list =  db2.FindList<EP_EquipmentMaintainDetailEntity>(sql.ToString());
                return EP_EquipmentMaintainDetailEntity_list;
            }
            catch (Exception ex)
            {
                msg = ex.Message;
        ...
        public DataTable GetDataTable_TestOtherEntity(string checkType, out string msg)
        {
            ...
            try
            {
                ...
                Data.Dapper.SqlDatabase db2 = new Data.Dapper.SqlDatabase();
                //实体映射查询
                DataTable EP_EquipmentMaintainDetailEntity_DataTable = db2.FindTable(sql.ToString());
                return EP_EquipmentMaintainDetailEntity_DataTable;
            }
            catch (Exception ex)
            {
                msg = ex.Message;
        ...
        /*public string GetList_export(string checkType, out string msg)
        {
            StringBuilder sql = new StringBuilder();
            sql.Append(@"SELECT 
                      [EquipmentTaskId] as '保养任务编号'
                      ,[EquipmentMaintainId] as '保养项目编号'
                      ,[EquipmentMaintainName] as '保养项目名称'
                      ,[EquipmentMaintainStandard] as '保养项目标准'
                      ,[DataType] as '数据类型'
                      ,[Creator] as '创建人'
                      ,[CreateTime] as '创建时间'
                      ,[ModifyBy] as '最后修改人'
        ...
        public List<dynamic> GetEP_EquipmentMaintainDetailList(string queryJson)
        {
            StringBuilder sql = new StringBuilder();
            sql.Append(@"select Id,EquipmentTaskId,EquipmentMaintainId,EquipmentMaintainName,EquipmentMaintainStandard,DataType,Creator,CreateTime,
                        dbo.get_dicName('DataType', DataType) as DataTypeName,'' as EquipmentMaintainResult
                        from EP_EquipmentMaintainDetail 
                        where EnabledMark=1  
				   ");
            var parameter = new List<DbParameter>();
            if (!string.IsNullOrEmpty(queryJson))
            {
                ...
                if (!queryParam["EquipmentTaskId"].IsEmpty())
                {
                    sql.Append($" AND EquipmentTaskId = '{queryParam["EquipmentTaskId"]}'");
                }                
            }
            try
            {
