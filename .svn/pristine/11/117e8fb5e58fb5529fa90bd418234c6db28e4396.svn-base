...
namespace Siemens.SimaticIT.MasterData.BasicDataManageFBLib.MSModel.Commands
{
    ...
    /// Class initialize
    /// </summary>
    public partial class UpdateAppPasswordCmdHandlerShell : ICommandHandler
    {
        ...
        public Response Execute(IUnifiedSdk unifiedSdk, ICommand command)
        {
            ...
            return UpdateAppPasswordCmdHandler((UpdateAppPasswordCmd)command);
        }
        ...
        {
            return typeof(UpdateAppPasswordCmd);
        }
    }
}
