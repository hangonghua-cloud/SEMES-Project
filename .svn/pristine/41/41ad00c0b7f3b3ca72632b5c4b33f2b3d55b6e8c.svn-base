(function () {
    'use strict';
    angular.module('Siemens.SimaticIT.PlanApp.WorkOrderManage')
        .constant('Siemens.SimaticIT.PlanApp.WorkOrderManage.WorkOrder.constants', ScreenServiceConstants())
        .service('Siemens.SimaticIT.PlanApp.WorkOrderManage.WorkOrder.service', ScreenService)
    ...
    ScreenService.$inject = ['$q', '$state', 'common.base', 'Siemens.SimaticIT.PlanApp.WorkOrderManage.WorkOrder.constants', 'common.services.logger.service'];
    function ScreenService($q, $state, base, context, loggerService) {
        ...
        activate();
        function activate() {
            logger = loggerService.getModuleLogger('Siemens.SimaticIT.PlanApp.WorkOrderManage.WorkOrder.service');
    ...
    ScreenServiceRun.$inject = ['Siemens.SimaticIT.PlanApp.WorkOrderManage.WorkOrder.constants', 'common.base'];
