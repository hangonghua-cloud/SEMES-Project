(function () {
    ...
    ViewScreenController.$inject = ['Siemens.SimaticIT.ProductionApp.TransferCardResume.RawMaterialComplete.service', '$state', '$stateParams', 'common.base', '$filter', '$scope'];
        ...
        var state = {
            ...
            views: {
                'property-area-container@': {
                    templateUrl: moduleFolder + '/RawMaterialComplete-select.html',
