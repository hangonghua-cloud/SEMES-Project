...
{ 
    ...
    /// 1.创建日期: 2021-10-20
    /// 2.创建作者: admin
    /// 3.功能描述: MM_ProductReworkBGService 业务服务类
    /// 4.任务编号: 成品返工报工
    /// 5.最后修改日期: 
    /// 6.最后修改作者: 
    /// </summary>
    public class MM_ProductReworkBG_Service : RepositoryFactory<MM_ProductReworkBGEntity>
    { 
        /// <summary>
        /// 功能描述: 查询分页列表
        /// 创　　建: admin
        ...
        public IEnumerable<MM_ProductReworkBGEntity> GetPageList(Pagination pagination, string queryJson)
        {
            ...
            sql.Append(@"SELECT 
                      ...
                      ,[ModifyBy]
                      ,[ModifyTime]
                  FROM [dbo].[MM_ProductReworkBG] where 1=1 ");
        ...
        /// <returns>返回分页列表</returns>
        public IEnumerable<MM_ProductReworkBGEntity> GetList(string checkType, out string msg)
        {
            StringBuilder sql = new StringBuilder();
            sql.Append(@"SELECT 
                      [Id]
        ...
        public int SaveEntity(string keyValue, MM_ProductReworkBGEntity entity, out string msg)
        {
            int n = 0;
            msg = "";
            try
        ...
        /// <param name="List<MM_ProductReworkBGEntity>">实体对象数组</param>
        /// <param name="msg">输出错误内容</param>
        /// <returns>返回int 成功1, 失败0 </returns>
        public int SaveEntity_List(bool IsUpdate, string CreatedByName, List<MM_ProductReworkBGEntity> entity_list, out string msg)
        {
            int n = 0;
            msg = "";
            try
            {
                if (IsUpdate)
                {
                    ...
                    if (entity_list.Count > 0)
                    {
                        foreach (var Save_obj in entity_list)
                        {
                            ...
                            sql_temp.Append("UPDATE [dbo].[MM_ProductReworkBG] set ");
                            string keyValue = "";
                            //循环实体
                ...
                else
                {
                    ...
                    StringBuilder sql = new StringBuilder();
                    sql.Append($@"INSERT INTO [dbo].[MM_ProductReworkBG] (
                                            [Id]
                                            ,[ReworkOrder]
                                            ,[ProcessCode]
                                            ,[ProductOrder]
                    ...
                    if (entity_list.Count > 0)
                    {
                        foreach (var Save_obj in entity_list)
                        {
                            sql.Append($@"(
                                ...
                                ,{Save_obj.PieceQty},{Save_obj.BadQty}
                                ,N'{Save_obj.Creator}'
        ...
        {
            int result = 0;
            MM_ProductReworkBGEntity entity = this.BaseRepository().FindEntity(keyValue);
            if (entity != null)
            {
                //删除禁用标记
        ...
        public int Delete_SQL(string keyValue, out string msg)
        {
            ...
            {
                StringBuilder sql = new StringBuilder();
                sql.Append($@"DELETE FROM [dbo].[MM_ProductReworkBG] WHERE Id=N'{keyValue}'");
                n = this.BaseRepository().ExecuteBySql(sql.ToString());
            }
            catch (Exception ex)
            {
        ...
        /// </summary>
        /// <param name="keyValue">主键值</param>
        /// <returns>返回MM_ProductReworkBGEntity</returns>
        public MM_ProductReworkBGEntity GetEntity(string keyValue)
        {
        ...
        /// <returns>返回MM_ProductReworkBGEntity</returns>
        public MM_ProductReworkBGEntity GetEntityByQuery(string QueryField)
        {
        ...
        /// <returns>返回MM_ProductReworkBGEntity 对象</returns>
        public MM_ProductReworkBGEntity Get_ExpressionEntity(Expression<Func<MM_ProductReworkBGEntity, bool>> condition)
        {
            // 根据实际情况更换某字段, 这个字段内容在列表是唯一值
        ...
        /// </summary>
        /// /// <param name="condition">Expression 条件</param>
        /// <returns>返回MM_ProductReworkBGEntity 列表</returns>
        public IEnumerable<MM_ProductReworkBGEntity> Get_ExpressionList(Expression<Func<MM_ProductReworkBGEntity, bool>> condition)
        {
            // 根据实际情况更换某字段, 这个字段内容在列表是唯一值
        ...
        //    StringBuilder sql = new StringBuilder();
        //    //子表服务类
        //    RepositoryFactory<MM_ProductReworkBGEntity> bomService = new RepositoryFactory<MM_ProductReworkBGEntity>();
        
        //    MM_ProductReworkBGEntity entity = this.BaseRepository().FindEntity(keyValue);
        //    //根据主表在子表的ID与主表主键查找实体, 如果是多条,使用循环遍历删除
        //    MM_ProductReworkBGDetailEntity bomEntity = bomService.BaseRepository().IQueryable(t => t.MM_ProductReworkBG_Id == entity.Id).FirstOrDefault();
        //    if (entity != null)
        //    {
        //        //主表删除标记
        ...
        /// <returns>返回分页列表</returns>
        public IEnumerable<MM_ProductReworkBGEntity> GetList_TestOtherEntity(string checkType, out string msg)
        {
            StringBuilder sql = new StringBuilder();
            ...
            try
            {
                ...
                //实体映射查询
                IEnumerable<MM_ProductReworkBGEntity> MM_ProductReworkBGEntity_list =  db2.FindList<MM_ProductReworkBGEntity>(sql.ToString());
                return MM_ProductReworkBGEntity_list;
            }
            catch (Exception ex)
            {
                msg = ex.Message;
        ...
        public DataTable GetDataTable_TestOtherEntity(string checkType, out string msg)
        {
            ...
            try
            {
                ...
                Data.Dapper.SqlDatabase db2 = new Data.Dapper.SqlDatabase();
                //实体映射查询
                DataTable MM_ProductReworkBGEntity_DataTable = db2.FindTable(sql.ToString());
                return MM_ProductReworkBGEntity_DataTable;
            }
            catch (Exception ex)
            {
                msg = ex.Message;
        ...
        public string GetList_export(string checkType, out string msg)
        {
            ...
            try
            {
                ...
                string saveFileName = "成品返工报工_" + DateTime.Now.ToString("yyyy-MM-dd-HHmm") + ".xls";
                
                ExcelHelper Excel = new ExcelHelper();
                MemoryStream ms = Excel.DataTableToExcel("成品返工报工", dt, true);
                //保存
