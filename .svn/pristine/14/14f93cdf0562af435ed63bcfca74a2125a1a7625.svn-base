(function () {
    'use strict';
    angular.module('Siemens.SimaticIT.MaterialApp.MaterialMain')
        .constant('Siemens.SimaticIT.MaterialApp.MaterialMain.FactoryMaterial.constants', ScreenServiceConstants())
        .service('Siemens.SimaticIT.MaterialApp.MaterialMain.FactoryMaterial.service', ScreenService)
    ...
    ScreenService.$inject = ['$q', '$state', 'common.base', 'Siemens.SimaticIT.MaterialApp.MaterialMain.FactoryMaterial.constants', 'common.services.logger.service'];
    function ScreenService($q, $state, base, context, loggerService) {
        ...
        activate();
        function activate() {
            logger = loggerService.getModuleLogger('Siemens.SimaticIT.MaterialApp.MaterialMain.FactoryMaterial.service');
    ...
    ScreenServiceRun.$inject = ['Siemens.SimaticIT.MaterialApp.MaterialMain.FactoryMaterial.constants', 'common.base'];
