...
namespace Siemens.SimaticIT.MasterData.BasicDataManageFBLib.MSModel.Commands
{
    ...
    /// Class initialize
    /// </summary>
    public partial class UpdateAppModelCmdHandlerShell : ICommandHandler
    {
        ...
        public Response Execute(IUnifiedSdk unifiedSdk, ICommand command)
        {
            ...
            return UpdateAppModelCmdHandler((UpdateAppModelCmd)command);
        }
        ...
        {
            return typeof(UpdateAppModelCmd);
        }
    }
}
