...
{ 
    ...
    /// 1.创建日期: 2021-09-23
    /// 2.创建作者: liyongguo
    /// 3.功能描述: QC_PollingDetailResult实体
    /// 4.任务编号: 巡检检验记录表明细
    /// 5.最后修改日期: 
    /// 6.最后修改作者: 
    /// </summary>
    public class QC_PollingDetailResultEntity : BaseEntity
    { 
        #region 表: QC_PollingDetailResult 实体类: QC_PollingDetailResult 
        ...
        /// 流转卡编码
        /// </summary>
        public string PollingDetailId {get; set; } = "";
