(function () {
    'use strict';
    angular.module('Siemens.SimaticIT.MaterialApp.ProductStock')
        .constant('Siemens.SimaticIT.MaterialApp.ProductStock.PackingTransferStock.constants', ScreenServiceConstants())
        .service('Siemens.SimaticIT.MaterialApp.ProductStock.PackingTransferStock.service', ScreenService)
    ...
    ScreenService.$inject = ['$q', '$state', 'common.base', 'Siemens.SimaticIT.MaterialApp.ProductStock.PackingTransferStock.constants', 'common.services.logger.service'];
    function ScreenService($q, $state, base, context, loggerService) {
        ...
        activate();
        function activate() {
            logger = loggerService.getModuleLogger('Siemens.SimaticIT.MaterialApp.ProductStock.PackingTransferStock.service');
    ...
    ScreenServiceRun.$inject = ['Siemens.SimaticIT.MaterialApp.ProductStock.PackingTransferStock.constants', 'common.base'];
