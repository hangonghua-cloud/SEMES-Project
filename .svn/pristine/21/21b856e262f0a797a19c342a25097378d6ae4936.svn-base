using ALP.Application.Entity.PublicInfoManage;
using ALP.Application.IService.PublicInfoManage;
using ALP.Data;
...
namespace ALP.Application.Service.PublicInfoManage
{
    /// <summary>
    /// 版 本 6.1
    /// Copyright (c) 
...
#pragma warning disable CS1572 // XML 注释中有“asterisk”的 param 标记，但是没有该名称的参数
#pragma warning disable CS1573 // 参数“sterisk”在“EmailContentService.SteriskEmail(string, int)”的 XML 注释中没有匹配的 param 标记(但其他参数有)
        /// <summary>
        /// 设置邮件星标/取消星标
        /// </summary>
        /// <param name="keyValue">主键</param>
...
#pragma warning restore CS1573 // 参数“sterisk”在“EmailContentService.SteriskEmail(string, int)”的 XML 注释中没有匹配的 param 标记(但其他参数有)
#pragma warning restore CS1572 // XML 注释中有“asterisk”的 param 标记，但是没有该名称的参数
        {
            EmailAddresseeEntity emailAddresseeEntity = new EmailAddresseeEntity();
            emailAddresseeEntity.AddresseeId = keyValue;
