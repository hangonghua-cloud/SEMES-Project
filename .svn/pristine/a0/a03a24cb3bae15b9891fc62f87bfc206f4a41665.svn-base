    ...
    public class BaseShiftController : ApiBaseController
    {
        ...
        public HttpResponseMessage GetPageListJson(JObject jo)
        {
            ...
            try
            {
                ...
                {
                    result.success = false;
                    result.returnMsg = "BaseManage.BaseShiftController.Tips_1";
                    return Request.CreateResponse(HttpStatusCode.OK, result);
                }
        ...
        public HttpResponseMessage GetFormJson(Guid keyValue)
        {
            ...
            try
            {
                ...
                result.success = true;
                result.returnMsg = "BaseManage.BaseShiftController.Tips_2";
                return Request.CreateResponse(HttpStatusCode.OK, result);
            }
            catch (Exception ex)
            {
        ...
        public HttpResponseMessage Delete(JObject jo)
        {
            ...
            try
            {
                ...
                {
                    result.success = false;
                    result.returnMsg = "BaseManage.BaseShiftController.GetSerialNo.Tips_1";//用户名不能为空！
                    return Request.CreateResponse(HttpStatusCode.OK, result);
                }
                else
                {
                    ...
                    result.success = true;
                    result.returnMsg = "Common.DeleteSuccess";
                    return Request.CreateResponse(HttpStatusCode.OK, result);
                }
            }
            catch (Exception ex)
        ...
        public HttpResponseMessage Save(JObject jo)
        {
            ...
            try
            {
                ...
                {
                    result.success = false;
                    result.returnMsg = "KeyValue Is Null！";
                    return Request.CreateResponse(HttpStatusCode.OK, result);
                }
                if (jo.SelectToken("Entity") == null)
                {
                    result.success = false;
                    result.returnMsg = "Entity Is Null！";
                    return Request.CreateResponse(HttpStatusCode.OK, result);
                }
                ...
                {
                    result.success = false;
                    result.returnMsg = "BaseManage.BaseShiftController.Save.Tips_1";//用户名不能为空！
                    return Request.CreateResponse(HttpStatusCode.OK, result);
                }
                else
                {
