(function () {
    ...
    EditScreenController.$inject = ['Siemens.SimaticIT.ProductionApp.TransferCardResume.BeforeSlottingInventory.service', '$state', '$stateParams', 'common.base', '$filter', '$scope'];
        ...
        var state = {
            ...
            views: {
                'property-area-container@': {
                    templateUrl: moduleFolder + '/BeforeSlottingInventory-edit.html',
