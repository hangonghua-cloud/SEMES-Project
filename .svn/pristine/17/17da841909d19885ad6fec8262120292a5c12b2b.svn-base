(function () {
    'use strict';
    angular.module('Siemens.SimaticIT.SystemApp.Sys_DataSegregateLabel')
        .constant('Siemens.SimaticIT.SystemApp.Sys_DataSegregateLabel.Sys_DataSegregateLabel.constants', ScreenServiceConstants())
        .service('Siemens.SimaticIT.SystemApp.Sys_DataSegregateLabel.Sys_DataSegregateLabel.service', ScreenService)
    ...
    function ScreenServiceConstants() {
        return {
            data: {
                //appName: 'SystemApp',
                appName: 'SystemApp', // The name of App: in case of extended app, it is the name of AppBase
    ...
    ScreenService.$inject = ['$q', '$state', 'common.base', 'Siemens.SimaticIT.SystemApp.Sys_DataSegregateLabel.Sys_DataSegregateLabel.constants', 'common.services.logger.service'];
    function ScreenService($q, $state, base, context, loggerService) {
        ...
        activate();
        function activate() {
            logger = loggerService.getModuleLogger('Siemens.SimaticIT.SystemApp.Sys_DataSegregateLabel.Sys_DataSegregateLabel.service');
    ...
    ScreenServiceRun.$inject = ['Siemens.SimaticIT.SystemApp.Sys_DataSegregateLabel.Sys_DataSegregateLabel.constants', 'common.base'];
