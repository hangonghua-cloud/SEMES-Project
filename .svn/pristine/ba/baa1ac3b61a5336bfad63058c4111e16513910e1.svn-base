(function () {
    'use strict';
    angular.module('Siemens.SimaticIT.ProductionApp.ReworkRecord')
        .constant('Siemens.SimaticIT.ProductionApp.ReworkRecord.ReworkRecord.constants', ScreenServiceConstants())
        .service('Siemens.SimaticIT.ProductionApp.ReworkRecord.ReworkRecord.service', ScreenService)
    ...
    ScreenService.$inject = ['$q', '$state', 'common.base', 'Siemens.SimaticIT.ProductionApp.ReworkRecord.ReworkRecord.constants', 'common.services.logger.service'];
    function ScreenService($q, $state, base, context, loggerService) {
        ...
        activate();
        function activate() {
            logger = loggerService.getModuleLogger('Siemens.SimaticIT.ProductionApp.ReworkRecord.ReworkRecord.service');
    ...
    ScreenServiceRun.$inject = ['Siemens.SimaticIT.ProductionApp.ReworkRecord.ReworkRecord.constants', 'common.base'];
