...
/* 'applicationServiceUrls': { "PlanApp": "http://localhost:80/sit-svc/Application/PlanApp/odata"}, */
/* 'applicationSignalManagerUrls': { "PlanApp": "http://localhost:80/sit-svc/Application/PlanApp/signals" }, */
