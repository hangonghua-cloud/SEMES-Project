(function () {
    'use strict';
    angular.module('Siemens.SimaticIT.ProductionApp.PrinterWorkOrderBG')
        .constant('Siemens.SimaticIT.ProductionApp.PrinterWorkOrderBG.PrinterWorkOrderBG.constants', ScreenServiceConstants())
        .service('Siemens.SimaticIT.ProductionApp.PrinterWorkOrderBG.PrinterWorkOrderBG.service', ScreenService)
    ...
    ScreenService.$inject = ['$q', '$state', 'common.base', 'Siemens.SimaticIT.ProductionApp.PrinterWorkOrderBG.PrinterWorkOrderBG.constants', 'common.services.logger.service'];
    function ScreenService($q, $state, base, context, loggerService) {
        ...
        activate();
        function activate() {
            logger = loggerService.getModuleLogger('Siemens.SimaticIT.ProductionApp.PrinterWorkOrderBG.PrinterWorkOrderBG.service');
    ...
    ScreenServiceRun.$inject = ['Siemens.SimaticIT.ProductionApp.PrinterWorkOrderBG.PrinterWorkOrderBG.constants', 'common.base'];
