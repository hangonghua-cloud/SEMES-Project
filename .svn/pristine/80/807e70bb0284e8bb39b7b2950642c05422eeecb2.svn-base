(function () {
    'use strict';
    angular.module('Siemens.SimaticIT.ProductionApp.MaterialBatchUpRecord').config(ViewScreenStateConfig);

    ViewScreenController.$inject = ['Siemens.SimaticIT.ProductionApp.MaterialBatchUpRecord.MaterialBatchUpRecord.service', '$state', '$stateParams', 'common.base', '$filter', '$scope'];
    ...
    function ViewScreenStateConfig($stateProvider) {
        var screenStateName = 'home.Siemens_SimaticIT_ProductionApp_MaterialBatchUpRecord_MaterialBatchUpRecord';
        ...
        var state = {
            ...
            views: {
                'property-area-container@': {
                    templateUrl: moduleFolder + '/MaterialBatchUpRecord-select.html',
