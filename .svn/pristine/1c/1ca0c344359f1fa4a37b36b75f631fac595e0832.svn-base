(function () {
    'use strict';
    angular.module('Siemens.SimaticIT.SystemApp.AppUserInfo').config(ViewScreenStateConfig);

    ViewScreenController.$inject = ['Siemens.SimaticIT.SystemApp.AppUserInfo.AppUserInfo.service', '$state', '$stateParams', 'common.base', '$filter', '$scope'];
        ...
        var state = {
            ...
            views: {
                'property-area-container@': {
                    templateUrl: moduleFolder + '/AppUserInfo-select.html',
