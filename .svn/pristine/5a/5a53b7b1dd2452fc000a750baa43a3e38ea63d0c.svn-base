...
namespace Siemens.SimaticIT.MasterData.ButtonAuthFBLib.MSModel.Commands
{
    ...
    /// Class initialize
    /// </summary>
    public partial class ProductionOrderImportWOHandlerShell : ICommandHandler
    {
        ...
        public Response Execute(IUnifiedSdk unifiedSdk, ICommand command)
        {
            ...
            return ProductionOrderImportWOHandler((ProductionOrderImportWO)command);
        }
        ...
        {
            return typeof(ProductionOrderImportWO);
        }
    }
}
