(function () {
    ...
    angular.module('Siemens.SimaticIT.ProductionApp.FormulaManage')
        .constant('Siemens.SimaticIT.ProductionApp.FormulaManage.FormulaBG.constants', ScreenServiceConstants())
        .service('Siemens.SimaticIT.ProductionApp.FormulaManage.FormulaBG.service', ScreenService)
    ...
    ScreenService.$inject = ['$q', '$state', 'common.base', 'Siemens.SimaticIT.ProductionApp.FormulaManage.FormulaBG.constants', 'common.services.logger.service'];
    function ScreenService($q, $state, base, context, loggerService) {
        ...
        activate();
        function activate() {
            logger = loggerService.getModuleLogger('Siemens.SimaticIT.ProductionApp.FormulaManage.FormulaBG.service');
    ...
    ScreenServiceRun.$inject = ['Siemens.SimaticIT.ProductionApp.FormulaManage.FormulaBG.constants', 'common.base'];
