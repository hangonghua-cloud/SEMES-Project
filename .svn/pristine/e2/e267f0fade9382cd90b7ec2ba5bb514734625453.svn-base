(function () {
    'use strict';
    angular.module('Siemens.SimaticIT.PlanApp.ProductRule').config(ViewScreenStateConfig);

    ViewScreenController.$inject = ['Siemens.SimaticIT.PlanApp.ProductRule.ProductRule.service', '$state', '$stateParams', 'common.base', '$filter', '$scope'];
        ...
        var state = {
            ...
            views: {
                'property-area-container@': {
                    templateUrl: moduleFolder + '/ProductRule-select.html',
