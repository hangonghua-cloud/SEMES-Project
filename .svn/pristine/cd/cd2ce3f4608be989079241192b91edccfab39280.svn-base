(function () {
    'use strict';
    angular.module('Siemens.SimaticIT.MaterialApp.MMReceiptNotice')
        .constant('Siemens.SimaticIT.MaterialApp.MMReceiptNotice.ReceiptNotice.constants', ScreenServiceConstants())
        .service('Siemens.SimaticIT.MaterialApp.MMReceiptNotice.ReceiptNotice.service', ScreenService)
    ...
    ScreenService.$inject = ['$q', '$state', 'common.base', 'Siemens.SimaticIT.MaterialApp.MMReceiptNotice.ReceiptNotice.constants', 'common.services.logger.service'];
    function ScreenService($q, $state, base, context, loggerService) {
        ...
        activate();
        function activate() {
            logger = loggerService.getModuleLogger('Siemens.SimaticIT.MaterialApp.MMReceiptNotice.ReceiptNotice.service');
    ...
    ScreenServiceRun.$inject = ['Siemens.SimaticIT.MaterialApp.MMReceiptNotice.ReceiptNotice.constants', 'common.base'];
