...
namespace Siemens.SimaticIT.MasterData.ButtonAuthFBLib.MSModel.Commands
{
    ...
    /// Class initialize
    /// </summary>
    public partial class ProductionOrderDelWOHandlerShell : ICommandHandler
    {
        ...
        public Response Execute(IUnifiedSdk unifiedSdk, ICommand command)
        {
            ...
            return ProductionOrderDelWOHandler((ProductionOrderDelWO)command);
        }
        ...
        {
            return typeof(ProductionOrderDelWO);
        }
    }
}
