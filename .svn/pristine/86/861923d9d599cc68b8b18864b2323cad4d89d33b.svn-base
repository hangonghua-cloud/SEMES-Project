...
{ 
    ...
    /// 1.创建日期: 2021-10-29
    /// 2.创建作者: liyongguo
    /// 3.功能描述: MM_SaleDomesticOutDetailService 业务服务类
    /// 4.任务编号: 内销发货单
    /// 5.最后修改日期: 
    /// 6.最后修改作者: 
    /// </summary>
    public class MM_SaleDomesticOutDetail_Service : RepositoryFactory<MM_SaleDomesticOutDetailEntity>
    { 
        /// <summary>
        /// 功能描述: 查询分页列表
        /// 创　　建: liyongguo
        ...
        public IEnumerable<MM_SaleDomesticOutDetailEntity> GetPageList(Pagination pagination, string queryJson)
        {
            ...
            sql.Append(@"SELECT 
                      ...
                      ,[ModifyBy]
                      ,[ModifyTime]
                  FROM [dbo].[MM_SaleDomesticOutDetail] where 1=1  ");
            ...
            if (!string.IsNullOrEmpty(queryJson))
            {
                ...
                //发货人名称 是否为空进行查询
                if (!queryParam["OperatorName"].IsEmpty())
                {
                    //sql.Append($" AND OperatorName = N'{queryParam["OperatorName"]}'");
                    sql.Append($" AND OperatorName like N'%{queryParam["OperatorName"]}%'");
                }
        ...
        public DataTable GetPageDataTableList(Pagination pagination, string queryJson)
        {
            ...
            sql.Append(@"  SELECT M.[Id],
                               ...
                               M.[ModifyBy],
                               M.[ModifyTime]
                        FROM [dbo].[MM_SaleDomesticOutDetail] M
        ...
        /// <returns>返回分页列表</returns>
        public IEnumerable<MM_SaleDomesticOutDetailEntity> GetList(string checkType, out string msg)
        {
            StringBuilder sql = new StringBuilder();
            sql.Append(@"SELECT 
                      [Id]
        ...
        public int SaveEntity(string keyValue, MM_SaleDomesticOutDetailEntity entity, out string msg)
        {
            int n = 0;
            msg = "";
            try
        ...
        /// <param name="List<MM_SaleDomesticOutDetailEntity>">实体对象数组</param>
        /// <param name="msg">输出错误内容</param>
        /// <returns>返回int 成功1, 失败0 </returns>
        public int SaveEntity_List(bool IsUpdate, string CreatedByName, List<MM_SaleDomesticOutDetailEntity> entity_list, out string msg)
        {
            int n = 0;
            msg = "";
            try
                ...
                if (IsUpdate)
                {
                    ...
                    if (entity_list.Count > 0)
                    {
                        foreach (var Save_obj in entity_list)
                        {
                            ...
                            sql_temp.Append("UPDATE [dbo].[MM_SaleDomesticOutDetail] set ");
                            string keyValue = "";
                            //循环实体
        ...
        {
            int result = 0;
            MM_SaleDomesticOutDetailEntity entity = this.BaseRepository().FindEntity(keyValue);
            if (entity != null)
            { 
        ...
        public int RemoveForm(Expression<Func<MM_SaleDomesticOutDetailEntity, bool>> condition)
        {
        ...
        public int Delete_SQL(string keyValue, out string msg)
        {
            ...
            {
                StringBuilder sql = new StringBuilder();
                sql.Append($@"DELETE FROM [dbo].[MM_SaleDomesticOutDetail] WHERE Id=N'{keyValue}'");
                n = this.BaseRepository().ExecuteBySql(sql.ToString());
            }
            catch (Exception ex)
            {
        ...
        /// </summary>
        /// <param name="keyValue">主键值</param>
        /// <returns>返回MM_SaleDomesticOutDetailEntity</returns>
        public MM_SaleDomesticOutDetailEntity GetEntity(string keyValue)
        {
        ...
        /// <returns>返回MM_SaleDomesticOutDetailEntity</returns>
        public MM_SaleDomesticOutDetailEntity GetEntityByQuery(string QueryField)
        {
        ...
        /// <returns>返回MM_SaleDomesticOutDetailEntity 对象</returns>
        public MM_SaleDomesticOutDetailEntity Get_ExpressionEntity(Expression<Func<MM_SaleDomesticOutDetailEntity, bool>> condition)
        {
            // 根据实际情况更换某字段, 这个字段内容在列表是唯一值
        ...
        /// </summary>
        /// /// <param name="condition">Expression 条件</param>
        /// <returns>返回MM_SaleDomesticOutDetailEntity 列表</returns>
        public IEnumerable<MM_SaleDomesticOutDetailEntity> Get_ExpressionList(Expression<Func<MM_SaleDomesticOutDetailEntity, bool>> condition)
        {
            // 根据实际情况更换某字段, 这个字段内容在列表是唯一值
        ...
        //    StringBuilder sql = new StringBuilder();
        //    //子表服务类
        //    RepositoryFactory<MM_SaleDomesticOutDetailEntity> bomService = new RepositoryFactory<MM_SaleDomesticOutDetailEntity>();
        
        //    MM_SaleDomesticOutDetailEntity entity = this.BaseRepository().FindEntity(keyValue);
        //    //根据主表在子表的ID与主表主键查找实体, 如果是多条,使用循环遍历删除
        //    MM_SaleDomesticOutDetailDetailEntity bomEntity = bomService.BaseRepository().IQueryable(t => t.MM_SaleDomesticOutDetail_Id == entity.Id).FirstOrDefault();
        //    if (entity != null)
        //    {
        //        //主表删除标记
        ...
        /// <returns>返回分页列表</returns>
        public IEnumerable<MM_SaleDomesticOutDetailEntity> GetList_TestOtherEntity(string checkType, out string msg)
        {
            StringBuilder sql = new StringBuilder();
            ...
            try
            {
                ...
                //实体映射查询
                IEnumerable<MM_SaleDomesticOutDetailEntity> MM_SaleDomesticOutDetailEntity_list =  db2.FindList<MM_SaleDomesticOutDetailEntity>(sql.ToString());
                return MM_SaleDomesticOutDetailEntity_list;
            }
            catch (Exception ex)
            {
                msg = ex.Message;
        ...
        public DataTable GetDataTable_TestOtherEntity(string checkType, out string msg)
        {
            ...
            try
            {
                ...
                Data.Dapper.SqlDatabase db2 = new Data.Dapper.SqlDatabase();
                //实体映射查询
                DataTable MM_SaleDomesticOutDetailEntity_DataTable = db2.FindTable(sql.ToString());
                return MM_SaleDomesticOutDetailEntity_DataTable;
            }
            catch (Exception ex)
            {
                msg = ex.Message;
        ...
        public string GetList_export(string checkType, out string msg)
        {
            ...
            try
            {
                ...
                string saveFileName = "内销发货单_" + DateTime.Now.ToString("yyyy-MM-dd-HHmm") + ".xls";
                
                ExcelHelper Excel = new ExcelHelper();
                MemoryStream ms = Excel.DataTableToExcel("内销发货单", dt, true);
                //保存
