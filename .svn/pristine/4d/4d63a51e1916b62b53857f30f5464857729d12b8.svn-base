(function () {
    'use strict';
    angular.module('Siemens.SimaticIT.MaterialApp.SuperProductStock')
        .constant('Siemens.SimaticIT.MaterialApp.SuperProductStock.SuperProductStockManage.constants', ScreenServiceConstants())
        .service('Siemens.SimaticIT.MaterialApp.SuperProductStock.SuperProductStockManage.service', ScreenService)
    ...
    ScreenService.$inject = ['$q', '$state', 'common.base', 'Siemens.SimaticIT.MaterialApp.SuperProductStock.SuperProductStockManage.constants', 'common.services.logger.service'];
    function ScreenService($q, $state, base, context, loggerService) {
        ...
        activate();
        function activate() {
            logger = loggerService.getModuleLogger('Siemens.SimaticIT.MaterialApp.SuperProductStock.SuperProductStockManage.service');
    ...
    ScreenServiceRun.$inject = ['Siemens.SimaticIT.MaterialApp.SuperProductStock.SuperProductStockManage.constants', 'common.base'];
