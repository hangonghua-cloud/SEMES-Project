...
namespace Siemens.SimaticIT.MasterData.ButtonAuthFBLib.MSModel.Commands
{
    ...
    /// Class initialize
    /// </summary>
    public partial class ProductDispatchAddHandlerShell : ICommandHandler
    {
        ...
        public Response Execute(IUnifiedSdk unifiedSdk, ICommand command)
        {
            ...
            return ProductDispatchAddHandler((ProductDispatchAdd)command);
        }
        ...
        {
            return typeof(ProductDispatchAdd);
        }
    }
}
