(function () {
    'use strict';
    angular.module('Siemens.SimaticIT.MaterialApp.TraitProcess').config(ListScreenRouteConfig);

    ListScreenController.$inject = ['Siemens.SimaticIT.MaterialApp.TraitProcess.TraitProcessOperation.service', '$state', '$stateParams',
    ...
    function ListScreenController(dataService, $state, $stateParams, $rootScope, $scope, base, loggerService, notificationService,
        ...
        function init() {
            ...
            rootstate = 'home.Siemens_SimaticIT_MaterialApp_TraitProcess_TraitProcessOperation';
            ...
            self.selectButtonHandler = selectButtonHandler;//导入
        ...
        function initDictionary() {
            ...
            //初始化 物料分类
            // self.MaterialClass = {
            //     value: { ItemName: commonService.$t('Siemens.SimaticIT.MaterialApp.TraitProcess.TraitProcessOperationlistctrl.Tips_1'), ItemValue: "" },
            //     options: [{ ItemName: commonService.$t('Siemens.SimaticIT.MaterialApp.TraitProcess.TraitProcessOperationlistctrl.Tips_1'), ItemValue: "" }]
            // };
            ...
            // };
            self.typeFactory = {
                value: { ResourceName: commonService.$t('Siemens.SimaticIT.MaterialApp.TraitProcess.TraitProcessOperationlistctrl.Tips_1'), ResourceCode: "" },
                options: [{ ResourceName: commonService.$t('Siemens.SimaticIT.MaterialApp.TraitProcess.TraitProcessOperationlistctrl.Tips_1'), ResourceCode: "" }]
            }
            ...
            commonService.getResourceExtendInfo({ LevelCode: "Factory" }).then(function (res) {
                if (res && res.data.success) {
                    ...
                    self.typeFactory.options.splice(0, 0, {
                        ResourceCode: "",
                        ResourceName: commonService.$t('Siemens.SimaticIT.MaterialApp.TraitProcess.TraitProcessOperationlistctrl.Tips_1')
                    });
                    initGridData();
                }
            });
        ...
        function initGridOptions() {
            self.gridOptions = {
                ...
                columnDefs: [
                    {
                        name: 'rowNum', displayName: commonService.$t('Siemens.SimaticIT.MaterialApp.TraitProcess.TraitProcessOperationlistctrl.Tips_2'), width: 80, enableSorting: false, cellTemplate:
                            '<div class="ui-grid-cell-contents">{{grid.renderContainers.body.visibleRowCache.indexOf(row) + 1}}</div>'
                    },
                    {
                        field: 'FactoryName',
                        displayName: commonService.$t('Siemens.SimaticIT.MaterialApp.TraitProcess.TraitProcessOperationlistctrl.Tips_3'),
                        width: 120
                    },
                    {
                        field: 'ProcessCode',
                        displayName: commonService.$t('Siemens.SimaticIT.MaterialApp.TraitProcess.TraitProcessOperationlistctrl.Tips_4'),
                        width: 120
                    },
                    {
                        field: 'ProcessName',
                        displayName: commonService.$t('Siemens.SimaticIT.MaterialApp.TraitProcess.TraitProcessOperationlistctrl.Tips_5'),
                        width: 120
                    },
                    // {
                    //     field: 'MaterialClass',
                    //     displayName: commonService.$t('Siemens.SimaticIT.MaterialApp.TraitProcess.TraitProcessOperationlistctrl.Tips_6'),
                    //     width: 100
                    // },
                    {
                        field: 'MaterialClass', //特征名称
                        displayName: commonService.$t('Siemens.SimaticIT.MaterialApp.TraitProcess.TraitProcessOperationlistctrl.Tips_7'),
                        width: 120
                    },
                    // {
                    //     field: 'SmallClass',
                    ...
                    // },
                    {
                        field: 'SmallClass', //特征值
                        displayName: commonService.$t('Siemens.SimaticIT.MaterialApp.TraitProcess.TraitProcessOperationlistctrl.Tips_8'),
                        width: 120
                    },
                    {
                        field: 'IsDefault',
                        displayName: commonService.$t('Siemens.SimaticIT.MaterialApp.TraitProcess.TraitProcessOperationlistctrl.Tips_9'),
                        width: 170,
                        cellTemplate:
                    ...
                    {
                        field: 'Remark',
                        displayName: commonService.$t('Siemens.SimaticIT.MaterialApp.TraitProcess.TraitProcessOperationlistctrl.Tips_10'),
                        width: 200
                    },
                    {
                        field: 'Creator',
                        displayName: commonService.$t('Siemens.SimaticIT.MaterialApp.TraitProcess.TraitProcessOperationlistctrl.Tips_11'),
                        width: 200
                    },
                    {
                        field: 'CreateTime',
                        displayName: commonService.$t('Siemens.SimaticIT.MaterialApp.TraitProcess.TraitProcessOperationlistctrl.Tips_12'),
                        width: 200,
                        type: 'date',
                    ...
                    {
                        field: 'ModifyBy',
                        displayName: commonService.$t('Siemens.SimaticIT.MaterialApp.TraitProcess.TraitProcessOperationlistctrl.Tips_13'),
                        width: 200
                    },
                    {
                        field: 'ModifyTime',
                        displayName: commonService.$t('Siemens.SimaticIT.MaterialApp.TraitProcess.TraitProcessOperationlistctrl.Tips_14'),
                        width: 200,
                        type: 'date',
                        cellFilter: 'date:"yyyy-MM - dd HH: mm: ss"'//'YYYY-MM-DD HH:mm:ss'//'alpDatetimeFilter'
                    }
        ...
        function initGridData() {
            ...
            if (!self.typeFactory.value.ResourceCode) {
                commonService.showWarning(commonService.$t('Siemens.SimaticIT.MaterialApp.TraitProcess.TraitProcessOperationlistctrl.Tips_15'));
                return;
            }
            ...
            self.searchParams.ProcessType = "2";
            let queryParmeters = {
            ...
            commonService.callWebApiPost(url, queryParmeters).then(function (res) {
                ...
                backendService.genericError('获取数据出错', commonService.$t('Siemens.SimaticIT.MaterialApp.TraitProcess.TraitProcessOperationlistctrl.Tips_16'));
            });
        }
        ...
        function CopyButtonHandler() {
            ...
            if (self.gridOptionsDetail.data != null) {
                ...
                commonService.showInfo(commonService.$t('Siemens.SimaticIT.MaterialApp.TraitProcess.TraitProcessOperationlistctrl.Tips_17'));
            } else {
                backendService.genericError(commonService.$t('Siemens.SimaticIT.MaterialApp.TraitProcess.TraitProcessOperationlistctrl.Tips_18'));
                return;
            }
        }
        ...
        function stickButtonHandler() {
            ...
            if (self.selectedItem != null) {
                ...
                backendService.genericError(commonService.$t('Siemens.SimaticIT.MaterialApp.TraitProcess.TraitProcessOperationlistctrl.Tips_19'));
                return;
            }
            ...
            busyIndicatorService.show({ message: commonService.$t('Siemens.SimaticIT.MaterialApp.TraitProcess.TraitProcessOperationlistctrl.Tips_20') });
            var req = commonService.callWebApiPost(url, postData).then(function (res) {
                ...
                backendService.genericError('[' + error.status + '] - ' + error.statusText + '-' + error.data.returnMsg, commonService.$t('Siemens.SimaticIT.MaterialApp.TraitProcess.TraitProcessOperationlistctrl.Tips_16'));
            });
        }
        ...
        function deleteButtonHandler(clickedCommand) {
            var title = commonService.$t('Siemens.SimaticIT.MaterialApp.TraitProcess.TraitProcessOperationlistctrl.Tips_21');
            var text = commonService.$t('Siemens.SimaticIT.MaterialApp.TraitProcess.TraitProcessOperationlistctrl.Tips_22');
            backendService.confirm(text, function () {
                ...
                commonService.callWebApiPost(url, postData).then(function (res) {
                    ...
                    if ((res) && (res.data.success)) {
                        ...
                        //backendService.genericError('[' + res.status + '] - ' + res.statusText + '-' + res.data.returnMsg, commonService.$t('Siemens.SimaticIT.MaterialApp.TraitProcess.TraitProcessOperationlistctrl.Tips_23'));
                    }
                }, function (error) {
        ...
        function initGridOptionsDetail() {
            self.gridOptionsDetail = {
                ...
                columnDefs: [
                    ...
                    {
                        field: 'SN',
                        displayName: commonService.$t('Siemens.SimaticIT.MaterialApp.TraitProcess.TraitProcessOperationlistctrl.Tips_24'),
                        width: 120
                    },
                    {
                        field: 'FactoryName',
                    ...
                    {
                        field: 'OperationCode',
                        displayName: commonService.$t('Siemens.SimaticIT.MaterialApp.TraitProcess.TraitProcessOperationlistctrl.Tips_25'),
                        width: 120
                    },
                    {
                        field: 'OperationName',
                        displayName: commonService.$t('Siemens.SimaticIT.MaterialApp.TraitProcess.TraitProcessOperationlistctrl.Tips_26'),
                        width: 120
                    },
                    {
                        field: 'CuringCycle',
                        displayName: commonService.$t('Siemens.SimaticIT.MaterialApp.TraitProcess.TraitProcessOperationlistctrl.Tips_27'),
                        width: 160
                    },
                ],
                //---------------api---------------------
        ...
        function initGridDataDetail() {
            ...
            if (self.selectedItem != null) {
                ...
                backendService.genericError(commonService.$t('Siemens.SimaticIT.MaterialApp.TraitProcess.TraitProcessOperationlistctrl.Tips_28'), commonService.$t('Siemens.SimaticIT.MaterialApp.TraitProcess.TraitProcessOperationlistctrl.Tips_29'));
                return;
            }
        ...
        function initGridOptionsAttr() {
            self.gridOptionsAttr = {
                ...
                columnDefs: [
                    ...
                    {
                        field: 'AttrCode',
                        displayName: commonService.$t('Siemens.SimaticIT.MaterialApp.TraitProcess.TraitProcessOperationlistctrl.Tips_30'),
                        width: 120
                    },
                    {
                        field: 'AttrName',
                        displayName: commonService.$t('Siemens.SimaticIT.MaterialApp.TraitProcess.TraitProcessOperationlistctrl.Tips_31'),
                        width: 120
                    },
                    {
                        field: 'SortCode',
                    ...
                    {
                        field: 'AttrValue',
                        displayName: commonService.$t('Siemens.SimaticIT.MaterialApp.TraitProcess.TraitProcessOperationlistctrl.Tips_32'),
                        width: 160
                    },
        ...
        function initGridDataAttr() {
            //console.log(commonService.$t('Siemens.SimaticIT.MaterialApp.TraitProcess.TraitProcessOperationlistctrl.Tips_33'));
            self.selectedItemAttr = null;
            self.isAttrButtonVisible = false;
        ...
        function add3ButtonHandler() {
            if (!self.selectedItem.FactoryCode || !self.selectedItemDetail.OperationCode) {
                backendService.genericError(commonService.$t('Siemens.SimaticIT.MaterialApp.TraitProcess.TraitProcessOperationlistctrl.Tips_34'), commonService.$t('Siemens.SimaticIT.MaterialApp.TraitProcess.TraitProcessOperationlistctrl.Tips_16'));
                return false;
            }
            var params = {
    ...
    function ListScreenRouteConfig($stateProvider) {
        var moduleStateName = 'home.Siemens_SimaticIT_MaterialApp_TraitProcess';
        var moduleStateUrl = 'Siemens.SimaticIT_MaterialApp_TraitProcess';
        var moduleFolder = 'Siemens.SimaticIT.MaterialApp/modules/TraitProcess';

        var state = {
            name: moduleStateName + '_TraitProcessOperation',
            url: '/' + moduleStateUrl + '_TraitProcessOperation',
            views: {
                'Canvas@': {
                    templateUrl: moduleFolder + '/TraitProcessOperation-list.html',
                    controller: ListScreenController,
                    controllerAs: 'vm'
                }
            },
            data: {
                title: 'Siemens.SimaticIT.MaterialApp.TraitProcess.TraitProcessOperationlistctrl.Tips_35'
            }
        };
