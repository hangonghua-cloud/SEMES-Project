...
{
    public class Base_MaterialFactoryBLL
    {
        private Base_MaterialFactoryIService service = new Base_MaterialFactory_Service();
        ...
        {
            return service.GetListSelect(queryJson);
        }
