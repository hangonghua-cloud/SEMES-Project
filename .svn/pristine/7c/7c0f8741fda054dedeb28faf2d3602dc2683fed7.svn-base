...
{ 
    ...
    /// 1.创建日期: 2021-10-09
    /// 2.创建作者: liyongguo
    /// 3.功能描述: QC_OQCQualityCheckItem实体
    /// 4.任务编号: OQC检验记录
    /// 5.最后修改日期: 
    /// 6.最后修改作者: 
    /// </summary>
    public class QC_OQCQualityCheckItemEntity : BaseEntity
    { 
        #region 表: QC_OQCQualityCheckItem 实体类: QC_OQCQualityCheckItem 
        ...
        /// 检验记录Id
        /// </summary>
        public string OQCQualityCheckId {get; set; } = "";
        /// <summary>
        /// 工厂编码
        /// </summary>
