...
namespace Siemens.SimaticIT.MasterData.ButtonAuthFBLib.MSModel.Commands
{
    ...
    /// Class initialize
    /// </summary>
    public partial class RawMaterialStockManageOutWhs2HandlerShell : ICommandHandler
    {
        ...
        public Response Execute(IUnifiedSdk unifiedSdk, ICommand command)
        {
            ...
            return RawMaterialStockManageOutWhs2Handler((RawMaterialStockManageOutWhs2)command);
        }
        ...
        {
            return typeof(RawMaterialStockManageOutWhs2);
        }
    }
}
