(function () {
    'use strict';
    angular.module('Siemens.SimaticIT.MaterialApp.RawMaterialOut')
        .constant('Siemens.SimaticIT.MaterialApp.RawMaterialOut.RawMaterialConsumption.constants', ScreenServiceConstants())
        .service('Siemens.SimaticIT.MaterialApp.RawMaterialOut.RawMaterialConsumption.service', ScreenService)
    ...
    ScreenService.$inject = ['$q', '$state', 'common.base', 'Siemens.SimaticIT.MaterialApp.RawMaterialOut.RawMaterialConsumption.constants', 'common.services.logger.service'];
    function ScreenService($q, $state, base, context, loggerService) {
        ...
        activate();
        function activate() {
            logger = loggerService.getModuleLogger('Siemens.SimaticIT.MaterialApp.RawMaterialOut.RawMaterialConsumption.service');
    ...
    ScreenServiceRun.$inject = ['Siemens.SimaticIT.MaterialApp.RawMaterialOut.RawMaterialConsumption.constants', 'common.base'];
