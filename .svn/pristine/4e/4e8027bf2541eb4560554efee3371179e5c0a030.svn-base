(function () {
    ...
    angular.module('Siemens.SimaticIT.MaterialApp.MMSaleDomestic')
        .constant('Siemens.SimaticIT.MaterialApp.MMSaleDomestic.SaleDomestic.constants', ScreenServiceConstants())
        .service('Siemens.SimaticIT.MaterialApp.MMSaleDomestic.SaleDomestic.service', ScreenService)
    ...
    ScreenService.$inject = ['$q', '$state', 'common.base', 'Siemens.SimaticIT.MaterialApp.MMSaleDomestic.SaleDomestic.constants', 'common.services.logger.service'];
    function ScreenService($q, $state, base, context, loggerService) {
        ...
        activate();
        function activate() {
            logger = loggerService.getModuleLogger('Siemens.SimaticIT.MaterialApp.MMSaleDomestic.SaleDomestic.service');
    ...
    ScreenServiceRun.$inject = ['Siemens.SimaticIT.MaterialApp.MMSaleDomestic.SaleDomestic.constants', 'common.base'];
