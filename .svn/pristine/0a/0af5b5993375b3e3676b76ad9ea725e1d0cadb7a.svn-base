(function () {
    'use strict';
    angular.module('Siemens.SimaticIT.ProductionApp.ScrapRecord')
        .constant('Siemens.SimaticIT.ProductionApp.ScrapRecord.ScrapRecord.constants', ScreenServiceConstants())
        .service('Siemens.SimaticIT.ProductionApp.ScrapRecord.ScrapRecord.service', ScreenService)
    ...
    ScreenService.$inject = ['$q', '$state', 'common.base', 'Siemens.SimaticIT.ProductionApp.ScrapRecord.ScrapRecord.constants', 'common.services.logger.service'];
    function ScreenService($q, $state, base, context, loggerService) {
        ...
        activate();
        function activate() {
            logger = loggerService.getModuleLogger('Siemens.SimaticIT.ProductionApp.ScrapRecord.ScrapRecord.service');
    ...
    ScreenServiceRun.$inject = ['Siemens.SimaticIT.ProductionApp.ScrapRecord.ScrapRecord.constants', 'common.base'];
