(function () {
    'use strict';
    angular.module('Siemens.SimaticIT.ProductionApp.PMOperationPalletNum')
        .constant('Siemens.SimaticIT.ProductionApp.PMOperationPalletNum.PMOperationPalletNum.constants', ScreenServiceConstants())
        .service('Siemens.SimaticIT.ProductionApp.PMOperationPalletNum.PMOperationPalletNum.service', ScreenService)
    ...
    ScreenService.$inject = ['$q', '$state', 'common.base', 'Siemens.SimaticIT.ProductionApp.PMOperationPalletNum.PMOperationPalletNum.constants', 'common.services.logger.service'];
    function ScreenService($q, $state, base, context, loggerService) {
        ...
        activate();
        function activate() {
            logger = loggerService.getModuleLogger('Siemens.SimaticIT.ProductionApp.PMOperationPalletNum.PMOperationPalletNum.service');
    ...
    ScreenServiceRun.$inject = ['Siemens.SimaticIT.ProductionApp.PMOperationPalletNum.PMOperationPalletNum.constants', 'common.base'];
