...
namespace Siemens.SimaticIT.MasterData.BasicDataManageFBLib.MSModel.Commands
{
    ...
    /// Class initialize
    /// </summary>
    public partial class GetFactoryModelCmdHandlerShell : ICommandHandler
    {
        ...
        public Response Execute(IUnifiedSdk unifiedSdk, ICommand command)
        {
            ...
            return GetFactoryModelCmdHandler((GetFactoryModelCmd)command);
        }
        ...
        {
            return typeof(GetFactoryModelCmd);
        }
    }
}
