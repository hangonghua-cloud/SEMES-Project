...
namespace Siemens.SimaticIT.MasterData.ButtonAuthFBLib.MSModel.Commands
{
    ...
    /// Class initialize
    /// </summary>
    public partial class ProductionOrderImportPrdHandlerShell : ICommandHandler
    {
        ...
        public Response Execute(IUnifiedSdk unifiedSdk, ICommand command)
        {
            ...
            return ProductionOrderImportPrdHandler((ProductionOrderImportPrd)command);
        }
        ...
        {
            return typeof(ProductionOrderImportPrd);
        }
    }
}
