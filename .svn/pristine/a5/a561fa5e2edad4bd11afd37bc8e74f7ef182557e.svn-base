(function () {
    'use strict';
    angular.module('Siemens.SimaticIT.MaterialApp.TraitBOM').config(ViewScreenStateConfig);

    ViewScreenController.$inject = ['Siemens.SimaticIT.MaterialApp.TraitBOM.TraitBOM.service', '$state', '$stateParams', 'common.base', '$filter', '$scope'];
    function ViewScreenController(dataService, $state, $stateParams, common, $filter, $scope) {
        ...
        function activate() {
            ...
            sidePanelManager.setTitle(commonService.$t('Siemens.SimaticIT.MaterialApp.TraitBOM.TraitBOMselectctrl.Tips_1'));
        ...
        var state = {
            ...
            views: {
                'property-area-container@': {
                    templateUrl: moduleFolder + '/TraitBOM-select.html',
                    controller: ViewScreenController,
                    controllerAs: 'vm'
                }
            },
            data: {
                title: 'Siemens.SimaticIT.MaterialApp.TraitBOM.TraitBOMselectctrl.Tips_1'
            },
            params: {
                selectedItem: null,
            }
