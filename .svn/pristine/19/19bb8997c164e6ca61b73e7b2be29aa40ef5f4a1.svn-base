...
/* 'applicationServiceUrls': { "ButtonAuthFBApp": "http://localhost:80/sit-svc/Application/ButtonAuthFBApp/odata"}, */
/* 'applicationSignalManagerUrls': { "ButtonAuthFBApp": "http://localhost:80/sit-svc/Application/ButtonAuthFBApp/signals" }, */
