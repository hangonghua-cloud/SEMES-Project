...
namespace ALP.Application.Busines.BaseManage
{
    ...
    /// 描 述：文件上传管理
    /// </summary>
    public class UploadManageBLL
    {
        private UploadManageIService service = new UploadManageService();
        ...
        public IEnumerable<UploadManageEntity> GetUploadFile(string FId)
        {
            var queryJson = "{\"condition\":\"FId\",\"keyword\":\"" + FId + "\"}";
            return GetList(queryJson);
        }
