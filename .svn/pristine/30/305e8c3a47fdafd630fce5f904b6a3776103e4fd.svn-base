(function () {
    'use strict';
    angular.module('Siemens.SimaticIT.ProductionApp.AbrasiveOrder').controller('Siemens.SimaticIT.ProductionApp.AbrasiveOrder.AddBomItem',
        ['common.base', '$filter', '$scope', '$uibModalInstance', 'data', 'commonService',
            function (common, $filter, $scope, $modalInstance, data, commonService) {
                ...
                function initDictionary() {
                    //初始化 物料分类
                    vm.MaterialClass = {
                        value: { ItemName: commonService.$t('Siemens.SimaticIT.ProductionApp.OwnProduct.addJS.Tips_1'), ItemValue: "" },
                        options: [{ ItemName: commonService.$t('Siemens.SimaticIT.ProductionApp.OwnProduct.addJS.Tips_1'), ItemValue: "" }]
                    };
                    ...
                    vm.Warehouse = {
                        value: { ResourceName: commonService.$t('Siemens.SimaticIT.ProductionApp.OwnProduct.addJS.Tips_1'), ResourceCode: "" },
                        options: [{ ResourceName: commonService.$t('Siemens.SimaticIT.ProductionApp.OwnProduct.addJS.Tips_1'), ResourceCode: "" }]
                    };
                    vm.Process = {
                        value: { ResourceName: commonService.$t('Siemens.SimaticIT.ProductionApp.OwnProduct.addJS.Tips_1'), ResourceCode: "" },
                        options: [{ ResourceName: commonService.$t('Siemens.SimaticIT.ProductionApp.OwnProduct.addJS.Tips_1'), ResourceCode: "" }]
                    ...
                    vm.TypeBom = {
                        value: { BOMCode: commonService.$t('Siemens.SimaticIT.ProductionApp.OwnProduct.addJS.Tips_1'), Id: "" },
                        options: [{ BOMCode: commonService.$t('Siemens.SimaticIT.ProductionApp.OwnProduct.addJS.Tips_1'), Id: "" }]
                    };
                    ...
                    commonService.getResourceExtendInfo({ LevelCode: "Warehouse" }).then(function (res) {
                        if (res && res.data.success) {
                            ...
                            vm.Warehouse.options.splice(0, 0, {
                                ResourceCode: "",
                                ResourceName: commonService.$t('Siemens.SimaticIT.ProductionApp.OwnProduct.addJS.Tips_1')
                            });
                        }
                    });
                ...
                vm.materialChange = function (oldvalu, newvalue) {
                    ...
                    commonService.callWebApiGet(url1, null).then(function (res) {
                        if (res && res.data.success && res.data.resultData.length > 0) {
                            ...
                            vm.currentItem.Spec = "";
                            vm.MaterialClass.value = { ItemName: commonService.$t('Siemens.SimaticIT.ProductionApp.OwnProduct.addJS.Tips_1'), ItemValue: "" };
                            vm.SmallClass.value = { ItemName: commonService.$t('Siemens.SimaticIT.ProductionApp.OwnProduct.addJS.Tips_1'), ItemValue: "" };
                            vm.typeUnit.value = { ItemName: commonService.$t('Siemens.SimaticIT.ProductionApp.OwnProduct.addJS.Tips_1'), ItemValue: "" };
                        }
                    });
                    //获取物料BOM信息
                    ...
                    commonService.callWebApiGet(url2, null).then(function (res) {
                        if (res && res.data.success) {
                            ...
                            vm.TypeBom.options.splice(0, 0, {
                                Id: "",
                                BOMCode: commonService.$t('Siemens.SimaticIT.ProductionApp.OwnProduct.addJS.Tips_1')
                            });

                        } else {
                            vm.TypeBom.value = { BOMCode: commonService.$t('Siemens.SimaticIT.ProductionApp.OwnProduct.addJS.Tips_1'), Id: "" };
                        }
                    });
                };
