...
(function () {
    'use strict';
    angular.module('Siemens.SimaticIT.PlanApp.PL_TransfersRecord')
        .constant('Siemens.SimaticIT.PlanApp.PL_TransfersRecord.PL_TransfersRecord.constants', ScreenServiceConstants())
        .service('Siemens.SimaticIT.PlanApp.PL_TransfersRecord.PL_TransfersRecord.service', ScreenService)
    ...
    ScreenService.$inject = ['$q', '$state', 'common.base', 'Siemens.SimaticIT.PlanApp.PL_TransfersRecord.PL_TransfersRecord.constants', 'common.services.logger.service'];
    function ScreenService($q, $state, base, context, loggerService) {
        ...
        activate();
        function activate() {
            logger = loggerService.getModuleLogger('Siemens.SimaticIT.PlanApp.PL_TransfersRecord.PL_TransfersRecord.service');
    ...
    ScreenServiceRun.$inject = ['Siemens.SimaticIT.PlanApp.PL_TransfersRecord.PL_TransfersRecord.constants', 'common.base'];
