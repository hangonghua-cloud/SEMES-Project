...
/* 'applicationServiceUrls': { "FactoryModelApp": "http://localhost:80/sit-svc/Application/FactoryModelApp/odata"}, */
/* 'applicationSignalManagerUrls': { "FactoryModelApp": "http://localhost:80/sit-svc/Application/FactoryModelApp/signals" }, */
