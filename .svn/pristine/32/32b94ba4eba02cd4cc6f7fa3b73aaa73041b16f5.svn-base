(function () {
    'use strict';
    angular.module('Siemens.SimaticIT.MaterialApp.MMRawMaterialDispatch')
        .constant('Siemens.SimaticIT.MaterialApp.MMRawMaterialDispatch.MMRawMaterialDispatch.constants', ScreenServiceConstants())
        .service('Siemens.SimaticIT.MaterialApp.MMRawMaterialDispatch.MMRawMaterialDispatch.service', ScreenService)
    ...
    ScreenService.$inject = ['$q', '$state', 'common.base', 'Siemens.SimaticIT.MaterialApp.MMRawMaterialDispatch.MMRawMaterialDispatch.constants', 'common.services.logger.service'];
    function ScreenService($q, $state, base, context, loggerService) {
        ...
        activate();
        function activate() {
            logger = loggerService.getModuleLogger('Siemens.SimaticIT.MaterialApp.MMRawMaterialDispatch.MMRawMaterialDispatch.service');
    ...
    ScreenServiceRun.$inject = ['Siemens.SimaticIT.MaterialApp.MMRawMaterialDispatch.MMRawMaterialDispatch.constants', 'common.base'];
