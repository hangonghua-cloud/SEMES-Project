...
namespace ALP.Data
{
    ...
    public class DbHelper
    {
        ...
        public IDataReader ExecuteReader(CommandType cmdType, string strSql, params DbParameter[] dbParameter)
        {
            try
            {
                dbCommand = PrepareCommand(dbConnection, dbCommand, null, cmdType, strSql, dbParameter);
        ...
        private DbCommand PrepareCommand(DbConnection conn, IDbCommand cmd, DbTransaction isOpenTrans, CommandType cmdType, string cmdText, params DbParameter[] dbParameter)
        {
        ...
        public void ExecuteProc(DbConnection conn, string procName, SqlParameter[] param)
        {
            if (conn.State != ConnectionState.Open)
                conn.Open();
        ...
        /// <param name="procName"></param>
        /// <param name="param"></param>
        public DataTable ExecuteProc_Table(DbConnection conn, string procName, SqlParameter[] param)
        {
            ...
            var IDataReader = cmd.ExecuteReader();          
