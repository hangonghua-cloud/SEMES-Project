(function () {
    'use strict';
    angular.module('Siemens.SimaticIT.ProductionApp.TransferCardResume').config(ViewScreenStateConfig);

    ViewScreenController.$inject = ['Siemens.SimaticIT.ProductionApp.TransferCardResume.BeforeSlottingInventory.service', '$state', '$stateParams', 'common.base', '$filter', '$scope'];
    ...
    function ViewScreenStateConfig($stateProvider) {
        var screenStateName = 'home.Siemens_SimaticIT_ProductionApp_TransferCardResume_BeforeSlottingInventory';
        ...
        var state = {
            ...
            views: {
                'property-area-container@': {
                    templateUrl: moduleFolder + '/BeforeSlottingInventory-select.html',
