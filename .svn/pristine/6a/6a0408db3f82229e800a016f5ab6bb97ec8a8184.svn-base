...
/* 'applicationServiceUrls': { "SystemApp": "http://localhost:80/sit-svc/Application/SystemApp/odata"}, */
/* 'applicationSignalManagerUrls': { "SystemApp": "http://localhost:80/sit-svc/Application/SystemApp/signals" }, */
