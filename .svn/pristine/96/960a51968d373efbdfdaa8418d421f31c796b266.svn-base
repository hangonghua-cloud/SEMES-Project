(function () {
    'use strict';
    angular.module('Siemens.SimaticIT.ProductionApp.PMProductPrice')
        .constant('Siemens.SimaticIT.ProductionApp.PMProductPrice.PMProductPrice.constants', ScreenServiceConstants())
        .service('Siemens.SimaticIT.ProductionApp.PMProductPrice.PMProductPrice.service', ScreenService)
    ...
    ScreenService.$inject = ['$q', '$state', 'common.base', 'Siemens.SimaticIT.ProductionApp.PMProductPrice.PMProductPrice.constants', 'common.services.logger.service'];
    function ScreenService($q, $state, base, context, loggerService) {
        ...
        activate();
        function activate() {
            logger = loggerService.getModuleLogger('Siemens.SimaticIT.ProductionApp.PMProductPrice.PMProductPrice.service');
    ...
    ScreenServiceRun.$inject = ['Siemens.SimaticIT.ProductionApp.PMProductPrice.PMProductPrice.constants', 'common.base'];
