    ...
    public class DataBaseTableService : RepositoryFactory, IDataBaseTableService
    {
        ...
        public DataTable GetTableList(string dataBaseLinkId, string tableName)
        {
            ...
            if (dataBaseLinkEntity != null)
            {
                ...
                strSql.Append(@"DECLARE @TableInfo TABLE ( name VARCHAR(200) , sumrows VARCHAR(11) , reserved VARCHAR(50) , data VARCHAR(50) , index_size VARCHAR(50) , unused VARCHAR(50) , pk VARCHAR(50) )
                            DECLARE @TableName TABLE ( name VARCHAR(200) )
