    ...
    public class PostService : RepositoryFactory<RoleEntity>, IPostService
    {
        ...
        public void SaveForm(string keyValue, RoleEntity postEntity)
        {
            if (!string.IsNullOrEmpty(keyValue))
            {
                ...
                codeExpression = codeExpression.And(t => t.EnCode == postEntity.EnCode).And(t => t.Category == 2);
                ...
                nameExpression = nameExpression.And(t => t.FullName == postEntity.FullName).And(t => t.Category == 2).And(t => t.OrganizeId == postEntity.OrganizeId);
            ...
            else
            {
                ...
                postEntity.EnabledMark = 1;
                postEntity.DeleteMark = 0;
