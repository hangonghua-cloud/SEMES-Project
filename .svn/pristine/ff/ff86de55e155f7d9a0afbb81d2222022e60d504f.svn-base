(function () {
    'use strict';
    angular.module('Siemens.SimaticIT.PlanApp.PurchaseManage')
        .constant('Siemens.SimaticIT.PlanApp.PurchaseManage.PurchaseOrder.constants', ScreenServiceConstants())
        .service('Siemens.SimaticIT.PlanApp.PurchaseManage.PurchaseOrder.service', ScreenService)
    ...
    ScreenService.$inject = ['$q', '$state', 'common.base', 'Siemens.SimaticIT.PlanApp.PurchaseManage.PurchaseOrder.constants', 'common.services.logger.service'];
    function ScreenService($q, $state, base, context, loggerService) {
        ...
        activate();
        function activate() {
            logger = loggerService.getModuleLogger('Siemens.SimaticIT.PlanApp.PurchaseManage.PurchaseOrder.service');
    ...
    ScreenServiceRun.$inject = ['Siemens.SimaticIT.PlanApp.PurchaseManage.PurchaseOrder.constants', 'common.base'];
