(function () {
    'use strict';
    angular.module('CCS.CommonApp.CommonUI')
        .constant('CCS.CommonApp.CommonUI.Blank.constants', ScreenServiceConstants())
        .service('CCS.CommonApp.CommonUI.Blank.service', ScreenService)
    ...
    ScreenService.$inject = ['$q', '$state', 'common.base', 'CCS.CommonApp.CommonUI.Blank.constants', 'common.services.logger.service'];
    function ScreenService($q, $state, base, context, loggerService) {
        ...
        activate();
        function activate() {
            logger = loggerService.getModuleLogger('CCS.CommonApp.CommonUI.Blank.service');
    ...
    ScreenServiceRun.$inject = ['CCS.CommonApp.CommonUI.Blank.constants', 'common.base'];
