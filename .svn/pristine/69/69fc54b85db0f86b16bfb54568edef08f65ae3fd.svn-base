...
namespace Siemens.SimaticIT.MasterData.ButtonAuthFBLib.MSModel.Commands
{
    ...
    /// Class initialize
    /// </summary>
    public partial class WorkOrderEditProcessHandlerShell : ICommandHandler
    {
        ...
        public Response Execute(IUnifiedSdk unifiedSdk, ICommand command)
        {
            ...
            return WorkOrderEditProcessHandler((WorkOrderEditProcess)command);
        }
        ...
        {
            return typeof(WorkOrderEditProcess);
        }
    }
}
