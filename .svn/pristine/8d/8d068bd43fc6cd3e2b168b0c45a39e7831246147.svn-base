...
namespace ALP.Application.Entity.ProduceManage
{
    ...
    /// 1.创建日期: 2021-08-11
    /// 2.创建作者: admin
    /// 3.功能描述: PM_TransferCard实体
    /// 4.任务编号: 流转卡信息
    /// 5.最后修改日期: 
    /// 6.最后修改作者: 
    /// </summary>
    public class PM_TransferCardEntity : BaseEntity
    {
        #region 表: PM_TransferCard 实体类: PM_TransferCard 
        ...
        /// <summary>
        /// 流转卡状态 1：正常 2：待返工 3：返工中 4：已返工 5：报废 6：已包装
        /// </summary>
