(function () {
    ...
    ViewScreenController.$inject = ['CCS.CommonApp.CommonUI.Demo.service', '$state', '$stateParams', 'common.base', '$filter', '$scope'];
    ...
    function ViewScreenStateConfig($stateProvider) {
        var screenStateName = 'home.CCS_CommonApp_CommonUI_Demo';
        ...
        var state = {
            ...
            views: {
                'property-area-container@': {
                    templateUrl: moduleFolder + '/Demo-select.html',
