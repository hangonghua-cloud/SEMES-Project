...
(function () {
    'use strict';
    angular.module('Siemens.SimaticIT.QualityApp.QC_IPQCDetail')
        .constant('Siemens.SimaticIT.QualityApp.QC_IPQCDetail.QC_IPQCDetail.constants', ScreenServiceConstants())
        .service('Siemens.SimaticIT.QualityApp.QC_IPQCDetail.QC_IPQCDetail.service', ScreenService)
    ...
    ScreenService.$inject = ['$q', '$state', 'common.base', 'Siemens.SimaticIT.QualityApp.QC_IPQCDetail.QC_IPQCDetail.constants', 'common.services.logger.service'];
    function ScreenService($q, $state, base, context, loggerService) {
        ...
        activate();
        function activate() {
            logger = loggerService.getModuleLogger('Siemens.SimaticIT.QualityApp.QC_IPQCDetail.QC_IPQCDetail.service');
    ...
    ScreenServiceRun.$inject = ['Siemens.SimaticIT.QualityApp.QC_IPQCDetail.QC_IPQCDetail.constants', 'common.base'];
