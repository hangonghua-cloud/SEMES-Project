(function () {
    ...
    angular.module('Siemens.SimaticIT.MaterialApp.SuperProductStock')
        .constant('Siemens.SimaticIT.MaterialApp.SuperProductStock.SuperProductStock.constants', ScreenServiceConstants())
        .service('Siemens.SimaticIT.MaterialApp.SuperProductStock.SuperProductStock.service', ScreenService)
    ...
    ScreenService.$inject = ['$q', '$state', 'common.base', 'Siemens.SimaticIT.MaterialApp.SuperProductStock.SuperProductStock.constants', 'common.services.logger.service'];
    function ScreenService($q, $state, base, context, loggerService) {
        ...
        activate();
        function activate() {
            logger = loggerService.getModuleLogger('Siemens.SimaticIT.MaterialApp.SuperProductStock.SuperProductStock.service');
    ...
    ScreenServiceRun.$inject = ['Siemens.SimaticIT.MaterialApp.SuperProductStock.SuperProductStock.constants', 'common.base'];
