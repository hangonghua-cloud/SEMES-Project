(function () {
    'use strict';
    angular.module('Siemens.SimaticIT.ProductionApp.PackingBG').config(ViewScreenStateConfig);

    ViewScreenController.$inject = ['Siemens.SimaticIT.ProductionApp.PackingBG.PackingRecord.service', '$state', '$stateParams', 'common.base', '$filter', '$scope'];
    ...
    function ViewScreenStateConfig($stateProvider) {
        var screenStateName = 'home.Siemens_SimaticIT_ProductionApp_PackingBG_PackingRecord';
        ...
        var state = {
            ...
            views: {
                'property-area-container@': {
                    templateUrl: moduleFolder + '/PackingRecord-select.html',
