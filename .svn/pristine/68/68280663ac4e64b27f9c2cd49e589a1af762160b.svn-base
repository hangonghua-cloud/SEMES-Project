(function () {
    'use strict';
    angular.module('Siemens.SimaticIT.ProductionApp.ProductionFirstInspection')
        .constant('Siemens.SimaticIT.ProductionApp.ProductionFirstInspection.ProductionFirstInspection.constants', ScreenServiceConstants())
        .service('Siemens.SimaticIT.ProductionApp.ProductionFirstInspection.ProductionFirstInspection.service', ScreenService)
    ...
    function ScreenServiceConstants() {
        return {
            data: {
                ...
                appName: 'ProductionApp', // The name of App: in case of extended app, it is the name of AppBase
    ...
    ScreenService.$inject = ['$q', '$state', 'common.base', 'Siemens.SimaticIT.ProductionApp.ProductionFirstInspection.ProductionFirstInspection.constants', 'common.services.logger.service'];
    function ScreenService($q, $state, base, context, loggerService) {
        ...
        activate();
        function activate() {
            logger = loggerService.getModuleLogger('Siemens.SimaticIT.ProductionApp.ProductionFirstInspection.ProductionFirstInspection.service');
    ...
    ScreenServiceRun.$inject = ['Siemens.SimaticIT.ProductionApp.ProductionFirstInspection.ProductionFirstInspection.constants', 'common.base'];
