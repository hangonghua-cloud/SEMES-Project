...
namespace Siemens.SimaticIT.MasterData.ButtonAuthFBLib.MSModel.Commands
{
    ...
    /// Class initialize
    /// </summary>
    public partial class PurchaseManageEditHandlerShell : ICommandHandler
    {
        ...
        public Response Execute(IUnifiedSdk unifiedSdk, ICommand command)
        {
            ...
            return PurchaseManageEditHandler((PurchaseManageEdit)command);
        }
        ...
        {
            return typeof(PurchaseManageEdit);
        }
    }
}
