(function () {
    'use strict';
    angular.module('Siemens.SimaticIT.ProductionApp.PrinterWorkOrderBG').config(AddScreenStateConfig);

    AddScreenController.$inject = ['Siemens.SimaticIT.ProductionApp.PrinterWorkOrderBG.PrinterWorkOrderBG.service', '$state', '$stateParams', 'common.base', '$filter', '$scope'];
        ...
        var state = {
            ...
            views: {
                'property-area-container@': {
                    templateUrl: moduleFolder + '/PrinterWorkOrderBG-add.html',
