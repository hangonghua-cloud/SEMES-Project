(function () {
    'use strict';
    angular.module('Siemens.SimaticIT.ProductionApp.AbrasiveOrder')
        .constant('Siemens.SimaticIT.ProductionApp.AbrasiveOrder.AbrasiveOrder.constants', ScreenServiceConstants())
        .service('Siemens.SimaticIT.ProductionApp.AbrasiveOrder.AbrasiveOrder.service', ScreenService)
    ...
    ScreenService.$inject = ['$q', '$state', 'common.base', 'Siemens.SimaticIT.ProductionApp.AbrasiveOrder.AbrasiveOrder.constants', 'common.services.logger.service'];
    function ScreenService($q, $state, base, context, loggerService) {
        ...
        activate();
        function activate() {
            logger = loggerService.getModuleLogger('Siemens.SimaticIT.ProductionApp.AbrasiveOrder.AbrasiveOrder.service');
    ...
    ScreenServiceRun.$inject = ['Siemens.SimaticIT.ProductionApp.AbrasiveOrder.AbrasiveOrder.constants', 'common.base'];
