...
(function () {
    'use strict';
    angular.module('Siemens.SimaticIT.MaterialApp.BSTraitManage')
        .constant('Siemens.SimaticIT.MaterialApp.BSTraitManage.BS_TraitManage.constants', ScreenServiceConstants())
        .service('Siemens.SimaticIT.MaterialApp.BSTraitManage.BS_TraitManage.service', ScreenService)
    ...
    ScreenService.$inject = ['$q', '$state', 'common.base', 'Siemens.SimaticIT.MaterialApp.BSTraitManage.BS_TraitManage.constants', 'common.services.logger.service'];
    function ScreenService($q, $state, base, context, loggerService) {
        ...
        activate();
        function activate() {
            logger = loggerService.getModuleLogger('Siemens.SimaticIT.MaterialApp.BSTraitManage.BS_TraitManage.service');
    ...
    ScreenServiceRun.$inject = ['Siemens.SimaticIT.MaterialApp.BSTraitManage.BS_TraitManage.constants', 'common.base'];
