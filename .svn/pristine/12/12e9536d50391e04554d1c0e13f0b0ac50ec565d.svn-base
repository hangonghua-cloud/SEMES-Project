(function () {
    'use strict';
    angular.module('Siemens.SimaticIT.ProductionApp.MaterialBatchUpRecord')
        .constant('Siemens.SimaticIT.ProductionApp.MaterialBatchUpRecord.MaterialBatchUpRecord.constants', ScreenServiceConstants())
        .service('Siemens.SimaticIT.ProductionApp.MaterialBatchUpRecord.MaterialBatchUpRecord.service', ScreenService)
    ...
    ScreenService.$inject = ['$q', '$state', 'common.base', 'Siemens.SimaticIT.ProductionApp.MaterialBatchUpRecord.MaterialBatchUpRecord.constants', 'common.services.logger.service'];
    function ScreenService($q, $state, base, context, loggerService) {
        ...
        activate();
        function activate() {
            logger = loggerService.getModuleLogger('Siemens.SimaticIT.ProductionApp.MaterialBatchUpRecord.MaterialBatchUpRecord.service');
    ...
    ScreenServiceRun.$inject = ['Siemens.SimaticIT.ProductionApp.MaterialBatchUpRecord.MaterialBatchUpRecord.constants', 'common.base'];
