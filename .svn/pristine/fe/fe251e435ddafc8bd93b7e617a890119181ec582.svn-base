(function () {
    'use strict';
    angular.module('CCS.CommonApp.Common')
        .constant('CCS.CommonApp.Common.Common.constants', ScreenServiceConstants())
        .service('CCS.CommonApp.Common.Common.service', ScreenService)
    ...
    function ScreenServiceConstants() {
        return {
            data: {
                //appName: 'CommonApp',
                appName: 'CommonApp', // The name of App: in case of extended app, it is the name of AppBase
                appPrefix: 'CCS',
                ...
                entityName: 'Common',
                createPublicName: 'CreateCommon',
                updatePublicName: 'UpdateCommon',
                deletePublicName: 'DeleteCommon'
            }
        };
    }

    ScreenService.$inject = ['$q', '$state', 'common.base', 'CCS.CommonApp.Common.Common.constants', 'common.services.logger.service'];
    function ScreenService($q, $state, base, context, loggerService) {
        ...
        activate();
        function activate() {
            logger = loggerService.getModuleLogger('CCS.CommonApp.Common.Common.service');
    ...
    ScreenServiceRun.$inject = ['CCS.CommonApp.Common.Common.constants', 'common.base'];
