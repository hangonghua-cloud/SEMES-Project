...
namespace Siemens.SimaticIT.MasterData.ButtonAuthFBLib.MSModel.Commands
{
    ...
    /// Class initialize
    /// </summary>
    public partial class BaseBOMAddDetailHandlerShell : ICommandHandler
    {
        ...
        public Response Execute(IUnifiedSdk unifiedSdk, ICommand command)
        {
            ...
            return BaseBOMAddDetailHandler((BaseBOMAddDetail)command);
        }
        ...
        {
            return typeof(BaseBOMAddDetail);
        }
    }
}
