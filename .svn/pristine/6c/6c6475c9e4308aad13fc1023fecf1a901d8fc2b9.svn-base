(function () {
    'use strict';
    angular.module('Siemens.SimaticIT.BaseDataApp.UpdateLog').config(ViewScreenStateConfig);

    ViewScreenController.$inject = ['Siemens.SimaticIT.BaseDataApp.UpdateLog.UpdateLog.service', '$state', '$stateParams', 'common.base', '$filter', '$scope'];
    function ViewScreenController(dataService, $state, $stateParams, common, $filter, $scope) {
        ...
        function activate() {
            ...
            sidePanelManager.setTitle(commonService.$t('Siemens.SimaticIT.BaseDataApp.UpdateLog.UpdateLogselectctrl.Tips_1'));
        ...
        var state = {
            ...
            views: {
                'property-area-container@': {
                    templateUrl: moduleFolder + '/UpdateLog-select.html',
                    controller: ViewScreenController,
                    controllerAs: 'vm'
                }
            },
            data: {
                title: 'Siemens.SimaticIT.BaseDataApp.UpdateLog.UpdateLogselectctrl.Tips_1'
            },
            params: {
                selectedItem: null,
            }
