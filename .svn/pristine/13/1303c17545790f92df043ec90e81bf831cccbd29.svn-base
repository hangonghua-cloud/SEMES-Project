(function () {
    'use strict';
    angular.module('Siemens.SimaticIT.ProductionApp.ScrapRecord').config(ImportScreenStateConfig);

    ImportScreenController.$inject = ['Siemens.SimaticIT.ProductionApp.ScrapRecord.ScrapRecord.service', '$state',
    ...
    function ImportScreenController(dataService, $state, $stateParams, common, $filter, $scope, i18nService, FileUploader,
        ...
        function activate() {
            ...
            sidePanelManager.setTitle('导入分摊');
        ...
        function save() {
            ...
            var url = commonService.getMesApiAddress('ProduceManage') + "/PMScrapRecord/ImportShare";
        ...
        var state = {
            ...
            views: {
                'property-area-container@': {
                    templateUrl: moduleFolder + '/ScrapRecord-import.html',
