...
export function register(data) {
	return request({
	   url: '/api/Test/CallSetUserFullPrincipalCmd',
	   method: 'GET',
	   data: data
	 })
	// return request({
...
//修改密码
export function UpdateAppPassword(data) {
	return request({
		url: '/System/UpdateAppPassword',
		method: 'POST',
		data: data
	})
}
...
export function GetLoginInfo(data) {
	return request({
		url: '/Base/GetLoginInfo',
		method: 'POST',
		data: data
	})
}
//获取更新日志
export function GetUpdateLog(data) {
	return request({
		url: '/Base/GetUpdateLog',
		method: 'POST',
		data: data
	})
}
