(function () {
    ...
    angular.module('Siemens.SimaticIT.BaseDataApp.DataDictionary')
        .constant('Siemens.SimaticIT.BaseDataApp.DataDictionary.DataDictionary.constants', ScreenServiceConstants())
        .service('Siemens.SimaticIT.BaseDataApp.DataDictionary.DataDictionary.service', ScreenService)
    ...
    ScreenService.$inject = ['$q', '$state', 'common.base', 'Siemens.SimaticIT.BaseDataApp.DataDictionary.DataDictionary.constants', 'common.services.logger.service'];
    function ScreenService($q, $state, base, context, loggerService) {
        ...
        activate();
        function activate() {
            logger = loggerService.getModuleLogger('Siemens.SimaticIT.BaseDataApp.DataDictionary.DataDictionary.service');
    ...
    ScreenServiceRun.$inject = ['Siemens.SimaticIT.BaseDataApp.DataDictionary.DataDictionary.constants', 'common.base'];
