...
{
    public class QC_PollingDetail_BLL
    {
        private QC_PollingDetail_IService service = new QC_PollingDetail_Service();
        /// <summary>
        /// 功能描述: 查询分页列表
        /// 创　　建: 丁零
        ...
        {
            return service.SaveDetermination(keyValue, determinationValue, inspector, ref msg);
        }
