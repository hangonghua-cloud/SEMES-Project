...
namespace Siemens.SimaticIT.MasterData.ButtonAuthFBLib.MSModel.Commands
{
    ...
    /// Class initialize
    /// </summary>
    public partial class RawMaterialStockManageAddHandlerShell : ICommandHandler
    {
        ...
        public Response Execute(IUnifiedSdk unifiedSdk, ICommand command)
        {
            ...
            return RawMaterialStockManageAddHandler((RawMaterialStockManageAdd)command);
        }
        ...
        {
            return typeof(RawMaterialStockManageAdd);
        }
    }
}
