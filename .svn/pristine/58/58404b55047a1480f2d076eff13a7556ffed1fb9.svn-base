...
namespace Siemens.SimaticIT.MasterData.ButtonAuthFBLib.MSModel.Commands
{
    ...
    /// Class initialize
    /// </summary>
    public partial class WorkOrderAddSuppleHandlerShell : ICommandHandler
    {
        ...
        public Response Execute(IUnifiedSdk unifiedSdk, ICommand command)
        {
            ...
            return WorkOrderAddSuppleHandler((WorkOrderAddSupple)command);
        }
        ...
        {
            return typeof(WorkOrderAddSupple);
        }
    }
}
