(function () {
    'use strict';
    angular.module('Siemens.SimaticIT.FactoryModelApp.ModelManage').config(ViewScreenStateConfig);

    ViewScreenController.$inject = ['Siemens.SimaticIT.FactoryModelApp.ModelManage.ModelManage.service', '$state', '$stateParams', 'common.base', '$filter', '$scope'];
    ...
    function ViewScreenStateConfig($stateProvider) {
        var screenStateName = 'home.Siemens_SimaticIT_FactoryModelApp_ModelManage_ModelManage';
        ...
        var state = {
            ...
            views: {
                'property-area-container@': {
                    templateUrl: moduleFolder + '/ModelManage-select.html',
