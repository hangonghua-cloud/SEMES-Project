...
{
    public class QC_PollingDetailResult_BLL
    {
        private QC_PollingDetailResult_IService service = new QC_PollingDetailResult_Service();
        /// <summary>
        /// 功能描述: 查询分页列表
        /// 创　　建: 丁零
        ...
        {
            return service.GetCheckPageDataList(pagination, queryJson);
        }
