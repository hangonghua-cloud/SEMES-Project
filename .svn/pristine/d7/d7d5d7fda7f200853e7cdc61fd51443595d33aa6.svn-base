...
(function () {
    'use strict';
    angular.module('Siemens.SimaticIT.EquipmentApp.EP_EquipmentRepairRecord')
        .constant('Siemens.SimaticIT.EquipmentApp.EP_EquipmentRepairRecord.EP_EquipmentRepairRecord.constants', ScreenServiceConstants())
        .service('Siemens.SimaticIT.EquipmentApp.EP_EquipmentRepairRecord.EP_EquipmentRepairRecord.service', ScreenService)
    ...
    ScreenService.$inject = ['$q', '$state', 'common.base', 'Siemens.SimaticIT.EquipmentApp.EP_EquipmentRepairRecord.EP_EquipmentRepairRecord.constants', 'common.services.logger.service'];
    function ScreenService($q, $state, base, context, loggerService) {
        ...
        activate();
        function activate() {
            logger = loggerService.getModuleLogger('Siemens.SimaticIT.EquipmentApp.EP_EquipmentRepairRecord.EP_EquipmentRepairRecord.service');
    ...
    ScreenServiceRun.$inject = ['Siemens.SimaticIT.EquipmentApp.EP_EquipmentRepairRecord.EP_EquipmentRepairRecord.constants', 'common.base'];
