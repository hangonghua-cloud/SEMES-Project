(function () {
    ...
    ViewScreenController.$inject = ['Siemens.SimaticIT.ProductionApp.TransferCardResume.TransferCardResume.service', '$state', '$stateParams', 'common.base', '$filter', '$scope'];
    ...
    function ViewScreenStateConfig($stateProvider) {
        var screenStateName = 'home.Siemens_SimaticIT_ProductionApp_TransferCardResume_TransferCardResume';
        ...
        var state = {
            ...
            views: {
                'property-area-container@': {
                    templateUrl: moduleFolder + '/TransferCardResume-select.html',
