(function () {
    ...
    angular.module('Siemens.SimaticIT.MaterialApp.ProductStock')
        .constant('Siemens.SimaticIT.MaterialApp.ProductStock.ProductStock.constants', ScreenServiceConstants())
        .service('Siemens.SimaticIT.MaterialApp.ProductStock.ProductStock.service', ScreenService)
    ...
    ScreenService.$inject = ['$q', '$state', 'common.base', 'Siemens.SimaticIT.MaterialApp.ProductStock.ProductStock.constants', 'common.services.logger.service'];
    function ScreenService($q, $state, base, context, loggerService) {
        ...
        activate();
        function activate() {
            logger = loggerService.getModuleLogger('Siemens.SimaticIT.MaterialApp.ProductStock.ProductStock.service');
    ...
    ScreenServiceRun.$inject = ['Siemens.SimaticIT.MaterialApp.ProductStock.ProductStock.constants', 'common.base'];
