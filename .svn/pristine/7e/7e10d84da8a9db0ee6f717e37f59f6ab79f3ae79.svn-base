(function () {
    'use strict';
    angular.module('Siemens.SimaticIT.SystemApp.PrintServer').config(ViewScreenStateConfig);

    ViewScreenController.$inject = ['Siemens.SimaticIT.SystemApp.PrintServer.PrintServer.service', '$state', '$stateParams', 'common.base', '$filter', '$scope'];
        ...
        var state = {
            ...
            views: {
                'property-area-container@': {
                    templateUrl: moduleFolder + '/PrintServer-select.html',
