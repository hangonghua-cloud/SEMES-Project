(function () {
    'use strict';
    angular.module('Siemens.SimaticIT.BaseDataApp.UpdateLog')
        .constant('Siemens.SimaticIT.BaseDataApp.UpdateLog.UpdateLog.constants', ScreenServiceConstants())
        .service('Siemens.SimaticIT.BaseDataApp.UpdateLog.UpdateLog.service', ScreenService)
    ...
    ScreenService.$inject = ['$q', '$state', 'common.base', 'Siemens.SimaticIT.BaseDataApp.UpdateLog.UpdateLog.constants', 'common.services.logger.service'];
    function ScreenService($q, $state, base, context, loggerService) {
        ...
        activate();
        function activate() {
            logger = loggerService.getModuleLogger('Siemens.SimaticIT.BaseDataApp.UpdateLog.UpdateLog.service');
    ...
    ScreenServiceRun.$inject = ['Siemens.SimaticIT.BaseDataApp.UpdateLog.UpdateLog.constants', 'common.base'];
