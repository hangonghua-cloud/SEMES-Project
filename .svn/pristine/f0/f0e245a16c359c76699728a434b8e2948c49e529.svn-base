(function () {
    'use strict';
    angular.module('Siemens.SimaticIT.ProductionApp.WorkOrderBatch').config(EditScreenStateConfig);

    EditScreenController.$inject = ['Siemens.SimaticIT.ProductionApp.WorkOrderBatch.WorkOrderBatch.service', '$state', '$stateParams', 'common.base', '$filter', '$scope'];
        ...
        var state = {
            ...
            views: {
                'property-area-container@': {
                    templateUrl: moduleFolder + '/WorkOrderBatch-edit.html',
