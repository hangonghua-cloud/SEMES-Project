(function () {
    'use strict';
    angular.module('CCS.CommonApp.Common').config(ViewScreenStateConfig);

    ViewScreenController.$inject = ['CCS.CommonApp.Common.Common.service', '$state', '$stateParams', 'common.base', '$filter', '$scope'];
        ...
        var state = {
            ...
            views: {
                'property-area-container@': {
                    templateUrl: moduleFolder + '/Common-select.html',
