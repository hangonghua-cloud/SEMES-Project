(function () {
    'use strict';
    angular.module('Siemens.SimaticIT.MaterialApp.Process')
        .constant('Siemens.SimaticIT.MaterialApp.Process.ProcessOperation.constants', ScreenServiceConstants())
        .service('Siemens.SimaticIT.MaterialApp.Process.ProcessOperation.service', ScreenService)
    ...
    ScreenService.$inject = ['$q', '$state', 'common.base', 'Siemens.SimaticIT.MaterialApp.Process.ProcessOperation.constants', 'common.services.logger.service'];
    function ScreenService($q, $state, base, context, loggerService) {
        ...
        activate();
        function activate() {
            logger = loggerService.getModuleLogger('Siemens.SimaticIT.MaterialApp.Process.ProcessOperation.service');
    ...
    ScreenServiceRun.$inject = ['Siemens.SimaticIT.MaterialApp.Process.ProcessOperation.constants', 'common.base'];
