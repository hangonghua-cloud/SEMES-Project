...
/* 'applicationServiceUrls': { "QualityApp": "http://localhost:80/sit-svc/Application/QualityApp/odata"}, */
/* 'applicationSignalManagerUrls': { "QualityApp": "http://localhost:80/sit-svc/Application/QualityApp/signals" }, */
