...
namespace Siemens.SimaticIT.MasterData.ButtonAuthFBLib.MSModel.Commands
{
    ...
    /// Class initialize
    /// </summary>
    public partial class WorkOrderEditQualityHandlerShell : ICommandHandler
    {
        ...
        public Response Execute(IUnifiedSdk unifiedSdk, ICommand command)
        {
            ...
            return WorkOrderEditQualityHandler((WorkOrderEditQuality)command);
        }
        ...
        {
            return typeof(WorkOrderEditQuality);
        }
    }
}
