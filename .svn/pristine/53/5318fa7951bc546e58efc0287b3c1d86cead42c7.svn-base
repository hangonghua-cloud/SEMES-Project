...
namespace Siemens.SimaticIT.MasterData.ButtonAuthFBLib.MSModel.Commands
{
    ...
    /// Class initialize
    /// </summary>
    public partial class BaseBOMDeleteDetailHandlerShell : ICommandHandler
    {
        ...
        public Response Execute(IUnifiedSdk unifiedSdk, ICommand command)
        {
            ...
            return BaseBOMDeleteDetailHandler((BaseBOMDeleteDetail)command);
        }
        ...
        {
            return typeof(BaseBOMDeleteDetail);
        }
    }
}
