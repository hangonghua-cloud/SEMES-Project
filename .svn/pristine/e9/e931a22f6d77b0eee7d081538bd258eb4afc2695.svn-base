...
(function () {
    'use strict';
    angular.module('CCS.CommonApp.CommonUI').controller('CCS.CommonApp.CommonUI.Select_multiSelectModal',
        ['common.base', '$filter', '$scope', '$uibModalInstance', 'data', 'commonService', '$sce', 'common.services.authentication',
            function (common, $filter, $scope, $modalInstance, data, commonService, $sce, auth) {
                ...
                self.gridOptions = {
                    ...
                    enableSelectAll: true,//开启全选 单选 /多选
                    enableMultiSelection: true, //开启 单选 /多选
                ...
                function BuildQueryHtml(QueryAry)
                {
                    ...
                    QueryHtml += "<button ng-click=\"vm.loadData()\" class=\"btn btn-primary\" style=\"height: 34px;margin-top: 20px;\"><i class=\"fa fa-search\"></i><span>&nbsp;查询</span></button>";
                ...
                function loadData() {
                    ...
                    var queryParmeters = {
                        ...
                        queryJson: self.queryParmeters
                    };
                    console.log('Select_SingleChoiceModal:queryParmeters------' + JSON.stringify(queryParmeters)); 
                    //调用API 传递翻页\参数 获取数据
