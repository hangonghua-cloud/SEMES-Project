(function () {
    'use strict';
    angular.module('Siemens.SimaticIT.FactoryModelApp.ModelLevel').config(ViewScreenStateConfig);

    ViewScreenController.$inject = ['Siemens.SimaticIT.FactoryModelApp.ModelLevel.ModelLevel.service', '$state', '$stateParams', 'common.base', '$filter', '$scope'];
        ...
        var state = {
            ...
            views: {
                'property-area-container@': {
                    templateUrl: moduleFolder + '/ModelLevel-select.html',
