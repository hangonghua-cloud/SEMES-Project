(function () {
    'use strict';
    angular.module('Siemens.SimaticIT.PlanApp.OrderMaterial').config(ViewScreenStateConfig);

    ViewScreenController.$inject = ['Siemens.SimaticIT.PlanApp.OrderMaterial.OrderMaterial.service', '$state', '$stateParams', 'common.base', '$filter', '$scope'];
        ...
        var state = {
            ...
            views: {
                'property-area-container@': {
                    templateUrl: moduleFolder + '/OrderMaterial-select.html',
