...
namespace Siemens.SimaticIT.MasterData.ButtonAuthFBLib.MSModel.Commands
{
    ...
    /// Class initialize
    /// </summary>
    public partial class PurchaseManageDeleteDetailHandlerShell : ICommandHandler
    {
        ...
        public Response Execute(IUnifiedSdk unifiedSdk, ICommand command)
        {
            ...
            return PurchaseManageDeleteDetailHandler((PurchaseManageDeleteDetail)command);
        }
        ...
        {
            return typeof(PurchaseManageDeleteDetail);
        }
    }
}
