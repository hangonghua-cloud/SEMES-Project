(function () {
    ...
    angular.module('Siemens.SimaticIT.BasicDataManageFBApp.AppModelManage')
        .constant('Siemens.SimaticIT.BasicDataManageFBApp.AppModelManage.AppModelScreen.constants', ScreenServiceConstants())
        .service('Siemens.SimaticIT.BasicDataManageFBApp.AppModelManage.AppModelScreen.service', ScreenService)
    ...
    function ScreenServiceConstants() {
        return {
            data: {
                ...
                entityName: "AppModelEntity",
                dictionaryEntityName: 'DataItemEntity',
                createPublicName: "AddAppModelCmd",
                updatePublicName: "UpdateAppModelCmd",
                deletePublicName: "DelAppModelCmd"
            }
        };
    }

    ScreenService.$inject = ['$q', '$state', 'common.base', 'Siemens.SimaticIT.BasicDataManageFBApp.AppModelManage.AppModelScreen.constants', 'common.services.logger.service'];
    function ScreenService($q, $state, base, context, loggerService) {
        ...
        activate();
        function activate() {
            logger = loggerService.getModuleLogger('Siemens.SimaticIT.BasicDataManageFBApp.AppModelManage.AppModelScreen.service');
        ...
        function getDectionary(options) {
            return execGetAll(options, context.data.dictionaryEntityName);
        }

        function createEntity(data) {
            return execCommand(context.data.createPublicName, data);
        }
    ...
    ScreenServiceRun.$inject = ['Siemens.SimaticIT.BasicDataManageFBApp.AppModelManage.AppModelScreen.constants', 'common.base'];
