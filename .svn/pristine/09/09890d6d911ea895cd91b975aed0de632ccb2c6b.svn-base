(function () {
    ...
    ViewScreenController.$inject = ['Siemens.SimaticIT.MaterialApp.Process.ProcessAttr.service', '$state', '$stateParams', 'common.base', '$filter', '$scope'];
    function ViewScreenController(dataService, $state, $stateParams, common, $filter, $scope) {
        ...
        function activate() {
            ...
            sidePanelManager.setTitle(commonService.$t('Siemens.SimaticIT.MaterialApp.Process.ProcessAttrselectctrl.Tips_1'));
        ...
        var state = {
            ...
            views: {
                'property-area-container@': {
                    templateUrl: moduleFolder + '/ProcessAttr-select.html',
                    controller: ViewScreenController,
                    controllerAs: 'vm'
                }
            },
            data: {
                title: 'Siemens.SimaticIT.MaterialApp.Process.ProcessAttrselectctrl.Tips_1'
            },
            params: {
                selectedItem: null,
            }
