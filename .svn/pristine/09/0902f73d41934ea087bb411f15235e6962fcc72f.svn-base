...
namespace Siemens.SimaticIT.MasterData.BasicDataManageFBLib.MSModel.Commands
{
    ...
    /// Class initialize
    /// </summary>
    public partial class GetAppUserRolesCmdHandlerShell : ICommandHandler
    {
        ...
        public Response Execute(IUnifiedSdk unifiedSdk, ICommand command)
        {
            ...
            return GetAppUserRolesCmdHandler((GetAppUserRolesCmd)command);
        }
        ...
        {
            return typeof(GetAppUserRolesCmd);
        }
    }
}
