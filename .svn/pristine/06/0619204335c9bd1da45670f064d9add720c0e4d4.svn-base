(function () {
    'use strict';
    angular.module('Siemens.SimaticIT.MaterialApp.ImportData')
        .constant('Siemens.SimaticIT.MaterialApp.ImportData.ImportData.constants', ScreenServiceConstants())
        .service('Siemens.SimaticIT.MaterialApp.ImportData.ImportData.service', ScreenService)
    ...
    ScreenService.$inject = ['$q', '$state', 'common.base', 'Siemens.SimaticIT.MaterialApp.ImportData.ImportData.constants', 'common.services.logger.service'];
    function ScreenService($q, $state, base, context, loggerService) {
        ...
        activate();
        function activate() {
            logger = loggerService.getModuleLogger('Siemens.SimaticIT.MaterialApp.ImportData.ImportData.service');
    ...
    ScreenServiceRun.$inject = ['Siemens.SimaticIT.MaterialApp.ImportData.ImportData.constants', 'common.base'];
