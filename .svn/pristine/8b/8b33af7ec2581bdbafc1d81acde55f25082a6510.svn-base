using ALP.Application.UtilExtend.Log;
using System;
...
namespace ALP.Application.WebApi.Controllers.BaseManage
{
    ...
    public class WebApiTrackerAttribute : ActionFilterAttribute
    {
        ...
        public override void OnActionExecuted(HttpActionExecutedContext actionExecutedContext)
        {
            ...
            MonLog.ExceptionText = actionExecutedContext.Exception == null ? "无异常信息" : actionExecutedContext.Exception.ToString();
            MonLog.ExceptionStackTrace = actionExecutedContext.Exception == null ? "无StackTrace" : actionExecutedContext.Exception.StackTrace;
