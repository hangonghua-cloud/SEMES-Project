...
namespace Siemens.SimaticIT.MasterData.ButtonAuthFBLib.MSModel.Commands
{
    ...
    /// Class initialize
    /// </summary>
    public partial class ProductionOrderTransferHandlerShell : ICommandHandler
    {
        ...
        public Response Execute(IUnifiedSdk unifiedSdk, ICommand command)
        {
            ...
            return ProductionOrderTransferHandler((ProductionOrderTransfer)command);
        }
        ...
        {
            return typeof(ProductionOrderTransfer);
        }
    }
}
