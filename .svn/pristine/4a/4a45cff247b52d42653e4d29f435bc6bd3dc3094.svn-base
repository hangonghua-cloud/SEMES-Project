...
{ 
    ...
    /// 1.创建日期: 2021-09-08
    /// 2.创建作者: admin
    /// 3.功能描述: MM_SupProductStockTransferService 业务服务类
    /// 4.任务编号: 超产品库存流转记录
    /// 5.最后修改日期: 
    /// 6.最后修改作者: 
    /// </summary>
    public class MM_SupProductStockTransfer_Service : RepositoryFactory<MM_SupProductStockTransferEntity>, MM_SupProductStockTransfer_IService
    { 
        /// <summary>
        /// 功能描述: 查询分页列表
        /// 创　　建: admin
        ...
        public IEnumerable<MM_SupProductStockTransferEntity> GetPageList(Pagination pagination, string queryJson)
        {
            ...
            sql.Append(@"SELECT 
                      ...
                      ,[ModifyBy]
                      ,[ModifyTime]
                  FROM [dbo].[MM_SupProductStockTransfer] where IsDeleted = 0 ");
        ...
        public DataTable GetPageDataTableList(Pagination pagination, string queryJson)
        {
            ...
            sql.Append(@"SELECT a.Id,
                               ...
                               a.ModifyTime,
                               a.Remark
                        FROM [dbo].[MM_SupProductStockTransfer] a
        ...
        /// <returns>返回分页列表</returns>
        public IEnumerable<MM_SupProductStockTransferEntity> GetList(string checkType, out string msg)
        {
            StringBuilder sql = new StringBuilder();
            sql.Append(@"SELECT 
                      [Id]
        ...
        public int SaveEntity(string keyValue, MM_SupProductStockTransferEntity entity, out string msg)
        {
            int n = 0;
            msg = "";
            try
        ...
        /// <param name="List<MM_SupProductStockTransferEntity>">实体对象数组</param>
        /// <param name="msg">输出错误内容</param>
        /// <returns>返回int 成功1, 失败0 </returns>
        public int SaveEntity_List(bool IsUpdate, string CreatedByName, List<MM_SupProductStockTransferEntity> entity_list, out string msg)
        {
            int n = 0;
            msg = "";
            try
            {
                if (IsUpdate)
                {
                    ...
                    if (entity_list.Count > 0)
                    {
                        foreach (var Save_obj in entity_list)
                        {
                            ...
                            sql_temp.Append("UPDATE [dbo].[MM_SupProductStockTransfer] set ");
                            string keyValue = "";
                            //循环实体
                ...
                else
                {
                    ...
                    StringBuilder sql = new StringBuilder();
                    sql.Append($@"INSERT INTO [dbo].[MM_SupProductStockTransfer] (
                                            [Id]
                                            ,[BusinessType]
                                            ,[ProcessCode]
                                            ,[Spec]
        ...
        {
            int result = 0;
            MM_SupProductStockTransferEntity entity = this.BaseRepository().FindEntity(keyValue);
            if (entity != null)
            {
                //删除禁用标记
        ...
        public int Delete_SQL(string keyValue, out string msg)
        {
            ...
            {
                StringBuilder sql = new StringBuilder();
                sql.Append($@"DELETE FROM [dbo].[MM_SupProductStockTransfer] WHERE Id=N'{keyValue}'");
                n = this.BaseRepository().ExecuteBySql(sql.ToString());
            }
            catch (Exception ex)
            {
        ...
        /// </summary>
        /// <param name="keyValue">主键值</param>
        /// <returns>返回MM_SupProductStockTransferEntity</returns>
        public MM_SupProductStockTransferEntity GetEntity(string keyValue)
        {
        ...
        /// <returns>返回MM_SupProductStockTransferEntity</returns>
        public MM_SupProductStockTransferEntity GetEntityByQuery(string QueryField)
        {
        ...
        /// <returns>返回MM_SupProductStockTransferEntity 对象</returns>
        public MM_SupProductStockTransferEntity Get_ExpressionEntity(Expression<Func<MM_SupProductStockTransferEntity, bool>> condition)
        {
            // 根据实际情况更换某字段, 这个字段内容在列表是唯一值
        ...
        /// </summary>
        /// /// <param name="condition">Expression 条件</param>
        /// <returns>返回MM_SupProductStockTransferEntity 列表</returns>
        public IEnumerable<MM_SupProductStockTransferEntity> Get_ExpressionList(Expression<Func<MM_SupProductStockTransferEntity, bool>> condition)
        {
            // 根据实际情况更换某字段, 这个字段内容在列表是唯一值
        ...
        //    StringBuilder sql = new StringBuilder();
        //    //子表服务类
        //    RepositoryFactory<MM_SupProductStockTransferEntity> bomService = new RepositoryFactory<MM_SupProductStockTransferEntity>();
        
        //    MM_SupProductStockTransferEntity entity = this.BaseRepository().FindEntity(keyValue);
        //    //根据主表在子表的ID与主表主键查找实体, 如果是多条,使用循环遍历删除
        //    MM_SupProductStockTransferDetailEntity bomEntity = bomService.BaseRepository().IQueryable(t => t.MM_SupProductStockTransfer_Id == entity.Id).FirstOrDefault();
        //    if (entity != null)
        //    {
        //        //主表删除标记
        ...
        /// <returns>返回分页列表</returns>
        public IEnumerable<MM_SupProductStockTransferEntity> GetList_TestOtherEntity(string checkType, out string msg)
        {
            StringBuilder sql = new StringBuilder();
            ...
            try
            {
                ...
                //实体映射查询
                IEnumerable<MM_SupProductStockTransferEntity> MM_SupProductStockTransferEntity_list =  db2.FindList<MM_SupProductStockTransferEntity>(sql.ToString());
                return MM_SupProductStockTransferEntity_list;
            }
            catch (Exception ex)
            {
                msg = ex.Message;
        ...
        public DataTable GetDataTable_TestOtherEntity(string checkType, out string msg)
        {
            ...
            try
            {
                ...
                Data.Dapper.SqlDatabase db2 = new Data.Dapper.SqlDatabase();
                //实体映射查询
                DataTable MM_SupProductStockTransferEntity_DataTable = db2.FindTable(sql.ToString());
                return MM_SupProductStockTransferEntity_DataTable;
            }
            catch (Exception ex)
            {
                msg = ex.Message;
        ...
        public string GetList_export(string checkType, out string msg)
        {
            ...
            try
            {
                ...
                string saveFileName = "超产品库存流转记录_" + DateTime.Now.ToString("yyyy-MM-dd-HHmm") + ".xls";
                
                ExcelHelper Excel = new ExcelHelper();
                MemoryStream ms = Excel.DataTableToExcel("超产品库存流转记录", dt, true);
                //保存
