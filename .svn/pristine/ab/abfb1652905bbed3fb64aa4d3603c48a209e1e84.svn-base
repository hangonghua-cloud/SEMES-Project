...
namespace Siemens.SimaticIT.MasterData.ButtonAuthFBLib.MSModel.Commands
{
    ...
    /// Class initialize
    /// </summary>
    public partial class ProductionOrderEditMaterialHandlerShell : ICommandHandler
    {
        ...
        public Response Execute(IUnifiedSdk unifiedSdk, ICommand command)
        {
            ...
            return ProductionOrderEditMaterialHandler((ProductionOrderEditMaterial)command);
        }
        ...
        {
            return typeof(ProductionOrderEditMaterial);
        }
    }
}
