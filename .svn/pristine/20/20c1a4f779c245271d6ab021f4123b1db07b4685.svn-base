...
namespace Siemens.SimaticIT.MasterData.ButtonAuthFBLib.MSModel.Commands
{
    ...
    /// Class initialize
    /// </summary>
    public partial class ProductionOrderSapPublishHandlerShell : ICommandHandler
    {
        ...
        public Response Execute(IUnifiedSdk unifiedSdk, ICommand command)
        {
            ...
            return ProductionOrderSapPublishHandler((ProductionOrderSapPublish)command);
        }
        ...
        {
            return typeof(ProductionOrderSapPublish);
        }
    }
}
