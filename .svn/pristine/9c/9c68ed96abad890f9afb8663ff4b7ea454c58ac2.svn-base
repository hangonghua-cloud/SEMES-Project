...
{ 
    ...
    /// 1.创建日期: 2021-10-29
    /// 2.创建作者: liyongguo
    /// 3.功能描述: MM_SaleDomesticInService 业务服务类
    /// 4.任务编号: 内销成品入库记录
    /// 5.最后修改日期: 
    /// 6.最后修改作者: 
    /// </summary>
    public class MM_SaleDomesticIn_Service : RepositoryFactory<MM_SaleDomesticInEntity>
    { 
        /// <summary>
        /// 功能描述: 查询分页列表
        /// 创　　建: liyongguo
        ...
        public IEnumerable<MM_SaleDomesticInEntity> GetPageList(Pagination pagination, string queryJson)
        {
            ...
            sql.Append(@"SELECT 
                      ...
                      ,[ModifyBy]
                      ,[ModifyTime]
                  FROM [dbo].[MM_SaleDomesticIn] where 1=1  ");
        ...
        /// <returns>返回分页列表</returns>
        public IEnumerable<MM_SaleDomesticInEntity> GetList(string checkType, out string msg)
        {
            StringBuilder sql = new StringBuilder();
            sql.Append(@"SELECT 
                      [Id]
        ...
        public int SaveEntity(string keyValue, MM_SaleDomesticInEntity entity, out string msg)
        {
            int n = 0;
            msg = "";
            try
        ...
        /// <param name="List<MM_SaleDomesticInEntity>">实体对象数组</param>
        /// <param name="msg">输出错误内容</param>
        /// <returns>返回int 成功1, 失败0 </returns>
        public int SaveEntity_List(bool IsUpdate, string CreatedByName, List<MM_SaleDomesticInEntity> entity_list, out string msg)
        {
            int n = 0;
            msg = "";
            try
            {
                if (IsUpdate)
                {
                    ...
                    if (entity_list.Count > 0)
                    {
                        foreach (var Save_obj in entity_list)
                        {
                            ...
                            sql_temp.Append("UPDATE [dbo].[MM_SaleDomesticIn] set ");
                            string keyValue = "";
                            //循环实体
                ...
                else
                {
                    ...
                    StringBuilder sql = new StringBuilder();
                    sql.Append($@"INSERT INTO [dbo].[MM_SaleDomesticIn] (
                                            [Id]
                                            ,[FactoryCode]
                                            ,[ProductOrder]
                                            ,[WorkOrder]
        ...
        {
            int result = 0;
            MM_SaleDomesticInEntity entity = this.BaseRepository().FindEntity(keyValue);
            if (entity != null)
            {
        ...
        public int Delete_SQL(string keyValue, out string msg)
        {
            ...
            {
                StringBuilder sql = new StringBuilder();
                sql.Append($@"DELETE FROM [dbo].[MM_SaleDomesticIn] WHERE Id=N'{keyValue}'");
                n = this.BaseRepository().ExecuteBySql(sql.ToString());
            }
            catch (Exception ex)
            {
        ...
        /// </summary>
        /// <param name="keyValue">主键值</param>
        /// <returns>返回MM_SaleDomesticInEntity</returns>
        public MM_SaleDomesticInEntity GetEntity(string keyValue)
        {
        ...
        /// <returns>返回MM_SaleDomesticInEntity</returns>
        public MM_SaleDomesticInEntity GetEntityByQuery(string QueryField)
        {
        ...
        /// <returns>返回MM_SaleDomesticInEntity 对象</returns>
        public MM_SaleDomesticInEntity Get_ExpressionEntity(Expression<Func<MM_SaleDomesticInEntity, bool>> condition)
        {
            // 根据实际情况更换某字段, 这个字段内容在列表是唯一值
        ...
        /// </summary>
        /// /// <param name="condition">Expression 条件</param>
        /// <returns>返回MM_SaleDomesticInEntity 列表</returns>
        public IEnumerable<MM_SaleDomesticInEntity> Get_ExpressionList(Expression<Func<MM_SaleDomesticInEntity, bool>> condition)
        {
            // 根据实际情况更换某字段, 这个字段内容在列表是唯一值
        ...
        //    StringBuilder sql = new StringBuilder();
        //    //子表服务类
        //    RepositoryFactory<MM_SaleDomesticInEntity> bomService = new RepositoryFactory<MM_SaleDomesticInEntity>();
        
        //    MM_SaleDomesticInEntity entity = this.BaseRepository().FindEntity(keyValue);
        //    //根据主表在子表的ID与主表主键查找实体, 如果是多条,使用循环遍历删除
        //    MM_SaleDomesticInDetailEntity bomEntity = bomService.BaseRepository().IQueryable(t => t.MM_SaleDomesticIn_Id == entity.Id).FirstOrDefault();
        //    if (entity != null)
        //    {
        //        //主表删除标记
        ...
        /// <returns>返回分页列表</returns>
        public IEnumerable<MM_SaleDomesticInEntity> GetList_TestOtherEntity(string checkType, out string msg)
        {
            StringBuilder sql = new StringBuilder();
            ...
            try
            {
                ...
                //实体映射查询
                IEnumerable<MM_SaleDomesticInEntity> MM_SaleDomesticInEntity_list =  db2.FindList<MM_SaleDomesticInEntity>(sql.ToString());
                return MM_SaleDomesticInEntity_list;
            }
            catch (Exception ex)
            {
                msg = ex.Message;
        ...
        public DataTable GetDataTable_TestOtherEntity(string checkType, out string msg)
        {
            ...
            try
            {
                ...
                Data.Dapper.SqlDatabase db2 = new Data.Dapper.SqlDatabase();
                //实体映射查询
                DataTable MM_SaleDomesticInEntity_DataTable = db2.FindTable(sql.ToString());
                return MM_SaleDomesticInEntity_DataTable;
            }
            catch (Exception ex)
            {
                msg = ex.Message;
        ...
        public string GetList_export(string checkType, out string msg)
        {
            ...
            try
            {
                ...
                string saveFileName = "内销成品入库记录_" + DateTime.Now.ToString("yyyy-MM-dd-HHmm") + ".xls";
                
                ExcelHelper Excel = new ExcelHelper();
                MemoryStream ms = Excel.DataTableToExcel("内销成品入库记录", dt, true);
                //保存
