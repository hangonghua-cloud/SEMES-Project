...
/* 'applicationServiceUrls': { "CommonApp": "http://localhost:80/sit-svc/Application/CommonApp/odata"}, */
/* 'applicationSignalManagerUrls': { "CommonApp": "http://localhost:80/sit-svc/Application/CommonApp/signals" }, */
