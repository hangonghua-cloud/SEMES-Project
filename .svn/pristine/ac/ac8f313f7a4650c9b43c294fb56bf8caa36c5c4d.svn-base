(function () {
    'use strict';
    angular.module('Siemens.SimaticIT.PlanApp.Plan')
        .constant('Siemens.SimaticIT.PlanApp.Plan.ProductionOrder.constants', ScreenServiceConstants())
        .service('Siemens.SimaticIT.PlanApp.Plan.ProductionOrder.service', ScreenService)
    ...
    ScreenService.$inject = ['$q', '$state', 'common.base', 'Siemens.SimaticIT.PlanApp.Plan.ProductionOrder.constants', 'common.services.logger.service'];
    function ScreenService($q, $state, base, context, loggerService) {
        ...
        activate();
        function activate() {
            logger = loggerService.getModuleLogger('Siemens.SimaticIT.PlanApp.Plan.ProductionOrder.service');
    ...
    ScreenServiceRun.$inject = ['Siemens.SimaticIT.PlanApp.Plan.ProductionOrder.constants', 'common.base'];
