(function () {
    'use strict';
    angular.module('Siemens.SimaticIT.QualityApp.IPQCManage')
        .constant('Siemens.SimaticIT.QualityApp.IPQCManage.TestMaintenance.constants', ScreenServiceConstants())
        .service('Siemens.SimaticIT.QualityApp.IPQCManage.TestMaintenance.service', ScreenService)
    ...
    ScreenService.$inject = ['$q', '$state', 'common.base', 'Siemens.SimaticIT.QualityApp.IPQCManage.TestMaintenance.constants', 'common.services.logger.service'];
    function ScreenService($q, $state, base, context, loggerService) {
        ...
        activate();
        function activate() {
            logger = loggerService.getModuleLogger('Siemens.SimaticIT.QualityApp.IPQCManage.TestMaintenance.service');
    ...
    ScreenServiceRun.$inject = ['Siemens.SimaticIT.QualityApp.IPQCManage.TestMaintenance.constants', 'common.base'];
