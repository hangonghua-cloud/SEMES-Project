...
/* 'applicationServiceUrls': { "ProductionApp": "http://localhost:80/sit-svc/Application/ProductionApp/odata"}, */
/* 'applicationSignalManagerUrls': { "ProductionApp": "http://localhost:80/sit-svc/Application/ProductionApp/signals" }, */
