(function () {
    ...
    ViewScreenController.$inject = ['Siemens.SimaticIT.ProductionApp.TransferCardResume.SharedInventory.service', '$state', '$stateParams', 'common.base', '$filter', '$scope'];
    ...
    function ViewScreenStateConfig($stateProvider) {
        var screenStateName = 'home.Siemens_SimaticIT_ProductionApp_TransferCardResume_SharedInventory';
        ...
        var state = {
            ...
            views: {
                'property-area-container@': {
                    templateUrl: moduleFolder + '/SharedInventory-select.html',
