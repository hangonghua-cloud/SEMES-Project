(function () {
    ...
    angular.module('Siemens.SimaticIT.MaterialApp.MaterialMain')
        .constant('Siemens.SimaticIT.MaterialApp.MaterialMain.MaterialMain.constants', ScreenServiceConstants())
        .service('Siemens.SimaticIT.MaterialApp.MaterialMain.MaterialMain.service', ScreenService)
    ...
    ScreenService.$inject = ['$q', '$state', 'common.base', 'Siemens.SimaticIT.MaterialApp.MaterialMain.MaterialMain.constants', 'common.services.logger.service'];
    function ScreenService($q, $state, base, context, loggerService) {
        ...
        activate();
        function activate() {
            logger = loggerService.getModuleLogger('Siemens.SimaticIT.MaterialApp.MaterialMain.MaterialMain.service');
    ...
    ScreenServiceRun.$inject = ['Siemens.SimaticIT.MaterialApp.MaterialMain.MaterialMain.constants', 'common.base'];
