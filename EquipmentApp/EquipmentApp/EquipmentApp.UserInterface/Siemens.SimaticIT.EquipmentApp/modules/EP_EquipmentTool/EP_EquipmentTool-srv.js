...
(function () {
    'use strict';
    angular.module('Siemens.SimaticIT.EquipmentApp.EP_EquipmentTool')
        .constant('Siemens.SimaticIT.EquipmentApp.EP_EquipmentTool.EP_EquipmentTool.constants', ScreenServiceConstants())
        .service('Siemens.SimaticIT.EquipmentApp.EP_EquipmentTool.EP_EquipmentTool.service', ScreenService)
    ...
    ScreenService.$inject = ['$q', '$state', 'common.base', 'Siemens.SimaticIT.EquipmentApp.EP_EquipmentTool.EP_EquipmentTool.constants', 'common.services.logger.service'];
    function ScreenService($q, $state, base, context, loggerService) {
        ...
        activate();
        function activate() {
            logger = loggerService.getModuleLogger('Siemens.SimaticIT.EquipmentApp.EP_EquipmentTool.EP_EquipmentTool.service');
    ...
    ScreenServiceRun.$inject = ['Siemens.SimaticIT.EquipmentApp.EP_EquipmentTool.EP_EquipmentTool.constants', 'common.base'];
