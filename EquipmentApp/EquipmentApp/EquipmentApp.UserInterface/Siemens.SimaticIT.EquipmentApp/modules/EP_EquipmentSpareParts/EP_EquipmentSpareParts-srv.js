...
(function () {
    'use strict';
    angular.module('Siemens.SimaticIT.EquipmentApp.EP_EquipmentSpareParts')
        .constant('Siemens.SimaticIT.EquipmentApp.EP_EquipmentSpareParts.EP_EquipmentSpareParts.constants', ScreenServiceConstants())
        .service('Siemens.SimaticIT.EquipmentApp.EP_EquipmentSpareParts.EP_EquipmentSpareParts.service', ScreenService)
    ...
    ScreenService.$inject = ['$q', '$state', 'common.base', 'Siemens.SimaticIT.EquipmentApp.EP_EquipmentSpareParts.EP_EquipmentSpareParts.constants', 'common.services.logger.service'];
    function ScreenService($q, $state, base, context, loggerService) {
        ...
        activate();
        function activate() {
            logger = loggerService.getModuleLogger('Siemens.SimaticIT.EquipmentApp.EP_EquipmentSpareParts.EP_EquipmentSpareParts.service');
    ...
    ScreenServiceRun.$inject = ['Siemens.SimaticIT.EquipmentApp.EP_EquipmentSpareParts.EP_EquipmentSpareParts.constants', 'common.base'];
