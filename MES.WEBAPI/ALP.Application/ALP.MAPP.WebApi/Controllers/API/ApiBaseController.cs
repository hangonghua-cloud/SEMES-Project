...
namespace ALP.Application.WebApi.Controllers.API
{
    public class ApiBaseController : ApiController
    {
        ...
        public HttpResponseMessage AjaxResultWithParams(bool flag, string msg, params string[] parms)
        {
            var result = new ResponseResult();
            result.success = flag;
            result.returnMsg = ALP.Application.Service.Resources.Language.GetText(msg, parms);
            return Request.CreateResponse(HttpStatusCode.OK, result);
        }
