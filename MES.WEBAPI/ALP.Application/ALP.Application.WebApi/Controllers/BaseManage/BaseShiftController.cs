    ...
    public class BaseShiftController : ApiBaseController
    {
        ...
        public HttpResponseMessage GetPageListJson(JObject jo)
        {
            ...
            try
            {
                ...
                {
                    result.success = false;
                    result.returnMsg = ALP.Application.Service.Resources.Language.GetText("BaseManage.BaseShiftController.Tips_2");//分页参数Pagination不能为空！
                    return Request.CreateResponse(HttpStatusCode.OK, result);
                }
        ...
        public HttpResponseMessage GetFormJson(Guid keyValue)
        {
            ...
            try
            {
                ...
                result.success = true;
                result.returnMsg = ALP.Application.Service.Resources.Language.GetText("BaseManage.BaseShiftController.Tips_4");//获取详情数据成功
                return Request.CreateResponse(HttpStatusCode.OK, result);
            }
            catch (Exception ex)
            {
        ...
        public HttpResponseMessage Delete(JObject jo)
        {
            ...
            try
            {
                ...
                {
                    result.success = false;
                    result.returnMsg = ALP.Application.Service.Resources.Language.GetText("BaseManage.BaseShiftController.Tips_5");//用户名不能为空！
                    return Request.CreateResponse(HttpStatusCode.OK, result);
                }
                else
                {
        ...
        public HttpResponseMessage Save(JObject jo)
        {
            ...
            try
            {
                ...
                {
                    result.success = false;
                    result.returnMsg = ALP.Application.Service.Resources.Language.GetText("BaseManage.BaseShiftController.Tips_8");//缺少KeyValue参数！
                    return Request.CreateResponse(HttpStatusCode.OK, result);
                }
                if (jo.SelectToken("Entity") == null)
                {
                    result.success = false;
                    result.returnMsg = ALP.Application.Service.Resources.Language.GetText("BaseManage.BaseShiftController.Tips_9");//缺少Entity参数！
                    return Request.CreateResponse(HttpStatusCode.OK, result);
                }
