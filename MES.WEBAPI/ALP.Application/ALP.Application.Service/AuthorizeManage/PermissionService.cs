...
#pragma warning disable CS1573 // 参数“userId”在“PermissionService.GetObjectList(string)”的 XML 注释中没有匹配的 param 标记(但其他参数有)
#pragma warning disable CS1572 // XML 注释中有“UserId”的 param 标记，但是没有该名称的参数
        /// <summary>
        /// 获取对象列表
        /// </summary>
...
#pragma warning restore CS1572 // XML 注释中有“UserId”的 param 标记，但是没有该名称的参数
#pragma warning restore CS1573 // 参数“userId”在“PermissionService.GetObjectList(string)”的 XML 注释中没有匹配的 param 标记(但其他参数有)
        {
