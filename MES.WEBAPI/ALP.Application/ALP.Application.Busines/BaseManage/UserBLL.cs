...
namespace ALP.Application.Busines.BaseManage
{
    ...
    public class UserBLL
    {
        ...
        /// <returns></returns>
        public UserEntity GetEntityByAccount(string userAccount)
        {
            return service.CheckLogin(userAccount);
        }
        ...
        public bool CheckExistUserByRoleId(string roleId)
        {
            var list = service.GetUserListByRoleId(roleId);
            return list.Count() > 0;
        }
        ...
        /// <returns></returns>
        public bool CheckExistUserByDepartId(string departmentId)
        {
            var list = service.GetUserListByDepartId(departmentId);
            return list.Count() > 0;
        }
        #endregion
        ...
        public UserEntity CheckLogin(string username, string password)
        {
            ...
            if (userEntity != null)
            {
                if (userEntity.EnabledMark == 1)
                {
                    ...
                    //string dbPassword1 = Md5Helper.MD5(DESEncrypt.Decrypt("09b55ce16d70ac3b9c4696554f11dbee".ToLower(), userEntity.Secretkey).ToLower(), 32).ToLower();
