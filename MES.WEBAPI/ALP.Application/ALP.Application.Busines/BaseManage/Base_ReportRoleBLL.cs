...
namespace ALP.Application.Busines.BaseManage
{
    ...
    /// 描 述：报表权限角色
    /// </summary>
    public class Base_ReportRoleBLL
    {
        private Base_ReportRoleIService service = new Base_ReportRoleService();
        ...
        {
            return service.GetReportRoleUserList(pagination, queryJson);
        }
        public DataTable GetUserNotInGroup(Pagination pagination, string queryJson)
        {
            return service.GetUserNotInGroup(pagination, queryJson);
        }
        #endregion
