...
{
    public class QC_IPQCDetail_BLL
    {
        private QC_IPQCDetail_IService service = new QC_IPQCDetail_Service();
        ...
        {
            return service.GetCalibrationMethodPageList(pagination, queryJson);
        }
        ...
        {
            return service.GetProcessList(method);
        }
        ...
        {
            return service.GetMainenanceList(pagination, queryJson);
        }
        ...
        {
            return service.GetProcessList(pagination, queryJson);
        }
        /// <summary>
