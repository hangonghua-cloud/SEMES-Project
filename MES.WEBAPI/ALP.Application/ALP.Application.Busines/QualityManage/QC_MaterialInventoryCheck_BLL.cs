...
{
    public class QC_MaterialInventoryCheck_BLL
    {
        private QC_MaterialInventoryCheck_IService service = new QC_MaterialInventoryCheck_Service();


        /// <summary>
        /// 功能描述: 查询分页列表
        /// 创　　建: 丁零
        /// 创建日期: 2021-08-27 10:46:53
        /// 任务编号: 原材料库存检验记录表
        /// </summary>
        ...
        /// <param name="List<QC_MaterialInventoryCheckListEntity>">实体对象数组</param>
        /// <param name="msg">输出错误内容</param>
        /// <returns>返回int 成功1, 失败0 </returns>
        ...
        /// </summary>
        /// <param name="keyValue">主键值</param>
        /// <returns>返回QC_MaterialInventoryCheckListEntity</returns>
        ...
        /// <returns>返回QC_MaterialInventoryCheckListEntity 对象</returns>
        ...
        /// </summary>
        /// /// <param name="condition">Expression 条件</param>
        /// <returns>返回QC_MaterialInventoryCheckListEntity 列表</returns>
        ...
        //    //子表服务类
        //    RepositoryFactory<QC_MaterialInventoryCheckListEntity> bomService = new RepositoryFactory<QC_MaterialInventoryCheckListEntity>();

        //    QC_MaterialInventoryCheckListEntity entity = this.BaseRepository().FindEntity(keyValue);
        //    //根据主表在子表的ID与主表主键查找实体, 如果是多条,使用循环遍历删除
        //    QC_MaterialInventoryCheckListDetailEntity bomEntity = bomService.BaseRepository().IQueryable(t => t.QC_MaterialInventoryCheckList_Id == entity.Id).FirstOrDefault();
        //    if (entity != null)
        //    {
        //        //主表删除标记
