...
{
    public class PM_ProductionFirstInspectionDetailBLL
    {
        private PM_ProductionFirstInspectionDetailIService service = new PM_ProductionFirstInspectionDetail_Service();
        ...
        {
            return service.FirstInspectionQueryResult(queryJson);
        }
    }
}
