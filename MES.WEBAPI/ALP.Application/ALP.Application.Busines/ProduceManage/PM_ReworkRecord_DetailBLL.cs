...
{
    public class PM_ReworkRecord_DetailBLL
    {
        private PM_ReworkRecord_Detail_IService service = new PM_ReworkRecord_Detail_Service();
        ...
        {
            return service.GetPageDataTableList(pagination, queryJson, reworkProductType);
        }
        ...
        {
            return service.GetReworkRecordDetail(reworkId, reworkProductType);
        }
    }
}
