...
{
    public interface QC_TestMethodItemMaintenance_IService
    {
        /// <summary>
        /// 功能描述: 查询分页列表
        /// 创　　建: 丁零
        /// 创建日期: 2021-08-27 10:43:14
        /// 任务编号: IQC检验项目配置表
        /// </summary>
        /// <param name="pagination">分页</param>
        /// <param name="queryJson">查询参数</param>
        /// <returns>返回分页列表</returns>
        IEnumerable<QC_TestMethodItemMaintenanceEntity> GetPageList(Pagination pagination, string queryJson);
        ...
        /// <returns>返回分页列表</returns>
        IEnumerable<QC_TestMethodItemMaintenanceEntity> GetList(string checkType, out string msg);
        ...
        int SaveEntity(string keyValue, QC_TestMethodItemMaintenanceEntity entity, out string msg);
        ...
        /// <param name="msg">输出错误内容</param>
        /// <returns>返回int 成功1, 失败0 </returns>
        int SaveEntity_List(bool IsUpdate, string CreatedByName, List<QC_TestMethodItemMaintenanceEntity> entity_list, out string msg);
        ...
        QC_TestMethodItemMaintenanceEntity GetEntity(string keyValue);
        ...
        /// <returns>返回QC_TestMethodItemMaintenanceEntity</returns>
        QC_TestMethodItemMaintenanceEntity GetEntityByQuery(string QueryField);
        ...
        QC_TestMethodItemMaintenanceEntity Get_ExpressionEntity(Expression<Func<QC_TestMethodItemMaintenanceEntity, bool>> condition);
        ...
        IEnumerable<QC_TestMethodItemMaintenanceEntity> Get_ExpressionList(Expression<Func<QC_TestMethodItemMaintenanceEntity, bool>> condition);
        ...
        /// <returns>返回分页列表</returns>
        IEnumerable<QC_TestMethodItemMaintenanceEntity> GetList_TestOtherEntity(string checkType, out string msg);
