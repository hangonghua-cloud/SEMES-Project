...
{
    public interface QC_IPQCDetailResult_IService
    {
        /// <summary>
        /// 功能描述: 查询分页列表
        /// 创　　建: 丁零
        ...
        IEnumerable<QC_IPQCDetailResultEntity> GetPageList(Pagination pagination, string queryJson);
        ...
        /// <returns></returns>
        DataTable GetCheckPageDataTableList(Pagination pagination, string queryJson);
        /// <summary>
        ...
        /// <returns>返回分页列表</returns>
        IEnumerable<QC_IPQCDetailResultEntity> GetList(string checkType, out string msg);
        ...
        int SaveEntity(string keyValue, QC_IPQCDetailResultEntity entity, out string msg);

        int SaveEntity(QC_IPQCDetailEntity mainEntity, List<QC_IPQCDetailResultEntity> list, ref string msg);
        ...
        /// <param name="msg">输出错误内容</param>
        /// <returns>返回int 成功1, 失败0 </returns>
        int SaveEntity_List(bool IsUpdate, string CreatedByName, List<QC_IPQCDetailResultEntity> entity_list, out string msg);
        ...
        int RemoveForm(Expression<Func<QC_IPQCDetailResultEntity, bool>> condition);
        ...
        QC_IPQCDetailResultEntity GetEntity(string keyValue);
        ...
        /// <returns>返回QC_IPQCDetailResultEntity</returns>
        QC_IPQCDetailResultEntity GetEntityByQuery(string QueryField);
        ...
        QC_IPQCDetailResultEntity Get_ExpressionEntity(Expression<Func<QC_IPQCDetailResultEntity, bool>> condition);
        ...
        IEnumerable<QC_IPQCDetailResultEntity> Get_ExpressionList(Expression<Func<QC_IPQCDetailResultEntity, bool>> condition);
        ...
        /// <returns>返回分页列表</returns>
        IEnumerable<QC_IPQCDetailResultEntity> GetList_TestOtherEntity(string checkType, out string msg);
