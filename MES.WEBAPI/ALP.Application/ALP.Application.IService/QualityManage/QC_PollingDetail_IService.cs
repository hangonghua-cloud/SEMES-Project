...
{
    public interface QC_PollingDetail_IService
    {
        /// <summary>
        /// 功能描述: 查询分页列表
        /// 创　　建: 丁零
        ...
        IEnumerable<QC_PollingDetailEntity> GetPageList(Pagination pagination, string queryJson);
        /// <summary>
        /// 用户实体
        /// </summary>
        /// <param name="keyValue">主键值</param>
        /// <returns></returns>
        DataTable GetUserEntity(string keyValue);
        ...
        /// <returns>返回分页列表</returns>
        IEnumerable<QC_PollingDetailEntity> GetList(string checkType, out string msg);
        ...
        int SaveEntity(string keyValue, QC_PollingDetailEntity entity, out string msg);
        int Insert(QC_PollingDetailEntity entity);
        ...
        /// <returns></returns>
        int SaveDetermination(string keyValue, string determinationValue, string inspector, ref string msg);
        ...
        /// <param name="msg">输出错误内容</param>
        /// <returns>返回int 成功1, 失败0 </returns>
        int SaveEntity_List(bool IsUpdate, string CreatedByName, List<QC_PollingDetailEntity> entity_list, out string msg);
        ...
        QC_PollingDetailEntity GetEntity(string keyValue);
        ...
        /// <returns>返回QC_PollingDetailEntity</returns>
        QC_PollingDetailEntity GetEntityByQuery(string QueryField);
        ...
        QC_PollingDetailEntity Get_ExpressionEntity(Expression<Func<QC_PollingDetailEntity, bool>> condition);
        ...
        IEnumerable<QC_PollingDetailEntity> Get_ExpressionList(Expression<Func<QC_PollingDetailEntity, bool>> condition);
        ...
        /// <returns>返回分页列表</returns>
        IEnumerable<QC_PollingDetailEntity> GetList_TestOtherEntity(string checkType, out string msg);
