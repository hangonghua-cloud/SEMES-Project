...
{
    [Auth]
    [RoutePrefix("PL_InternalOrder")]
    public class PL_InternalOrderController : ApiBaseController
    {
        PL_InternalOrder_Service _service = new PL_InternalOrder_Service();

        [HttpPost]
        [Route("PL_InternalOrderPageDataTableList")]

        public HttpResponseMessage PL_InternalOrderPageDataTableList(JObject jo)
        {
