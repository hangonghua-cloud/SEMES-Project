...
{ 
    ...
    /// 1.创建日期: 2021-09-09
    /// 2.创建作者: liyongguo
    /// 3.功能描述: QC_TestMethodItemMaintenance实体
    /// 4.任务编号: 原料/IQC检测项目配置表
    /// 5.最后修改日期: 
    /// 6.最后修改作者: 
    /// </summary>
    public class QC_TestMethodItemMaintenanceEntity : BaseEntity
    { 
        #region 表: QC_TestMethodItemMaintenance 实体类: QC_TestMethodItemMaintenance 
