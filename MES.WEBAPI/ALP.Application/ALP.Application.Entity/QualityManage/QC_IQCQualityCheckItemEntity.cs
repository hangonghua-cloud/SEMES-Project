...
{ 
    ...
    /// 1.创建日期: 2021-09-10
    /// 2.创建作者: liyongguo
    /// 3.功能描述: QC_IQCQualityCheckItem实体
    /// 4.任务编号: IQC检测记录
    /// 5.最后修改日期: 
    /// 6.最后修改作者: 
    /// </summary>
    public class QC_IQCQualityCheckItemEntity : BaseEntity
    { 
        #region 表: QC_IQCQualityCheckItem 实体类: QC_IQCQualityCheckItem 
