(function () {
    'use strict';
    angular.module('Siemens.SimaticIT.FactoryModelApp.ModelLevelExtendFileds')
        .constant('Siemens.SimaticIT.FactoryModelApp.ModelLevelExtendFileds.ModelLevelExtendFileds.constants', ScreenServiceConstants())
        .service('Siemens.SimaticIT.FactoryModelApp.ModelLevelExtendFileds.ModelLevelExtendFileds.service', ScreenService)
    ...
    ScreenService.$inject = ['$q', '$state', 'common.base', 'Siemens.SimaticIT.FactoryModelApp.ModelLevelExtendFileds.ModelLevelExtendFileds.constants', 'common.services.logger.service'];
    function ScreenService($q, $state, base, context, loggerService) {
        ...
        activate();
        function activate() {
            logger = loggerService.getModuleLogger('Siemens.SimaticIT.FactoryModelApp.ModelLevelExtendFileds.ModelLevelExtendFileds.service');
    ...
    ScreenServiceRun.$inject = ['Siemens.SimaticIT.FactoryModelApp.ModelLevelExtendFileds.ModelLevelExtendFileds.constants', 'common.base'];
