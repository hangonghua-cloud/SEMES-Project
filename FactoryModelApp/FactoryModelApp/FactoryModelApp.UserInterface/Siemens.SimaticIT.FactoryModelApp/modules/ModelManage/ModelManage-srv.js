(function () {
    'use strict';
    angular.module('Siemens.SimaticIT.FactoryModelApp.ModelManage')
        .constant('Siemens.SimaticIT.FactoryModelApp.ModelManage.ModelManage.constants', ScreenServiceConstants())
        .service('Siemens.SimaticIT.FactoryModelApp.ModelManage.ModelManage.service', ScreenService)
    ...
    ScreenService.$inject = ['$q', '$state', 'common.base', 'Siemens.SimaticIT.FactoryModelApp.ModelManage.ModelManage.constants', 'common.services.logger.service'];
    function ScreenService($q, $state, base, context, loggerService) {
        ...
        activate();
        function activate() {
            logger = loggerService.getModuleLogger('Siemens.SimaticIT.FactoryModelApp.ModelManage.ModelManage.service');
    ...
    ScreenServiceRun.$inject = ['Siemens.SimaticIT.FactoryModelApp.ModelManage.ModelManage.constants', 'common.base'];
