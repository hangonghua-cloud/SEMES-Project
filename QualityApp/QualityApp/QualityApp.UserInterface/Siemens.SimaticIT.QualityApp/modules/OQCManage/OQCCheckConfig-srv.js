(function () {
    ...
    angular.module('Siemens.SimaticIT.QualityApp.OQCManage')
        .constant('Siemens.SimaticIT.QualityApp.OQCManage.OQCCheckConfig.constants', ScreenServiceConstants())
        .service('Siemens.SimaticIT.QualityApp.OQCManage.OQCCheckConfig.service', ScreenService)
    ...
    ScreenService.$inject = ['$q', '$state', 'common.base', 'Siemens.SimaticIT.QualityApp.OQCManage.OQCCheckConfig.constants', 'common.services.logger.service'];
    function ScreenService($q, $state, base, context, loggerService) {
        ...
        activate();
        function activate() {
            logger = loggerService.getModuleLogger('Siemens.SimaticIT.QualityApp.OQCManage.OQCCheckConfig.service');
    ...
    ScreenServiceRun.$inject = ['Siemens.SimaticIT.QualityApp.OQCManage.OQCCheckConfig.constants', 'common.base'];
