...
(function () {
    'use strict';
    angular.module('Siemens.SimaticIT.QualityApp.QC_MaterialInventoryCheckList').config(EditAuditScreenStateConfig);
    
    EditAuditScreenController.$inject = ['Siemens.SimaticIT.QualityApp.QC_MaterialInventoryCheckList.QC_MaterialInventoryCheckList.service', '$state', '$stateParams',
    ...
    function EditAuditScreenController(dataService, $state, $stateParams, common, $filter, $scope, $rootScope, commonService, auth, notificationService, busyIndicatorService, $modal) {
        ...
        function activate() {
            ...
            sidePanelManager.setTitle(commonService.$t('Siemens.SimaticIT.QualityApp.QC_MaterialInventoryCheckList.QC_MaterialInventoryCheckListeditauditctrl.Tips_1'));
        ...
        function init() {
            ...
            self.ResultConfig = {
                value: null,
                selectedOption: { ItemCode: "", ItemName: commonService.$t('Siemens.SimaticIT.QualityApp.QC_MaterialInventoryCheckList.QC_MaterialInventoryCheckListeditauditctrl.Tips_2') },
                options: [
                    { ItemCode: "", ItemName: commonService.$t('Siemens.SimaticIT.QualityApp.QC_MaterialInventoryCheckList.QC_MaterialInventoryCheckListeditauditctrl.Tips_2') },
                    { ItemCode: "1", ItemName: commonService.$t('Siemens.SimaticIT.QualityApp.QC_MaterialInventoryCheckList.QC_MaterialInventoryCheckListeditauditctrl.Tips_3') },
                    { ItemCode: "2", ItemName: commonService.$t('Siemens.SimaticIT.QualityApp.QC_MaterialInventoryCheckList.QC_MaterialInventoryCheckListeditauditctrl.Tips_4') }
                ]
            };
            /*self.ResultConfig2 = {
                value: null,
                selectedOption: {ItemCode: "", ItemName:commonService.$t('Siemens.SimaticIT.QualityApp.QC_MaterialInventoryCheckList.QC_MaterialInventoryCheckListeditauditctrl.Tips_5')},
                options: [
                    {ItemCode: "", ItemName:commonService.$t('Siemens.SimaticIT.QualityApp.QC_MaterialInventoryCheckList.QC_MaterialInventoryCheckListeditauditctrl.Tips_5')},
                    {ItemCode: "1", ItemName:commonService.$t('Siemens.SimaticIT.QualityApp.QC_MaterialInventoryCheckList.QC_MaterialInventoryCheckListeditauditctrl.Tips_3')},
                    {ItemCode: "2", ItemName:commonService.$t('Siemens.SimaticIT.QualityApp.QC_MaterialInventoryCheckList.QC_MaterialInventoryCheckListeditauditctrl.Tips_4')}
                ]
            };*/
            self.ResultConfig3 = {
                ...
                selectedOption: { ItemCode: "", ItemName: commonService.$t('Siemens.SimaticIT.QualityApp.QC_MaterialInventoryCheckList.QC_MaterialInventoryCheckListeditauditctrl.Tips_2') },
                options: [
                    { ItemCode: "", ItemName: commonService.$t('Siemens.SimaticIT.QualityApp.QC_MaterialInventoryCheckList.QC_MaterialInventoryCheckListeditauditctrl.Tips_6') },
                    { ItemCode: "1", ItemName: commonService.$t('Siemens.SimaticIT.QualityApp.QC_MaterialInventoryCheckList.QC_MaterialInventoryCheckListeditauditctrl.Tips_7') },
                    { ItemCode: "2", ItemName: commonService.$t('Siemens.SimaticIT.QualityApp.QC_MaterialInventoryCheckList.QC_MaterialInventoryCheckListeditauditctrl.Tips_8') }
                ]
            };
            self.ResultConfig4 = {
                value: null,
                selectedOption: { ItemCode: "", ItemName: commonService.$t('Siemens.SimaticIT.QualityApp.QC_MaterialInventoryCheckList.QC_MaterialInventoryCheckListeditauditctrl.Tips_6') },
                options: [
                    { ItemCode: "", ItemName: commonService.$t('Siemens.SimaticIT.QualityApp.QC_MaterialInventoryCheckList.QC_MaterialInventoryCheckListeditauditctrl.Tips_6') },
                    { ItemCode: "1", ItemName: commonService.$t('Siemens.SimaticIT.QualityApp.QC_MaterialInventoryCheckList.QC_MaterialInventoryCheckListeditauditctrl.Tips_9') },
                    { ItemCode: "2", ItemName: commonService.$t('Siemens.SimaticIT.QualityApp.QC_MaterialInventoryCheckList.QC_MaterialInventoryCheckListeditauditctrl.Tips_10') }
                ]
            };
        ...
        function initGridOptions() {
            self.gridOptions = {
                ...
                columnDefs: [
                    {
                        field: 'Id',
                        displayName: commonService.$t('Siemens.SimaticIT.QualityApp.QC_MaterialInventoryCheckList.QC_MaterialInventoryCheckListeditauditctrl.Tips_11'),
                        width: 90,
                        visible: false
                    },
                    {
                        field: 'TestMethodCoading',
                        displayName: commonService.$t('Siemens.SimaticIT.QualityApp.QC_MaterialInventoryCheckList.QC_MaterialInventoryCheckListeditauditctrl.Tips_12'),
                        width: 90,
                        visible: false
                    },
                    {
                        field: 'TestItemCoading',
                        displayName: commonService.$t('Siemens.SimaticIT.QualityApp.QC_MaterialInventoryCheckList.QC_MaterialInventoryCheckListeditauditctrl.Tips_13'),
                        width: 80,
                        visible: false
                    },
                    {
                        field: 'TestDepartmentName',
                        displayName: commonService.$t('Siemens.SimaticIT.QualityApp.QC_MaterialInventoryCheckList.QC_MaterialInventoryCheckListeditauditctrl.Tips_14'),
                        width: 80,
                        visible: false
                    },
                    {
                        field: 'TestItemName',
                        displayName: commonService.$t('Siemens.SimaticIT.QualityApp.QC_MaterialInventoryCheckList.QC_MaterialInventoryCheckListeditauditctrl.Tips_15'),
                        width: 200
                    },
                    {
                        field: 'TestItemStandard',
                        displayName: commonService.$t('Siemens.SimaticIT.QualityApp.QC_MaterialInventoryCheckList.QC_MaterialInventoryCheckListeditauditctrl.Tips_16'),
                        width: 200
                    },
                    {
                        field: 'InspectionQty',
                        displayName: commonService.$t('Siemens.SimaticIT.QualityApp.QC_MaterialInventoryCheckList.QC_MaterialInventoryCheckListeditauditctrl.Tips_17'),
                        width: 200,
                    ...
                    {
                        field: 'DataType',
                        displayName: commonService.$t('Siemens.SimaticIT.QualityApp.QC_MaterialInventoryCheckList.QC_MaterialInventoryCheckListeditauditctrl.Tips_18'),
                        width: 80,
                        visible: false
                    },
                    {
                        field: 'TestItemResultValue',
                        displayName: commonService.$t('Siemens.SimaticIT.QualityApp.QC_MaterialInventoryCheckList.QC_MaterialInventoryCheckListeditauditctrl.Tips_19'),
                        width: 200,
        ...
        function SelectPeopleModal() {
            ...
            let columnDefs = [
                {
                    name: 'rowNum', displayName: commonService.$t('Siemens.SimaticIT.QualityApp.QC_MaterialInventoryCheckList.QC_MaterialInventoryCheckListeditauditctrl.Tips_20'), minWidth: 80, width: 90, enableSorting: false, cellTemplate:
                        '<div class="ui-grid-cell-contents">{{grid.renderContainers.body.visibleRowCache.indexOf(row) + 1}}</div>'
                },
                {
                    field: 'Code',
                    displayName: commonService.$t('Siemens.SimaticIT.QualityApp.QC_MaterialInventoryCheckList.QC_MaterialInventoryCheckListeditauditctrl.Tips_21'),
                    width: 200
                },
                {
                    field: 'Name',
                    displayName: commonService.$t('Siemens.SimaticIT.QualityApp.QC_MaterialInventoryCheckList.QC_MaterialInventoryCheckListeditauditctrl.Tips_22'),
                    width: 200
                }
            ];
            //queryName: "",
        ...
        function save() {
            ...
            busyIndicatorService.show({ message: commonService.$t('Siemens.SimaticIT.QualityApp.QC_MaterialInventoryCheckList.QC_MaterialInventoryCheckListeditauditctrl.Tips_23') });
            //字典类型 取值参考
            ...
            var url = commonService.getMesApiAddress("quality") + 'QC_MaterialInventoryCheckList/SaveDetermination';
            console.log("url----------------" + url);
            //提交数据
        ...
        function onSaveSuccess(data) {
            ...
            if (data.data.success) {
                ...
                //关闭侧边栏
                sidePanelManager.close();
                commonService.showInfo(commonService.$t('Siemens.SimaticIT.QualityApp.QC_MaterialInventoryCheckList.QC_MaterialInventoryCheckListeditauditctrl.Tips_24'));
                //刷新局部
                if(self.DeterminationConfig.selectedOption != null){
                    ...
                    self.currentItem.LaboratoryTestStatusName = commonService.$t('Siemens.SimaticIT.QualityApp.QC_MaterialInventoryCheckList.QC_MaterialInventoryCheckListeditauditctrl.Tips_25');
                ...
                busyIndicatorService.hide();
                backendService.genericError(data.data.returnMsg, commonService.$t('Siemens.SimaticIT.QualityApp.QC_MaterialInventoryCheckList.QC_MaterialInventoryCheckListeditauditctrl.Tips_26'));
            }
        }
        ...
        function onSaveError(error) {
                busyIndicatorService.hide();
            backendService.genericError('[' + error.status + '] - ' + error.statusText, commonService.$t('Siemens.SimaticIT.QualityApp.QC_MaterialInventoryCheckList.QC_MaterialInventoryCheckListeditauditctrl.Tips_26'));
        }
        ...
        var state = {
            ...
            views: {
                'property-area-container@': {
                    templateUrl: moduleFolder + '/QC_MaterialInventoryCheckList-editaudit.html',
