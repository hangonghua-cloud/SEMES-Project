...
(function () {
    'use strict';
    angular.module('Siemens.SimaticIT.QualityApp.QC_PollingDetail')
        .constant('Siemens.SimaticIT.QualityApp.QC_PollingDetail.QC_PollingDetail.constants', ScreenServiceConstants())
        .service('Siemens.SimaticIT.QualityApp.QC_PollingDetail.QC_PollingDetail.service', ScreenService)
    ...
    ScreenService.$inject = ['$q', '$state', 'common.base', 'Siemens.SimaticIT.QualityApp.QC_PollingDetail.QC_PollingDetail.constants', 'common.services.logger.service'];
    function ScreenService($q, $state, base, context, loggerService) {
        ...
        activate();
        function activate() {
            logger = loggerService.getModuleLogger('Siemens.SimaticIT.QualityApp.QC_PollingDetail.QC_PollingDetail.service');
    ...
    ScreenServiceRun.$inject = ['Siemens.SimaticIT.QualityApp.QC_PollingDetail.QC_PollingDetail.constants', 'common.base'];
