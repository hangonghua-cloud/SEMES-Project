...
(function (sit) {
    ...
    (function (framework) {
        var SwacUiModuleManager = /** @class */ (function () {
            function SwacUiModuleManager($window, $injector, $timeout, $rootScope, $log, $q, authentication, swacComponentService, commonCtx) {
                var _this = this;
                this.$window = $window;
            ...
            SwacUiModuleManager.prototype.init = function () {
                this.enabled = this.commonCtx.getCtx('isSwacEnabled');
            ...
            SwacUiModuleManager.$inject = ['$window', '$injector', '$timeout', '$rootScope', '$log', '$q', 'common.services.authentication', 'common.services.component.swacComponentService', 'common.ctx'];
