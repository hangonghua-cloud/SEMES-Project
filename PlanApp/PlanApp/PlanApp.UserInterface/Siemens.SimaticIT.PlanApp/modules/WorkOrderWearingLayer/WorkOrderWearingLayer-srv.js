(function () {
    'use strict';
    angular.module('Siemens.SimaticIT.PlanApp.WorkOrderWearingLayer')
        .constant('Siemens.SimaticIT.PlanApp.WorkOrderWearingLayer.WorkOrderWearingLayer.constants', ScreenServiceConstants())
        .service('Siemens.SimaticIT.PlanApp.WorkOrderWearingLayer.WorkOrderWearingLayer.service', ScreenService)
    ...
    function ScreenServiceConstants() {
        return {
            data: {
                //appName: 'PlanApp',
                appName: 'PlanApp', // The name of App: in case of extended app, it is the name of AppBase
    ...
    ScreenService.$inject = ['$q', '$state', 'common.base', 'Siemens.SimaticIT.PlanApp.WorkOrderWearingLayer.WorkOrderWearingLayer.constants', 'common.services.logger.service'];
    function ScreenService($q, $state, base, context, loggerService) {
        ...
        activate();
        function activate() {
            logger = loggerService.getModuleLogger('Siemens.SimaticIT.PlanApp.WorkOrderWearingLayer.WorkOrderWearingLayer.service');
    ...
    ScreenServiceRun.$inject = ['Siemens.SimaticIT.PlanApp.WorkOrderWearingLayer.WorkOrderWearingLayer.constants', 'common.base'];
