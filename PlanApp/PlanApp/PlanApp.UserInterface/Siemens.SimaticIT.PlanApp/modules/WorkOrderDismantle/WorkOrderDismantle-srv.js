(function () {
    'use strict';
    angular.module('Siemens.SimaticIT.PlanApp.WorkOrderDismantle')
        .constant('Siemens.SimaticIT.PlanApp.WorkOrderDismantle.WorkOrderDismantle.constants', ScreenServiceConstants())
        .service('Siemens.SimaticIT.PlanApp.WorkOrderDismantle.WorkOrderDismantle.service', ScreenService)
    ...
    ScreenService.$inject = ['$q', '$state', 'common.base', 'Siemens.SimaticIT.PlanApp.WorkOrderDismantle.WorkOrderDismantle.constants', 'common.services.logger.service'];
    function ScreenService($q, $state, base, context, loggerService) {
        ...
        activate();
        function activate() {
            logger = loggerService.getModuleLogger('Siemens.SimaticIT.PlanApp.WorkOrderDismantle.WorkOrderDismantle.service');
    ...
    ScreenServiceRun.$inject = ['Siemens.SimaticIT.PlanApp.WorkOrderDismantle.WorkOrderDismantle.constants', 'common.base'];
