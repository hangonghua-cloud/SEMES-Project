(function () {
    'use strict';
    angular.module('Siemens.SimaticIT.PlanApp.WorkOrderSort').config(ViewScreenStateConfig);

    ViewScreenController.$inject = ['Siemens.SimaticIT.PlanApp.WorkOrderSort.WorkOrderSort.service', '$state', '$stateParams', 'common.base', '$filter', '$scope'];
        ...
        var state = {
            ...
            views: {
                'property-area-container@': {
                    templateUrl: moduleFolder + '/WorkOrderSort-select.html',
