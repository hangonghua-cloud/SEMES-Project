(function () {
    'use strict';
    angular.module('Siemens.SimaticIT.PlanApp.WorkOrderSort')
        .constant('Siemens.SimaticIT.PlanApp.WorkOrderSort.WorkOrderSort.constants', ScreenServiceConstants())
        .service('Siemens.SimaticIT.PlanApp.WorkOrderSort.WorkOrderSort.service', ScreenService)
    ...
    ScreenService.$inject = ['$q', '$state', 'common.base', 'Siemens.SimaticIT.PlanApp.WorkOrderSort.WorkOrderSort.constants', 'common.services.logger.service'];
    function ScreenService($q, $state, base, context, loggerService) {
        ...
        activate();
        function activate() {
            logger = loggerService.getModuleLogger('Siemens.SimaticIT.PlanApp.WorkOrderSort.WorkOrderSort.service');
    ...
    ScreenServiceRun.$inject = ['Siemens.SimaticIT.PlanApp.WorkOrderSort.WorkOrderSort.constants', 'common.base'];
