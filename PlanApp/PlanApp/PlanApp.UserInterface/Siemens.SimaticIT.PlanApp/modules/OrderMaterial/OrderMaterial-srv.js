(function () {
    'use strict';
    angular.module('Siemens.SimaticIT.PlanApp.OrderMaterial')
        .constant('Siemens.SimaticIT.PlanApp.OrderMaterial.OrderMaterial.constants', ScreenServiceConstants())
        .service('Siemens.SimaticIT.PlanApp.OrderMaterial.OrderMaterial.service', ScreenService)
    ...
    ScreenService.$inject = ['$q', '$state', 'common.base', 'Siemens.SimaticIT.PlanApp.OrderMaterial.OrderMaterial.constants', 'common.services.logger.service'];
    function ScreenService($q, $state, base, context, loggerService) {
        ...
        activate();
        function activate() {
            logger = loggerService.getModuleLogger('Siemens.SimaticIT.PlanApp.OrderMaterial.OrderMaterial.service');
    ...
    ScreenServiceRun.$inject = ['Siemens.SimaticIT.PlanApp.OrderMaterial.OrderMaterial.constants', 'common.base'];
