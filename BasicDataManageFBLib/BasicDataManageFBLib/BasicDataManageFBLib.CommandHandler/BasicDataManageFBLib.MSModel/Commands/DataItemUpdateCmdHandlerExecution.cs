...
namespace Siemens.SimaticIT.MasterData.BasicDataManageFBLib.MSModel.Commands
{
    ...
    /// Class initialize
    /// </summary>
    public partial class DataItemUpdateCmdHandlerShell : ICommandHandler
    {
        ...
        public Response Execute(IUnifiedSdk unifiedSdk, ICommand command)
        {
            ...
            return DataItemUpdateCmdHandler((DataItemUpdateCmd)command);
        }
        ...
        {
            return typeof(DataItemUpdateCmd);
        }
    }
}
