...
namespace Siemens.SimaticIT.MasterData.BasicDataManageFBLib.MSModel.Commands
{
    ...
    /// Class initialize
    /// </summary>
    public partial class SaveAppRolesConfiCmdHandlerShell : ICommandHandler
    {
        ...
        public Response Execute(IUnifiedSdk unifiedSdk, ICommand command)
        {
            ...
            return SaveAppRolesConfiCmdHandler((SaveAppRolesConfiCmd)command);
        }
        ...
        {
            return typeof(SaveAppRolesConfiCmd);
        }
    }
}
