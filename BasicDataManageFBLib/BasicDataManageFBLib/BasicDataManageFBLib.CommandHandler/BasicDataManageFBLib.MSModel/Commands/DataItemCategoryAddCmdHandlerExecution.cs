...
namespace Siemens.SimaticIT.MasterData.BasicDataManageFBLib.MSModel.Commands
{
    ...
    /// Class initialize
    /// </summary>
    public partial class DataItemCategoryAddCmdHandlerShell : ICommandHandler
    {
        ...
        public Response Execute(IUnifiedSdk unifiedSdk, ICommand command)
        {
            ...
            return DataItemCategoryAddCmdHandler((DataItemCategoryAddCmd)command);
        }
        ...
        {
            return typeof(DataItemCategoryAddCmd);
        }
    }
}
