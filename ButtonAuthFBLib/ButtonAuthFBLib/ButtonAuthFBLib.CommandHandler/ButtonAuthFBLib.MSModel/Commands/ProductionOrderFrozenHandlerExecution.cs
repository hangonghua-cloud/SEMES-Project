...
namespace Siemens.SimaticIT.MasterData.ButtonAuthFBLib.MSModel.Commands
{
    ...
    /// Class initialize
    /// </summary>
    public partial class ProductionOrderFrozenHandlerShell : ICommandHandler
    {
        ...
        public Response Execute(IUnifiedSdk unifiedSdk, ICommand command)
        {
            ...
            return ProductionOrderFrozenHandler((ProductionOrderFrozen)command);
        }
        ...
        {
            return typeof(ProductionOrderFrozen);
        }
    }
}
