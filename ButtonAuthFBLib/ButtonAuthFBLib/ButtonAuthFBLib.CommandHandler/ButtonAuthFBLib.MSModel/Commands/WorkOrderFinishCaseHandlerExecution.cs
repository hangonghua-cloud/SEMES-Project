...
namespace Siemens.SimaticIT.MasterData.ButtonAuthFBLib.MSModel.Commands
{
    ...
    /// Class initialize
    /// </summary>
    public partial class WorkOrderFinishCaseHandlerShell : ICommandHandler
    {
        ...
        public Response Execute(IUnifiedSdk unifiedSdk, ICommand command)
        {
            ...
            return WorkOrderFinishCaseHandler((WorkOrderFinishCase)command);
        }
        ...
        {
            return typeof(WorkOrderFinishCase);
        }
    }
}
