...
namespace Siemens.SimaticIT.MasterData.ButtonAuthFBLib.MSModel.Commands
{
    ...
    /// Class initialize
    /// </summary>
    public partial class BaseMaterialEditHandlerShell : ICommandHandler
    {
        ...
        public Response Execute(IUnifiedSdk unifiedSdk, ICommand command)
        {
            ...
            return BaseMaterialEditHandler((BaseMaterialEdit)command);
        }
        ...
        {
            return typeof(BaseMaterialEdit);
        }
    }
}
