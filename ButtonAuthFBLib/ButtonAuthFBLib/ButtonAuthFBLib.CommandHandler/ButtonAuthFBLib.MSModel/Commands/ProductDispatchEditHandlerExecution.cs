...
namespace Siemens.SimaticIT.MasterData.ButtonAuthFBLib.MSModel.Commands
{
    ...
    /// Class initialize
    /// </summary>
    public partial class ProductDispatchEditHandlerShell : ICommandHandler
    {
        ...
        public Response Execute(IUnifiedSdk unifiedSdk, ICommand command)
        {
            ...
            return ProductDispatchEditHandler((ProductDispatchEdit)command);
        }
        ...
        {
            return typeof(ProductDispatchEdit);
        }
    }
}
