...
namespace Siemens.SimaticIT.MasterData.ButtonAuthFBLib.MSModel.Commands
{
    ...
    /// Class initialize
    /// </summary>
    public partial class RawMaterialStockManageAdjustHandlerShell : ICommandHandler
    {
        ...
        public Response Execute(IUnifiedSdk unifiedSdk, ICommand command)
        {
            ...
            return RawMaterialStockManageAdjustHandler((RawMaterialStockManageAdjust)command);
        }
        ...
        {
            return typeof(RawMaterialStockManageAdjust);
        }
    }
}
