...
namespace Siemens.SimaticIT.MasterData.ButtonAuthFBLib.MSModel.Commands
{
    ...
    /// Class initialize
    /// </summary>
    public partial class ReceiptNoticeDeleteHandlerShell : ICommandHandler
    {
        ...
        public Response Execute(IUnifiedSdk unifiedSdk, ICommand command)
        {
            ...
            return ReceiptNoticeDeleteHandler((ReceiptNoticeDelete)command);
        }
        ...
        {
            return typeof(ReceiptNoticeDelete);
        }
    }
}
