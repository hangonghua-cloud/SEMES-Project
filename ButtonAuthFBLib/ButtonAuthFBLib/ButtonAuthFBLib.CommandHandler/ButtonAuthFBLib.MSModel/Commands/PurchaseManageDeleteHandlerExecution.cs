...
namespace Siemens.SimaticIT.MasterData.ButtonAuthFBLib.MSModel.Commands
{
    ...
    /// Class initialize
    /// </summary>
    public partial class PurchaseManageDeleteHandlerShell : ICommandHandler
    {
        ...
        public Response Execute(IUnifiedSdk unifiedSdk, ICommand command)
        {
            ...
            return PurchaseManageDeleteHandler((PurchaseManageDelete)command);
        }
        ...
        {
            return typeof(PurchaseManageDelete);
        }
    }
}
