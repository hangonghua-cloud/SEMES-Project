...
namespace Siemens.SimaticIT.MasterData.ButtonAuthFBLib.MSModel.Commands
{
    ...
    /// Class initialize
    /// </summary>
    public partial class BaseBOMEditDetailHandlerShell : ICommandHandler
    {
        ...
        public Response Execute(IUnifiedSdk unifiedSdk, ICommand command)
        {
            ...
            return BaseBOMEditDetailHandler((BaseBOMEditDetail)command);
        }
        ...
        {
            return typeof(BaseBOMEditDetail);
        }
    }
}
