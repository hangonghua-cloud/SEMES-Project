...
namespace Siemens.SimaticIT.MasterData.ButtonAuthFBLib.MSModel.Commands
{
    ...
    /// Class initialize
    /// </summary>
    public partial class RawMaterialStockManageOutWhsHandlerShell : ICommandHandler
    {
        ...
        public Response Execute(IUnifiedSdk unifiedSdk, ICommand command)
        {
            ...
            return RawMaterialStockManageOutWhsHandler((RawMaterialStockManageOutWhs)command);
        }
        ...
        {
            return typeof(RawMaterialStockManageOutWhs);
        }
    }
}
