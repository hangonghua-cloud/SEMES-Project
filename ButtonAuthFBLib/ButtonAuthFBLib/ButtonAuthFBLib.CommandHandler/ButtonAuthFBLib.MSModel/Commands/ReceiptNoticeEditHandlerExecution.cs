...
namespace Siemens.SimaticIT.MasterData.ButtonAuthFBLib.MSModel.Commands
{
    ...
    /// Class initialize
    /// </summary>
    public partial class ReceiptNoticeEditHandlerShell : ICommandHandler
    {
        ...
        public Response Execute(IUnifiedSdk unifiedSdk, ICommand command)
        {
            ...
            return ReceiptNoticeEditHandler((ReceiptNoticeEdit)command);
        }
        ...
        {
            return typeof(ReceiptNoticeEdit);
        }
    }
}
