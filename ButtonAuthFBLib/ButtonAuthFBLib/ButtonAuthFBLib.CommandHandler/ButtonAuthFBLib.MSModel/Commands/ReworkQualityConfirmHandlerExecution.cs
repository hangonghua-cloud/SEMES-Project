...
namespace Siemens.SimaticIT.MasterData.ButtonAuthFBLib.MSModel.Commands
{
    ...
    /// Class initialize
    /// </summary>
    public partial class ReworkQualityConfirmHandlerShell : ICommandHandler
    {
        ...
        public Response Execute(IUnifiedSdk unifiedSdk, ICommand command)
        {
            ...
            return ReworkQualityConfirmHandler((ReworkQualityConfirm)command);
        }
        ...
        {
            return typeof(ReworkQualityConfirm);
        }
    }
}
