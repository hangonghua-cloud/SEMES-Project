...
namespace Siemens.SimaticIT.MasterData.ButtonAuthFBLib.MSModel.Commands
{
    ...
    /// Class initialize
    /// </summary>
    public partial class OwnProductFinishCaseHandlerShell : ICommandHandler
    {
        ...
        public Response Execute(IUnifiedSdk unifiedSdk, ICommand command)
        {
            ...
            return OwnProductFinishCaseHandler((OwnProductFinishCase)command);
        }
        ...
        {
            return typeof(OwnProductFinishCase);
        }
    }
}
