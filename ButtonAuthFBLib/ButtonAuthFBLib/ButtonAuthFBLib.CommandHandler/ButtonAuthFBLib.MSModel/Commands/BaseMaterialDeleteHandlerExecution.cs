...
namespace Siemens.SimaticIT.MasterData.ButtonAuthFBLib.MSModel.Commands
{
    ...
    /// Class initialize
    /// </summary>
    public partial class BaseMaterialDeleteHandlerShell : ICommandHandler
    {
        ...
        public Response Execute(IUnifiedSdk unifiedSdk, ICommand command)
        {
            ...
            return BaseMaterialDeleteHandler((BaseMaterialDelete)command);
        }
        ...
        {
            return typeof(BaseMaterialDelete);
        }
    }
}
