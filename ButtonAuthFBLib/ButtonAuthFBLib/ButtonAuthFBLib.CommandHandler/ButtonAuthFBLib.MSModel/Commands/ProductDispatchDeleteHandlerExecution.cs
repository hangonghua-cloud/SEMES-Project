...
namespace Siemens.SimaticIT.MasterData.ButtonAuthFBLib.MSModel.Commands
{
    ...
    /// Class initialize
    /// </summary>
    public partial class ProductDispatchDeleteHandlerShell : ICommandHandler
    {
        ...
        public Response Execute(IUnifiedSdk unifiedSdk, ICommand command)
        {
            ...
            return ProductDispatchDeleteHandler((ProductDispatchDelete)command);
        }
        ...
        {
            return typeof(ProductDispatchDelete);
        }
    }
}
