...
namespace Siemens.SimaticIT.MasterData.ButtonAuthFBLib.MSModel.Commands
{
    ...
    /// Class initialize
    /// </summary>
    public partial class RawMaterialStockManageBackupHandlerShell : ICommandHandler
    {
        ...
        public Response Execute(IUnifiedSdk unifiedSdk, ICommand command)
        {
            ...
            return RawMaterialStockManageBackupHandler((RawMaterialStockManageBackup)command);
        }
        ...
        {
            return typeof(RawMaterialStockManageBackup);
        }
    }
}
