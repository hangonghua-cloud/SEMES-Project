...
namespace Siemens.SimaticIT.MasterData.ButtonAuthFBLib.MSModel.Commands
{
    ...
    /// Class initialize
    /// </summary>
    public partial class WorkOrderAddPickHandlerShell : ICommandHandler
    {
        ...
        public Response Execute(IUnifiedSdk unifiedSdk, ICommand command)
        {
            ...
            return WorkOrderAddPickHandler((WorkOrderAddPick)command);
        }
        ...
        {
            return typeof(WorkOrderAddPick);
        }
    }
}
