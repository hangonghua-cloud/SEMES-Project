...
namespace Siemens.SimaticIT.MasterData.ButtonAuthFBLib.MSModel.Commands
{
    ...
    /// Class initialize
    /// </summary>
    public partial class ProductStockManageAdjustHandlerShell : ICommandHandler
    {
        ...
        public Response Execute(IUnifiedSdk unifiedSdk, ICommand command)
        {
            ...
            return ProductStockManageAdjustHandler((ProductStockManageAdjust)command);
        }
        ...
        {
            return typeof(ProductStockManageAdjust);
        }
    }
}
